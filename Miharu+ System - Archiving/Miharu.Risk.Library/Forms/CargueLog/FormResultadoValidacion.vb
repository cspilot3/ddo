...
#Region " Constructor "
        ...
        Public Sub New(ByVal trErrores As DesktopConfig.TypeResult)
            ...
            If trErrores.Parameters.Count > 0 Then
                For index = 0 To trErrores.Parameters.Count - 1
                    msgRespuestaCargue = msgRespuestaCargue + (index + 1).ToString() + ". " + trErrores.Parameters(index).ToString() + vbCrLf
...
#Region " Metodos "
        ...
        Public Sub GuardarLog()
            ...
            Dialogo.Filter = "Archivo Excel (*.xls)|*.xlsx"
