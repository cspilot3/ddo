...
Namespace Forms.MesaControlFisicos
    ...
    Public Class FormMesaControlFisicos
        Inherits FormBase
...
#Region " Eventos "
        ...
        Private Sub CerrarCarpetaButton_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles CerrarCarpetaButton.Click
            CerrarCarpeta2()
        End Sub
        ...
        Private Sub CargaFiles()
            Try
                ...
                Select Case _TipoCaptura
                    Case DesktopConfig.TipoCaptura.Primera_Captura : nEstado = DBCore.EstadoEnum.Mesa_De_Control
            ...
            Try
                ...
                If cbarrasDesktopCBarrasControl.Text <> "" And dtFilesMesa.Count > 0 Then
                    If dtFilesMesa.Count > 0 Then
                        Select Case _TipoCaptura
                            Case DesktopConfig.TipoCaptura.Primera_Captura
                                dtFilesMesa.RowFilter = "CBarras_File = '" & cbarrasDesktopCBarrasControl.Text & "'" : idEstadoActual = DBCore.EstadoEnum.Mesa_De_Control : nombreEstadoActual = DBCore.EstadoEnum.Mesa_De_Control.ToString()
                            Case DesktopConfig.TipoCaptura.Segunda_Captura
                        ...
                        If dtFilesMesa.ToTable().Rows.Count > 0 AndAlso CInt(dtFilesMesa.ToTable().Rows(0).Item("id_Estado")) = idEstadoActual Then
                            ...
                            Else
                                Select Case _TipoCaptura
                                    Case DesktopConfig.TipoCaptura.Primera_Captura : FormPrimeraCapturarDataAdicional.Captura(cbarrasDesktopCBarrasControl.Text)
                                    Case DesktopConfig.TipoCaptura.Segunda_Captura : FormSegundaCapturarDataAdicional.Captura(cbarrasDesktopCBarrasControl.Text)
                                    Case DesktopConfig.TipoCaptura.Tercera_Captura : FormTerceraCapturarDataAdicional.Captura(cbarrasDesktopCBarrasControl.Text)
                                End Select
                            End If
