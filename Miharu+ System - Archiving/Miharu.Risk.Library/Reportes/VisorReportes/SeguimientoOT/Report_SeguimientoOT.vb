...
Namespace Reportes.VisorReportes.SeguimientoOT
    ...
    Public Class Report_SeguimientoOT
...
#Region " Propiedades "
        ...
        Public Overrides ReadOnly Property ReportName As String
            Get
                Return "Seguimiento Detallado OT"
            End Get
        End Property
...
#Region " Metodos "
        ...
        Public Overrides Sub Launch()
            Dim FormParametros As New Report_SeguimientoOT_Parametros()
            ...
            If FormParametros.ShowDialog = DialogResult.OK Then
                ...
                Try
                    ...
                    SeguimientoOTDataTable = dbmArchiving.SchemaReport.PA_Seguimiento_OT.DBExecute(Fecha_Inicio, Fecha_Final, Program.RiskGlobal.Entidad, Program.RiskGlobal.Proyecto)
                ...
                Dim InformeReportDataSource1 As New ReportDataSource("OTSeguimiento", SeguimientoOTDataTable)

                Me.ReportViewer.MainReportViewer.Reset()
                Me.ReportViewer.MainReportViewer.LocalReport.ReportEmbeddedResource = "Miharu.Risk.Library.Report_SeguimientoOT.rdlc"
