...
Namespace Reportes.VisorReportes.Validaciones
    ...
    Public Class Report_Validaciones
...
#Region " Propiedades "
        ...
        Public Overrides ReadOnly Property ReportName As String
            Get
                Return "Reporte de Validaciones"
            End Get
        End Property
...
#Region " Metodos "
        ...
        Public Overrides Sub Launch()
            Dim FormParametros As New Report_Validaciones_Parametros()
            ...
            If FormParametros.ShowDialog = DialogResult.OK Then
                ...
                Dim SeguimientoOTDataTable As DataTable
                'Dim OTDataTable As New DataTable
                ...
                Try
                    ...
                    SeguimientoOTDataTable = dbmArchiving.SchemaReport.PA_Reporte_Validaciones.DBExecute(Fecha_Inicio, Fecha_Final, Program.RiskGlobal.Entidad, Program.RiskGlobal.Proyecto)
                ...
                Dim InformeReportDataSource1 As New ReportDataSource("Reporte_Validaciones", SeguimientoOTDataTable)

                Me.ReportViewer.MainReportViewer.Reset()
                Me.ReportViewer.MainReportViewer.LocalReport.ReportEmbeddedResource = "Miharu.Risk.Library.Report_Validaciones.rdlc"
