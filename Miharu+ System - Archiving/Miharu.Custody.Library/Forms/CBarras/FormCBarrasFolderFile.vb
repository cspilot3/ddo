...
#Region " Metodos "
        ...
        Public Sub ImprimirCBarras()
            ...
            Try
                ...
                Dim TableParametros As DataTable = dbmImaging.Schemadbo.PA_Imprimir_CBarras_Unico.DBExecute(CBarrasLocal)
                ...
                End If
            Catch ex As Exception
                MessageBox.Show(ex.Message.ToString(), "Error Imprimiendo CB", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Finally
