...
Imports System.IO
Imports Miharu.Imaging.FileTransfer.Monitor.Formularios

Public Class Program

#Region " Declaraciones "

    Public Const ConfigFileName As String = "ObjectConfigFT.dat"
    Public Shared Config As New Servicio.ImagingFileTransferConfig
