...
#Region " Propiedades "
    ...
    Friend Shared ReadOnly Property ImagingWebServiceURL As String
        Get
            Return ConfigurationManager.AppSettings("WebService.ImagingService")
        End Get
    End Property

    Friend Shared ReadOnly Property VisorPageURL As String
        Get
            Return ConfigurationManager.AppSettings("WebService.Visor")
        End Get
    End Property

    Friend Shared ReadOnly Property DescargarPageURL As String
        Get
            Return ConfigurationManager.AppSettings("WebService.Descargar")
        End Get
    End Property
    ...
    Public Shared Function getCadenasConexion(ByRef nWebService As SecurityWebService) As TypeConnectionString
        ...
        For Each Modulo In ConnectionStrings
            Select Case Modulo.Id
                Case 0 : Cadenas.Security = Modulo.ConnectionString & DataRemoting
                Case 6 : Cadenas.Core = Modulo.ConnectionString & DataRemoting
            End Select
        Next
