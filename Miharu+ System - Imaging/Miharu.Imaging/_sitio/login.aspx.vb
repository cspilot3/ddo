...
Imports Miharu.Imaging.MiharuMasterPage
...
#Region " Eventos "
    ...
    Protected Sub btnIngresar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnIngresar.Click
        If Validar() Then IniciarSesion(txtUsuario.Text, txtContraseña.Text)
    End Sub
...
#Region " Metodos "
    ...
    Private Sub IniciarSesion(nUserName As String, nPassword As String)
        If (Validar()) Then
                ...
                If (WebService.ValidateUser(idEntidad, idUsuario, LogonResult)) Then
                    ...
                    Select Case LogonResult
                        ...
                        Case EnumValidateUser.VALIDO
                            ...
                            If (MySesion.Usuario.PerfilManager.Permisos.Count > 0) Then
                                MySesion.Pagina = New Pagina(GetType(Miharu.Imaging.blankform).FullName, "MIHARU", "~/_sitio/blankform.aspx", "0")
        ...
        If (nNewPassword = nConfirmPassword) Then
            ...
            Try
                ...
                Select Case Respuesta
                    Case EnumValidateUser.INVALIDO_PASSWORD
                        Master.ShowAlert("Contraseña no inválida", MsgBoxIcon.IconWarning)

                    Case EnumValidateUser.ERROR_PASSWORD
                        Master.ShowAlert("La contraseña no tiene la complejidad requerida por las políticas de seguridad del sistema", MsgBoxIcon.IconWarning)

                    Case Else
                        MySesion.Pagina = New Security.Library.Session.Pagina(GetType(Miharu.Imaging.blankform).FullName, "MIHARU", "~/_sitio/blankform.aspx", "0")
                        Response.Redirect("~/_sitio/MiharuMainForm.aspx")
                End Select
            Catch ex As Exception
