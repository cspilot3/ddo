<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="wucParameterText.ascx.vb" Inherits="Miharu.Imaging.wucParameterText" %>
...
<tr>
    ...
    <td|>
    <asp:TextBox ID="valueTextBox" runat="server" CssClass="TextBox" Width="250px"></asp:TextBox>
    </td>
    <td>
