...
Namespace View.Indexacion
    ...
    Public Class TextInputDateTimeControl
...
#Region " Implementación IIndexerControl "
        ...
        Public Property NextControl As System.Windows.Forms.Control Implements IInputControl.NextControl
        ...
        Public ReadOnly Property DefinicionCaptura As System.Collections.Generic.List(Of DefinicionCaptura) Implements IInputControl.DefinicionCaptura
            Get
        ...
        Public Property TriggerValues As System.Collections.Generic.List(Of KeyValueItem) Implements IInputControl.TriggerValues
        ...
        Public Function Validar() As Boolean Implements IInputControl.Validar
            ...
            Else
                ...
                Dim a As String = Me.ValueDesktopTextBox.Text
                Me.ValueDesktopTextBox.Text = String.Empty
                Dim Mascara As String = Me.ValueDesktopTextBox.Text
                Me.ValueDesktopTextBox.Text = a


                If Not Me.ValueDesktopTextBox.Text = Mascara Then
        ...
        Public Sub LoadDefinition(ByVal nDefinicionCaptura As List(Of DefinicionCaptura)) Implements IInputControl.LoadDefinition
            ...
            Me.ValueDesktopTextBox.Mask = nDefinicionCaptura(0).Mascara
            Me.ValueDesktopTextBox.DateFormat = nDefinicionCaptura(0).FormatoFecha
            Me.ValueDesktopTextBox.NombreCampo = nDefinicionCaptura(0).Caption
        End Sub
...
#Region " Metodos "
        ...
        '                        End If
        '                    Case "<"
        '                        If (CDbl(Me.Value.ToString()) < CDbl(TriggerValue._Valor)) Then
        '                            'oculta control validacion
        '                            Validacion.Control.Visible = False
        '                        End If
        '                    Case ">"
