...
Namespace View.Indexacion.Table
    ...
    Partial Class IndexerTableCellDateTime
        ...
        Private Sub InitializeComponent()
            Me.ValueDesktopTextBox = New DesktopDateTimeTextBoxControl()
            Me.Valueold2DesktopTextBox = New DesktopTextTextBoxControl()
            Me.ValueOld1DesktopTextBox = New DesktopTextTextBoxControl()
        ...
        Private WithEvents ValueDesktopTextBox As DesktopDateTimeTextBoxControl
        Private WithEvents Valueold2DesktopTextBox As DesktopTextTextBoxControl
        Private WithEvents ValueOld1DesktopTextBox As DesktopTextTextBoxControl
