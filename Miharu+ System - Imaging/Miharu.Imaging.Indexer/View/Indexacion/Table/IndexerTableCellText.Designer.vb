...
Namespace View.Indexacion.Table
    ...
    Partial Class IndexerTableCellText
        ...
        Private Sub InitializeComponent()
            Me.ValueDesktopTextBox = New DesktopTextTextBoxControl()
        ...
        Private WithEvents ValueDesktopTextBox As DesktopTextTextBoxControl
