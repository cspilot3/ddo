Namespace Servicio
    <System.ComponentModel.RunInstaller(True)> Partial Class ProjectInstaller
        ...
        Private Sub InitializeComponent()
            ...
            'MyServiceInstaller
            '
            Me.MyServiceInstaller.Description = "Sevicio de transferencia de archivos del módulo Imaging del sistema Miharu"
            Me.MyServiceInstaller.DisplayName = "MiharuImagingFileTransferService"
            Me.MyServiceInstaller.ServiceName = "MiharuImagingFileTransferService"
