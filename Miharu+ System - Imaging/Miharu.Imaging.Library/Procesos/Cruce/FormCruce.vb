        ...
        Private Sub GeneraCruce()
            If Validar() Then
                ...
                Try
                    ...
                    ' ValidaPrepararDataCruce = dbmImaging.SchemaProcess.PA_Get_Prepara_Data_Cruce.DBExecute(Program.ImagingGlobal.Entidad, Program.ImagingGlobal.Proyecto, CInt(FechaProcesodateTimePicker.Value.ToString("yyyyMMdd")), CInt(IIf(OTDesktopComboBox.SelectedValue.Equals("--TODOS--"), -1, OTDesktopComboBox.SelectedValue)), CInt(IIf(OTDesktopComboBox.SelectedValue.Equals("--TODOS--"), 2, 1)))
                    ...
                    '    Return '--=============== FIN REQUERIMIENTO RITM0229763 ===========-
                    'Else

                    If (CrucePrecapturaCheckBox.Checked = True) Then
                        ...
                        If (RegistrosPendientes = 0) Then
                            MessageBox.Show("No se puede realizar la preparación de data puesto que la OT, Cargue y/o Fecha de Proceso seleccionada aun tiene registros pendientes por procesar (cruce pre-captura).", "Preparar Data", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                            Return
                        End If
                    Else
                        RegistrosPendientes = dbmImaging.SchemaProcess.PA_Validacion_Registros.DBExecute(Program.ImagingGlobal.Entidad, Program.ImagingGlobal.Proyecto, CInt(FechaProcesodateTimePicker.Value.ToString("yyyyMMdd")), CInt(IIf(OTDesktopComboBox.SelectedValue.Equals("--TODOS--"), -1, OTDesktopComboBox.SelectedValue)))

                        If (RegistrosPendientes = 0) Then
                            MessageBox.Show("No se puede realizar la preparación de data puesto que la OT y/o Fecha de Proceso seleccionada aun tiene registros pendientes por procesar.", "Cruce", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                            Return
                        End If
                    End If
        ...
        Private Sub PrepararData()
            If Validar() Then
                ...
                Try
                    ...
                    If (Me.CrucePrecapturaCheckBox.Checked = True) Then
                        RegistrosPendientes = dbmImaging.SchemaProcess.PA_Validacion_Registros_Precaptura_Fecha_Proceso.DBExecute(Program.ImagingGlobal.Entidad, Program.ImagingGlobal.Proyecto, CInt(FechaProcesodateTimePicker.Value.ToString("yyyyMMdd")))
                    ...
                    Else
                        ...
                        If (RegistrosPendientes = 0) Then
                            MessageBox.Show("No se puede realizar la preparación de data puesto que la OT y/o Fecha de Proceso seleccionada aun tiene registros pendientes por procesar.", "Preparar Data", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                            Return
                        End If
                    End If
                    ...
                    If (ProcesoDataTable.Count = 1) Then
                        If (ProcesoDataTable(0).Cerrado = False) Then
                            ...
                            Dim aux As String = OTDesktopComboBox.SelectedValue.ToString
                            ...
                            'Finalizar preparar data
                            If (Resultado.ToString() = "Preparar Data Exitoso") Then
                                Me.WorkSpace.EventManager.FinalizarPrepararDataGenerico(Program.ImagingGlobal.Entidad, Program.ImagingGlobal.Proyecto, CInt(FechaProcesodateTimePicker.Value.ToString("yyyyMMdd")), CInt(IIf(OTDesktopComboBox.SelectedValue.Equals("--TODOS--"), -1, OTDesktopComboBox.SelectedValue)))
                            End If
