...
#Region " Funciones "
        ...
        Public Function ProcesaCargue(ByVal data As DataTable, ByVal fileName As String, id_Tipo_Log As Integer, ByVal Valida_Duplicados As Boolean, Fecha_Proceso As Integer, ByRef CargueBackgroundWorker As BackgroundWorker) As DesktopConfig.TypeResult
            ...
            Try
                ...
                Dim TablaErrores = dbmImaging.SchemaProcess.PA_Procesa_Log_DINAMICO_2.DBExecute(id_Tipo_Log, Program.ImagingGlobal.Entidad, Program.ImagingGlobal.Proyecto, tabla, Program.Sesion.Usuario.id, fileName, Fecha_Proceso)
