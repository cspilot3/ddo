...
Public Class FormGuardarSticker
...
#Region " Metodos "
    ...
    Private Sub GenerarSticker(ByVal dbmImaging As DBImaging.DBImagingDataBaseManager,
        ...
        If Datos.Rows.Count > 0 Then
            ...
            Dim FileFolderName = Titulo + "\" & "Caja_n" & nCaja & "\"
            ...
            Dim NombreArchivo = "StickerCaja_n" & nCaja & ".pdf"
            Dim NombreArchivoExcel = "StickerCaja_n" & nCaja & ".xls"
            ...
            End Using
            MessageBox.Show("Sticker guardados Con Exito Ruta: " & Ruta & " ", "Guardado", MessageBoxButtons.OK)
            Process.Start(Ruta)
