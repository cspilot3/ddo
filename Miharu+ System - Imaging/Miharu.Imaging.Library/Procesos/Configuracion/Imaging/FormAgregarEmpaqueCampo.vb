...
Namespace Procesos.Configuracion.Imaging
    ...
    Public Class FormAgregarEmpaqueCampo
        Inherits FormBase
...
#Region "Eventos"
        ...
        Private Sub FormAgregarempaqueCampo_Load(sender As System.Object, e As EventArgs) Handles MyBase.Load
            CargarListas()
        ...
        Private Sub GuardarCambios()
            ...
            Try
                ...
                If Validar() Then
                    ...
                    Dim empaqueCampo As New DBImaging.SchemaConfig.TBL_Empaque_CampoType()
                    With empaqueCampo
                    ...
                    If (id_CampoTextBox.Text = "") Then
                        empaqueCampo.id_Campo = dbmImaging.SchemaConfig.TBL_Empaque_Campo.DBNextId(Program.ImagingGlobal.Entidad, Program.ImagingGlobal.Proyecto)
                        dbmImaging.SchemaConfig.TBL_Empaque_Campo.DBInsert(empaqueCampo)
                    Else
                        dbmImaging.SchemaConfig.TBL_Empaque_Campo.DBUpdate(empaqueCampo, Program.ImagingGlobal.Entidad, Program.ImagingGlobal.Proyecto, CShort(id_CampoTextBox.Text))
                    End If
