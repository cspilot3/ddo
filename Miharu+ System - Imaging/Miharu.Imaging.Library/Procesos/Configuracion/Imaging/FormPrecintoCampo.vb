...
Namespace Procesos.Configuracion.Imaging
    ...
    Public Class FormPrecintoCampo
        Inherits Desktop.Library.FormBase

#Region " Declaraciones "

        Private _precintoCampoDataTable As DBImaging.SchemaConfig.TBL_Precinto_CampoDataTable

#End Region

#Region " Eventos "

        Private Sub FormPrecintoCampoLoad(sender As System.Object, e As EventArgs) Handles MyBase.Load
            CargarDatos()
        End Sub

        Private Sub GuardarButtonClick(sender As System.Object, e As EventArgs) Handles GuardarButton.Click
            Dim agregarCampos = New FormAgregarPrecintoCampo
...
#Region " Metodos "
        ...
        Private Sub GuardarCambios()
            ...
            Try
                ...
                dbmImaging.SchemaConfig.TBL_Precinto_Campo.DBSaveTable(_precintoCampoDataTable)
        ...
        Private Sub CargarDatos()
            ...
            Try
                ...
                _precintoCampoDataTable = dbmImaging.SchemaConfig.TBL_Precinto_Campo.DBGet(Program.ImagingGlobal.Entidad, Program.ImagingGlobal.Proyecto, Nothing)
                CamposDataGridView.AutoGenerateColumns = False
                CamposDataGridView.DataSource = _precintoCampoDataTable
