...
Namespace Reportes.EmpaqueDetallado

    Public Class Report_EmpaqueDetallado
...
#Region " Metodos "
        ...
        Public Overrides Sub Launch()
            ...
            If FiltrosForm.ShowDialog() = Windows.Forms.DialogResult.OK Then
                ...
                Dim dsInforme As New DBImaging.SchemaProcess.CTA_Empaque_DetalladoDataTable

                Try
                    dbmImaging = New DBImaging.DBImagingDataBaseManager(Program.DesktopGlobal.ConnectionStrings.Imaging)
                    dbmImaging.Connection_Open(Program.Sesion.Usuario.id)

                    dsInforme = dbmImaging.SchemaProcess.PA_Empaque_Detallado.DBExecute(Program.ImagingGlobal.Entidad, Program.ImagingGlobal.Proyecto, FechaProceso, Punto)
                ...
                Dim InformeReportDataSource As New ReportDataSource("dsEmpaqueDetallado", CType(dsInforme, DataTable))

                Me.ReportViewer.MainReportViewer.Reset()
                Me.ReportViewer.MainReportViewer.LocalReport.ReportEmbeddedResource = "Miharu.Imaging.Library.Report_EmpaqueDetallado.rdlc"
