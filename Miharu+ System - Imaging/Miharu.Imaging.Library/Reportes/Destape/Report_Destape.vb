        ...
        Public Overrides Sub Launch()
            ...
            If FiltrosForm.ShowDialog() = Windows.Forms.DialogResult.OK Then
                ...
                Try
                    ...
                    dsInforme = dbmImaging.SchemaProcess.PA_Destape.DBExecute(Program.ImagingGlobal.Entidad, Program.ImagingGlobal.Proyecto, FechaProceso, Punto)
                ...
                Dim InformeReportDataSource As New ReportDataSource("dsDestape", CType(dsInforme, DataTable))

                Me.ReportViewer.MainReportViewer.Reset()
                Me.ReportViewer.MainReportViewer.LocalReport.ReportEmbeddedResource = "Miharu.Imaging.Library.Report_Destape.rdlc"
