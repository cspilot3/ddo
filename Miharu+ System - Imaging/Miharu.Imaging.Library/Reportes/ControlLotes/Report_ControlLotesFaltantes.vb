...
Namespace Reportes.ControlLotes
    ...
    Public Class Report_ControlLotesFaltantes
        Inherits DesktopReport

#Region " Declaraciones "
        Dim InformeDataTable As New DBImaging.SchemaProcess.CTA_Reporte_ControlLote_FaltantesDataTable

        Public Overrides ReadOnly Property ReportName As String
            Get
                Return "Reporte de Faltantes"
            End Get
        End Property
...
#Region " Metodos "
        ...
        Public Overrides Sub Launch()
            Dim EfectividadForm As New FormEfectividad("ReporteFaltantes")
            ...
            If EfectividadForm.ShowDialog = Windows.Forms.DialogResult.OK Then
                ...
                Try
                    ...
                    'InformeDataTable = dbmImaging.SchemaProcess.PA_Reporte_ControlLote_Faltantes.DBExecute(Program.ImagingGlobal.ProyectoImagingRow.fk_Entidad, Program.ImagingGlobal.ProyectoImagingRow.fk_Proyecto, FechaInicio.Date, FechaFinal.Date, BancoEpago, Sede, Oficina, ColaD)

                    Dim QueryResponse As QueryResponse = ClientUtil.resolver("[DB_Miharu.Imaging_Core].[Process].[PA_Reporte_ControlLote_Faltantes]", New List(Of QueryParameter) From {
                    ...
                    InformeDataTable = CType(ClientUtil.mapToTypedTable(New DBImaging.SchemaProcess.CTA_Reporte_ControlLote_FaltantesDataTable(), QueryResponse.dataTable), DBImaging.SchemaProcess.CTA_Reporte_ControlLote_FaltantesDataTable)
                ...
                Dim InformeReportDataSource As New ReportDataSource("DS_Faltantes", CType(InformeDataTable, DataTable))

                'Exportación csv
                Dim nombreReporte As String = ""
                If BancoEpago = 1 Then
                    nombreReporte = "SoporteFaltantesBanco" & FechaInicio.ToString("ddMMyyyy") & ".csv"
                ElseIf BancoEpago = 2 Then
                    nombreReporte = "SoporteFaltantesEP" & FechaInicio.ToString("ddMMyyyy") & ".csv"
                Else
                    nombreReporte = "SoporteFaltantes" & FechaInicio.ToString("ddMMyyyy") & ".csv"
                End If
                ...
                Me.ReportViewer.MainReportViewer.LocalReport.ReportEmbeddedResource = "Miharu.Imaging.Library.Report_ControlLotes_Faltantes.rdlc"
