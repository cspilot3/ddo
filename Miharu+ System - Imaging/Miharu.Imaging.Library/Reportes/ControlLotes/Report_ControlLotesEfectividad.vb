...
Namespace Reportes.ControlLotes
    ...
    Public Class Report_ControlLotesEfectividad
...
#Region " Metodos "
        ...
        Public Overrides Sub Launch()
            Dim EfectividadForm As New FormEfectividad("ReporteEfectividad")
            ...
            If EfectividadForm.ShowDialog = Windows.Forms.DialogResult.OK Then
                ...
                Dim InformeDataTable As New DBImaging.SchemaProcess.CTA_Reporte_ControlLote_EfectividadDataTable
                ...
                Try
                    ...
                    'InformeDataTable = dbmImaging.SchemaProcess.PA_Reporte_ControlLote_Efectividad.DBExecute(Program.ImagingGlobal.ProyectoImagingRow.fk_Entidad, Program.ImagingGlobal.ProyectoImagingRow.fk_Proyecto, FechaInicio, FechaFinal, BancoEpago, Sede, Oficina, ColaD)

                    Dim QueryResponse As QueryResponse = ClientUtil.resolver("[DB_Miharu.Imaging_Core].[Process].[PA_Reporte_ControlLote_Efectividad]", New List(Of QueryParameter) From {
                    ...
                    InformeDataTable = CType(ClientUtil.mapToTypedTable(New DBImaging.SchemaProcess.CTA_Reporte_ControlLote_EfectividadDataTable(), QueryResponse.dataTable), DBImaging.SchemaProcess.CTA_Reporte_ControlLote_EfectividadDataTable)
                ...
                Dim InformeReportDataSource As New ReportDataSource("DS_Efectividad", CType(InformeDataTable, DataTable))

                'Exportación csv
                Dim nombreReporte As String = ""
                If BancoEpago = 1 Then
                    nombreReporte = "ReporteEfectividadBanco" & FechaInicio.ToString("ddMMyyyy") & ".csv"
                ElseIf BancoEpago = 2 Then
                    nombreReporte = "ReporteEfectividadEP" & FechaInicio.ToString("ddMMyyyy") & ".csv"
                Else
                    nombreReporte = "ReporteEfectividad" & FechaInicio.ToString("ddMMyyyy") & ".csv"
                End If
                ...
                Me.ReportViewer.MainReportViewer.LocalReport.ReportEmbeddedResource = "Miharu.Imaging.Library.Report_ControlLotes_Efectividad.rdlc"
