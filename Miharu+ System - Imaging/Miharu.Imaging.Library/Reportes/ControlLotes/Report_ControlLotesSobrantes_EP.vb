...
Namespace Reportes.ControlLotes
    ...
    Public Class Report_ControlLotesSobrantesEP
...
#Region " Declaraciones "
        ...
        Public Overrides ReadOnly Property ReportName As String
            Get
                Return "Reporte de Sobrantes Epago"
            End Get
        End Property
...
#Region " Metodos "
        ...
        Public Overrides Sub Launch()
            ...
            If RangoFechasForm.ShowDialog = Windows.Forms.DialogResult.OK Then
                ...
                Dim InformeDataTable As New DBImaging.SchemaProcess.CTA_Reporte_ControlLote_Sobrantes_EPDataTable
                ...
                Try
                    ...
                    InformeDataTable = dbmImaging.SchemaProcess.PA_Reporte_ControlLote_Sobrantes_EP.DBExecute(Program.ImagingGlobal.ProyectoImagingRow.fk_Entidad, Program.ImagingGlobal.ProyectoImagingRow.fk_Proyecto, FechaInicio, FechaFinal, Oficina, CShort(ColaD))
                ...
                Dim InformeReportDataSource As New ReportDataSource("DS_Sobrante_EP", CType(InformeDataTable, DataTable))
                ...
                Me.ReportViewer.MainReportViewer.LocalReport.ReportEmbeddedResource = "Miharu.Imaging.Library.Report_ControlLotes_Sobrantes_EP.rdlc"
