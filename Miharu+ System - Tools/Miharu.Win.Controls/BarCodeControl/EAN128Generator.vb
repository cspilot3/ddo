...
#Region " Funciones "
        ...
        Public Shared Function getCBarrasImage(ByVal nCodigo As String, ByVal nAncho As Integer, ByVal nAlto As Integer, ByVal nProporcion As Byte, ByVal nCodeAlign As AlignType) As Bitmap
            ...
            Dim BarCodeImage As Bitmap = New System.Drawing.Bitmap(widthImagen, height)
            Dim MyGraphic As Graphics = Graphics.FromImage(BarCodeImage)

            Try
                MyGraphic.FillRectangle(System.Drawing.Brushes.White, 0, 0, widthImagen, height)
                ...
                For codeidx As Integer = 0 To codes.Length - 1
                    ...
                    For bar As Integer = 0 To 7 Step 2
                        ...
                        If (barwidth > 0) Then
                            MyGraphic.FillRectangle(System.Drawing.Brushes.Black, cursor, 0, barwidth, height)
                        End If
...
#Region " Funciones "
        ...
        Private Function StringToCode128(ByVal AsciiData As String) As Integer()
            ...
            Dim csa2 As Code128Code.CodeSetAllowed = CType(IIf(asciiBytes.Length > 0, Code128Code.CodesetAllowedForChar(asciiBytes(1)), Code128Code.CodeSetAllowed.CodeAorB), Code128Code.CodeSetAllowed)

            Dim currcs As CodeSet = GetBestStartSet(csa1, csa2)

            Dim codes As System.Collections.ArrayList = New System.Collections.ArrayList(asciiBytes.Length + 3)
