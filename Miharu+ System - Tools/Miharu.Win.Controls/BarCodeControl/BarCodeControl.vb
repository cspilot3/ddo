...
#Region " Declaraciones "
        ...
        'Private _FileIOPermission As FileIOPermission
...
#Region " Eventos "
        ...
        Private Sub BarCodeControl_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            If _AutoPrint Then PrintAuto()
        End Sub

        Private Sub BarCodeControl_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Resize
            MainPanel.Invalidate()
        End Sub

        Private Sub MainPanel_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles MainPanel.Paint
            Dim intercharacterGap As String = "0"
            Dim str As String = "*" + _BarCode.ToUpper() & "*"
        ...
        Private Sub BarCodePrintDocument_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles BarCodePrintDocument.PrintPage
...
#Region " Metodos "
        ...
        Public Sub SaveImage(ByVal FileName As String, ByVal Format As Imaging.ImageFormat)
            Dim bmp As New Bitmap(Width, Height, System.Drawing.Imaging.PixelFormat.Format32bppArgb)
        ...
        Private Sub setFooterLinesString(ByVal FooterLinesString As String)
            Dim Lineas = FooterLinesString.Split(";"c)
            ...
            For Each Linea In Lineas
                ...
                If Partes.Length = 2 Then
                    If (IsNumeric(Partes(1))) Then
                        FooterLines.Add(New FooterLineItem(Partes(0), CInt(Partes(1))))
                    End If
                End If
            Next
        End Sub
...
#Region " Funciones "
        ...
        Private Function getFooterLinesString() As String
            Dim FooterLinesString As String = ""

            For Each Line In FooterLines
                FooterLinesString = Line.Text & "|" & Line.Column & ";"
            Next

            FooterLinesString = FooterLinesString.TrimEnd(";"c)

            Return FooterLinesString
        End Function
