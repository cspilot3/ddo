...
#Region " Variables Globales "
    ...
    Public Shared Config As New Library.MailSenderConfig
...
#Region " Metodos "
    ...
    Shared Sub Main()
        ...
        Catch ex As Exception
            MessageBox.Show("Se presento un error al iniciar la aplicación. " & ex.Message, Program.AssemblyTitle, MessageBoxButtons.OK, MessageBoxIcon.Error)
            End
        End Try
