...
#Region " Metodos "
    ...
    Protected Overrides Sub LoadControlState(ByVal savedState As Object)
        ...
        _IsConfigureRequired = Boolean.Parse(CStr(GetControlStateValue(IsConfigureRequiredClientControlId, "False")))
        _IsInitializeRequired = Boolean.Parse(CStr(GetControlStateValue(IsInitializeRequiredClientControlId, "False")))
    ...
    Private Function GetControlStateValue(ByVal ControlID As String, Optional ByVal DefaultValue As Object = Nothing) As Object
    ...
    Protected Overrides Sub OnRowDataBound(ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        If (Not DesignMode) Then
            ...
            If (e.Row.RowType = DataControlRowType.DataRow) Then
                e.Row.Attributes("onclick") = ClientGridId & ".PreSelectedIndexChanged" & "( this, " & e.Row.RowIndex & ", true)"
                e.Row.Attributes("ondblclick") = ClientGridId & ".SelectedIndexChanged" & "( this, " & e.Row.RowIndex & ", true)"
    ...
    Public Function GetClientScript() As String
        ...
        Dim isPreSelectedDoPostBack As String = CStr(IIf(_ClickAction = EnumClickAction.OnClickSelectedPostBack, "true", "false"))
        Dim isSelectedDoPostBack As String = CStr(IIf(_ClickAction = EnumClickAction.OnDblClickSelectedPostBack, "true", "false"))
