...
#Region " Declaraciones "
    ...
    Public Shared Config As New Library.FileProviderConfig
...
#Region " Propieddes "
    ...
    Friend Shared ReadOnly Property AppDataPath() As String
        Get
            Return Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData).TrimEnd("\"c) + "\SLYG\Miharu.FileProvider\"
        End Get
    End Property
...
#Region " Metodos "
    ...
    Shared Sub Main()
        ...
        Else
            MessageBox.Show("Ya se esta ejecutando una instancia de la aplicación", Program.AssemblyTitle, MessageBoxButtons.OK, MessageBoxIcon.Information)
            Application.Exit()
        End If
        'C:\WINDOWS\Microsoft.NET\Framework\v2.0.50727\InstallUtil.exe /u FileProvider.exe
    End Sub
