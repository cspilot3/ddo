...
#Region " Variables Globales "
    ...
    Public Const ConfigFileName As String = "ObjectConfigMS.dat"
    Public Shared Config As New MailSenderConfig
    Public Shared ConnectionStrings As MailSenderConfig.TypeConnectionString
    Public Shared ConnectionParameterString As MailSenderConfig.TypeParameterSystem
...
#Region " Propiedades "
    ...
    Friend Shared ReadOnly Property AppDataPath() As String
        Get
            Return Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData).TrimEnd("\"c) + "\SLYG\Miharu.MailSender\"
        End Get
    End Property

    Friend Shared ReadOnly Property AppTempPath() As String
        Get
            Return Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData).TrimEnd("\"c) + "\SLYG\Miharu.MailSender\Temp\"
        End Get
    End Property
