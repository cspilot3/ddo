...
Imports Miharu.CargueLog.Monitor.Forms

Public Class Program
#Region " Declaraciones "

    Public Const ConfigFileName As String = "CargueLogDDOConfig.dat"
    Public Shared Config As New CargueLogConfig
...
#Region " Propiedades "
    ...
    Friend Shared ReadOnly Property AppDataPath() As String
        Get
            Return Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData).TrimEnd("\"c) + "\PYC\Miharu.CargueLogDDO\"
        End Get
    End Property
