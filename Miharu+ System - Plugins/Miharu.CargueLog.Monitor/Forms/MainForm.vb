...
Imports DBSecurity
Imports Miharu.CargueLog.Servicio
...
#Region " Eventos "
        ...
        Private Sub ProbarButton_MouseDown(ByVal sender As System.Object, ByVal e As MouseEventArgs) Handles ProbarButton.MouseDown
            ...
            ElseIf (e.Button = MouseButtons.Right) Then
                Dim obj As New CargueLogService
                obj.IniciarServicio()
            End If
        End Sub
...
#Region " Metodos "
        ...
        Private Sub LoadConfig()
            ...
            PasswordTextBox.Text = CargueLogConfig.Decrypt(Program.Config.Password)
        ...
        Private Sub SaveServico()
            If Validar() Then
                ...
                Program.Config.Password = CargueLogConfig.Encrypt(PasswordTextBox.Text)

                CargueLogConfig.Serialize(Program.Config, Program.AppDataPath)
        ...
        Private Sub ActivarGuardar()
            If Not _Cargando Then
                ...
                HayCambios = (Program.Config.User <> UserTextBox.Text) Or
                             ...
                             (CargueLogConfig.Decrypt(Program.Config.Password) <> PasswordTextBox.Text) Or
        ...
        Private Sub MonitorearServicio()
            ...
            Try
                ...
                For Each ServicioEncontrado As ServiceController In Servicios
                    If ServicioEncontrado.ServiceName = "MiharuCargueLogDDOService" Then
                ...
                Else
                    ...
                    Select Case _Servicio.Status
                        Case ServiceControllerStatus.Running
                            ...
                            NotificacionNotifyIcon.Text = "MiharuCargueLogDDOService [Activo]"

                        Case Else
                            EstadoStatusStripLabel.Text = "Servicio detenido"
                            NotificacionNotifyIcon.Icon = _NotifiIcon_Inactivo
                            NotificacionNotifyIcon.Text = "MiharuCargueLogDDOService [Inactivo]"
        ...
        Private Sub IniciarServicio()
            Try
                ...
                NotificacionNotifyIcon.BalloonTipTitle = "MiharuCargueLogDDOService"
                NotificacionNotifyIcon.BalloonTipText = "El servicio MiharuCargueLogDDOService ha sido activado"
        ...
        Private Sub DetenerServicio()
            Try
                If _Servicio.CanStop Then
                    ...
                    NotificacionNotifyIcon.BalloonTipTitle = "MiharuCargueLogDDOService"
                    NotificacionNotifyIcon.BalloonTipText = "El servicio MiharuCargueLogDDOService ha sido desactivado"
                    NotificacionNotifyIcon.ShowBalloonTip(5000)
                End If
            Catch ex As Exception
        ...
        Public Sub ValidarServicio()
            ...
            Try
                Dim ConnectionStrings As CargueLogConfig.TypeConnectionString
                ...
                ConnectionStrings = CargueLogConfig.getCadenasConexion(WebService)
