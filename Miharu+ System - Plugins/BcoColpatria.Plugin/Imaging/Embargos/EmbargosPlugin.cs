...
namespace BcoColpatria.Plugin.Imaging.Embargos
{
    public class EmbargosPlugin : IDesktopPlugin
    {
        ...
        public const string ConfigurationPrefix = "PluginBcoColpatria_";
        ...
        private string _BcoColpatriaConnectionString;
        ...
        public string BcoColpatriaConnectionString
        {
            get { return this._BcoColpatriaConnectionString; }
        }
        ...
        public static short Imaging_BcoColpatria_ProyectoId { get; set; }
        ...
        {
            Imaging_EntidadId = 54;
            Imaging_BcoColpatria_ProyectoId = 1;
            ...
            if ((nEntidad != Imaging_EntidadId))
                return false;
            if ((nProyecto != Imaging_BcoColpatria_ProyectoId))
                return false;
            return true;
        }
            ...
            try
            {
                ...
                if ((ModuloDataTable.Count > 0))
                {
                    foreach (var modulo_loopVariable in ModuloDataTable)
                    {
                        ...
                        {
                            case 33:
                                this._BcoColpatriaConnectionString = modulo_loopVariable.ConnectionString;
                                break;
                            case 3:
        ...
        {
            return "BancoColpatriaEmbargo_Plugin";
        }

        public string GetName()
        {
            return "Libreria especializada para BancoColpatria-Embargo";
        }
