...
namespace BcoItau.Plugin.Imaging.Atlantico.Forms.Configuracion
{
    public partial class frmEditarCuentaMunicipio : Form
    {
        ...
        public frmEditarCuentaMunicipio(VallePlugin Plugin, int idBuscar, string Accion)
        {
            this._plugin = Plugin;
        ...
        private void LlenarCombos()
        {
            ...
            try
            {
                ...
                DataTable TipoCuentasCorriente = dbmIntegration.SchemaBcoItau.TBL_Tipo_Cuenta_Corriente.DBGet(null);
                ...
                //Tipo Cuentas
                DataTable TipoCuentas = dbmIntegration.SchemaBcoItau.TBL_Tipo_Cuenta.DBGet(null);
                Utilities.LlenarCombo(this.cbTipoCuenta, TipoCuentas, TipoCuentas.Columns["id_Tipo_Cuenta"], TipoCuentas.Columns["Valor"]);
                this.cbTipoCuenta.SelectedIndex = 0;

                //Codigo Compensación
                DataTable CodigoCompensa = dbmIntegration.SchemaBcoItau.TBL_Codigos_Compensacion.DBGet(null);
                ...
                //Estado
                DataTable Estados = dbmIntegration.SchemaBcoItau.TBL_Estado_Cuenta.DBGet(null);
        ...
        private void BuscarCuenta()
        {
            ...
            try
            {
                ...
                DataTable CuentaEncontrada = dbmIntegration.SchemaBcoItau.PA_Select_Relacion_Cuentas_Municipios.DBExecute(this._idBuscar, null, null, null, null, null);
        ...
        private void ActualizarCuenta()
        {
            ...
            try
            {
                ...
                {
                    DBIntegration.SchemaBcoItau.TBL_Relacion_Cuentas_MunicipioType regUpdate = new DBIntegration.SchemaBcoItau.TBL_Relacion_Cuentas_MunicipioType();
                    regUpdate.No_Cuenta_BcoItau = this.txtNoCuentaBcoBogota.Text;
                    ...
                    dbmIntegration.SchemaBcoItau.TBL_Relacion_Cuentas_Municipio.DBUpdate(regUpdate, this._idBuscar);
        ...
        private void InsertarCuenta()
        {
            ...
            try
            {
                ...
                var CuentaBuscar = this.txtNumeroCuenta.Text;
                //TODO validar que no exista la cuenta
                int idVigente = Convert.ToInt32(dbmIntegration.SchemaBcoItau.TBL_Estado_Cuenta.DBFindByNombre_Estado("Vigente").ToList().First().id);
                var EncontradaCuenta = dbmIntegration.SchemaBcoItau.TBL_Relacion_Cuentas_Municipio.DBFindByNumero_Cuentafk_Estado_Cuenta(CuentaBuscar, idVigente);
                ...
                else
                {
                    if (MessageBox.Show("Desea realmente Guardar los Cambios?", "Guardar Cambios", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)
                    {
                        DBIntegration.SchemaBcoItau.TBL_Relacion_Cuentas_MunicipioType regInsertar = new DBIntegration.SchemaBcoItau.TBL_Relacion_Cuentas_MunicipioType();
                        regInsertar.No_Cuenta_BcoItau = this.txtNoCuentaBcoBogota.Text;
                        ...
                        dbmIntegration.SchemaBcoItau.TBL_Relacion_Cuentas_Municipio.DBInsert(regInsertar);
