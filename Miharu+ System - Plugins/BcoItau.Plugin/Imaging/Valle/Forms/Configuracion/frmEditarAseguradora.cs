...
namespace BcoItau.Plugin.Imaging.Atlantico.Forms.Configuracion
{
    public partial class frmEditarAseguradora : Form
    {
        ...
        public frmEditarAseguradora(VallePlugin Plugin, int idBuscar, string Accion)
        {
            this._plugin = Plugin;
        ...
        private void BuscarCuenta()
        {
            ...
            try
            {
                ...
                var AseguradoraEncontrada = dbmIntegration.SchemaBcoItau.PA_Select_Aseguradoras.DBExecute(this._idBuscar, null, null, null, null, null, true);
        ...
        private void InsertarCuenta()
        {
            ...
            try
            {
                ...
                var EncontradaAseguradora = dbmIntegration.SchemaBcoItau.TBL_Aseguradoras.DBFindByNitActivo(NitBuscar, true);
                ...
                else
                {
                    ...
                    {
                        DBIntegration.SchemaBcoItau.TBL_AseguradorasType regInsertar = new DBIntegration.SchemaBcoItau.TBL_AseguradorasType();
                        ...
                        dbmIntegration.SchemaBcoItau.TBL_Aseguradoras.DBInsert(regInsertar);
        ...
        private void ActualizarCuenta()
        {
            ...
            try
            {
                ...
                if (MessageBox.Show("Desea realmente Guardar los Cambios?", "Guardar Cambios", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)
                {
                    DBIntegration.SchemaBcoItau.TBL_AseguradorasType regUpdate = new DBIntegration.SchemaBcoItau.TBL_AseguradorasType();
                    regUpdate.Activo = this.cbEstados.SelectedValue.ToString() == "1" ? true : false;
                    dbmIntegration.SchemaBcoItau.TBL_Aseguradoras.DBUpdate(regUpdate, this._idBuscar);
