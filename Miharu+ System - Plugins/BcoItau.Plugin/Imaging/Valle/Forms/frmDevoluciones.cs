...
namespace BcoItau.Plugin.Imaging.Valle.Forms
{
    public partial class frmDevoluciones : Form
    {
        ...
        public frmDevoluciones(VallePlugin plugin)
        {
            this._Plugin = plugin;
            InitializeComponent();
        }
        ...
        private void btnInsertarRegistro_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (ValidarCampos())
                {
                    ...
                    var encontradoFormulario = dbmIntegration.SchemaBcoItau.TBL_Formularios_Devueltos.DBFindByNumero_Formulario(this.txtFormulario.Text);
                    ...
                    DBIntegration.SchemaBcoItau.TBL_Formularios_DevueltosType rowInsertar = new DBIntegration.SchemaBcoItau.TBL_Formularios_DevueltosType();
                    ...
                    this.Cursor = Cursors.WaitCursor;
                    dbmIntegration.SchemaBcoItau.TBL_Formularios_Devueltos.DBInsert(rowInsertar);
        ...
        private void CargarCombos()
        {
            ...
            try
            {
                ...
                var Oficinas = dbmIntegration.SchemaBcoItau.PA_Obtiene_Oficinas.DBExecute(this._Plugin.Manager.ImagingGlobal.Entidad);
                ...
                var CausalesDevolucion = dbmIntegration.SchemaBcoItau.TBL_Causales_Devolucion.DBGet(null);
        ...
        {                                                                                                                                                          
            ...
            try
            {
                ...
                var Devueltos = dbmIntegration.SchemaBcoItau.PA_Select_Formularios_Devueltos.DBExecute(id_form_devuelto, Fecha_Recaudo, Oficina_str, Num_formulario, placa, causal);
