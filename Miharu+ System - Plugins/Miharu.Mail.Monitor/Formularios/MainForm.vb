...
Imports DBAgrario
Imports DBCattanDatos
Imports DBCattanImages
Imports DBCore
Imports DBSecurity
Imports Miharu.Mail.Servicio
...
#Region " Metodos "
        ...
        Private Sub LoadConfig()
            ...
            PasswordTextBox.Text = MailConfig.Decrypt(Program.Config.Password)
        ...
        Private Sub SaveServico()
            If Validar() Then
                ...
                Program.Config.Password = MailConfig.Encrypt(PasswordTextBox.Text)

                MailConfig.Serialize(Program.Config, Program.AppDataPath)
        ...
        Private Sub ActivarGuardar()
            If Not _Cargando Then
                ...
                HayCambios = (Program.Config.User <> UserTextBox.Text) Or _
                             ...
                             (MailConfig.Decrypt(Program.Config.Password) <> PasswordTextBox.Text) Or _
        ...
        Private Sub MonitorearServicio()
            ...
            Try
                ...
                For Each ServicioEncontrado As ServiceController In Servicios
                    If ServicioEncontrado.ServiceName = "MailService" Then
                ...
                Else
                    ...
                    Select Case _Servicio.Status
                        Case ServiceControllerStatus.Running
                            ...
                            NotificacionNotifyIcon.Text = "Miharu Mail [Activo]"

                        Case Else
                            EstadoStatusStripLabel.Text = "Servicio detenido"
                            NotificacionNotifyIcon.Icon = _NotifiIcon_Inactivo
                            NotificacionNotifyIcon.Text = "Miharu Mail [Inactivo]"
        ...
        Private Sub IniciarServicio()
            Try
                ...
                NotificacionNotifyIcon.BalloonTipTitle = "Miharu Mail"
                NotificacionNotifyIcon.BalloonTipText = "El servicio Miharu Mail ha sido activado"
        ...
        Private Sub DetenerServicio()
            Try
                If _Servicio.CanStop Then
                    ...
                    NotificacionNotifyIcon.BalloonTipTitle = "Miharu Mail"
                    NotificacionNotifyIcon.BalloonTipText = "El servicio Miharu Mail ha sido desactivado"
                    NotificacionNotifyIcon.ShowBalloonTip(5000)
                End If
            Catch ex As Exception
        ...
        Public Sub ValidarServicio()
            ...
            Try
                Dim ConnectionStrings As MailConfig.TypeConnectionString
                ...
                ConnectionStrings = MailConfig.getCadenasConexion(WebService)
                ...
                Try
                    dbmCore = New DBCoreDataBaseManager(ConnectionStrings.Core)
