...
Imports DBSecurity
Imports Miharu.DDOTransfer.Servicio
...
#Region " Eventos "
        ...
        Private Sub ProbarButton_MouseDown(ByVal sender As System.Object, ByVal e As MouseEventArgs) Handles ProbarButton.MouseDown
            ...
            ElseIf (e.Button = MouseButtons.Right) Then
                Dim obj As New DDOTransferService
                obj.IniciarServicio()
            End If
        End Sub
...
#Region " Metodos "
        ...
        Private Sub LoadConfig()
            ...
            PasswordTextBox.Text = DDOTransferConfig.Decrypt(Program.Config.Password)
        ...
        Private Sub SaveServico()
            If Validar() Then
                ...
                Program.Config.Password = DDOTransferConfig.Encrypt(PasswordTextBox.Text)

                DDOTransferConfig.Serialize(Program.Config, Program.AppDataPath)
        ...
        Private Sub ActivarGuardar()
            If Not _Cargando Then
                ...
                HayCambios = (Program.Config.User <> UserTextBox.Text) Or
                             ...
                             (DDOTransferConfig.Decrypt(Program.Config.Password) <> PasswordTextBox.Text) Or
        ...
        Private Sub MonitorearServicio()
            ...
            Try
                ...
                For Each ServicioEncontrado As ServiceController In Servicios
                    If ServicioEncontrado.ServiceName = "DDOTransferService" Then
                ...
                Else
                    ...
                    Select Case _Servicio.Status
                        Case ServiceControllerStatus.Running
                            ...
                            NotificacionNotifyIcon.Text = "DDOTransferService [Activo]"

                        Case Else
                            EstadoStatusStripLabel.Text = "Servicio detenido"
                            NotificacionNotifyIcon.Icon = _NotifiIcon_Inactivo
                            NotificacionNotifyIcon.Text = "DDOTransferService [Inactivo]"
        ...
        Private Sub IniciarServicio()
            Try
                ...
                NotificacionNotifyIcon.BalloonTipTitle = "DDOTransferService"
                NotificacionNotifyIcon.BalloonTipText = "El servicio DDOTransferService ha sido activado"
        ...
        Private Sub DetenerServicio()
            Try
                If _Servicio.CanStop Then
                    ...
                    NotificacionNotifyIcon.BalloonTipTitle = "DDOTransferService"
                    NotificacionNotifyIcon.BalloonTipText = "El servicio DDOTransferService ha sido desactivado"
                    NotificacionNotifyIcon.ShowBalloonTip(5000)
                End If
            Catch ex As Exception
        ...
        Public Sub ValidarServicio()
            ...
            Try
                Dim ConnectionStrings As DDOTransferConfig.TypeConnectionString
                ...
                ConnectionStrings = DDOTransferConfig.getCadenasConexion(WebService)
