...
Imports Miharu.Reportes.Monitor.Forms

Public Class Program
#Region " Declaraciones "

    Public Const ConfigFileName As String = "ReportesConfig.dat"
    Public Shared Config As New ReportesConfig
...
#Region " Propiedades "
    ...
    Friend Shared ReadOnly Property AppDataPath() As String
        Get
            Return Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData).TrimEnd("\"c) + "\PYC\Miharu.Reportes\"
        End Get
    End Property
