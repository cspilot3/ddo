...
Imports Miharu.Migracion.Servicio
...
#Region " Declaraciones "
    ...
    Public Shared Config As New MigracionConfig
    Public Shared ConnectionStringsR As MigracionConfig.TypeConnectionString
    Public Shared ConnectionStringsC As MigracionConfig.TypeConnectionString
...
#Region " Propiedades "
    ...
    Friend Shared ReadOnly Property AppDataPath() As String
        Get
            Return Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData).TrimEnd("\"c) + "\PYC\Miharu.Migracion\"
        End Get
    End Property
