...
#Region " Declaraciones "
    ...
    Public Shared ConnectionStrings As ReportesConfig.TypeConnectionString
...
#Region " Propiedades "
    ...
    Friend Shared ReadOnly Property AppDataPath() As String
        Get
            Return Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData).TrimEnd("\"c) + "\PYC\Miharu.ReportesDDO\"
        End Get
    End Property
