...
Imports DBSecurity
Imports Miharu.DDOEnvioCorreo
Imports Miharu.DDOEnvioCorreo.Servicio
...
#Region " Eventos "
        ...
        Private Sub ProbarButton_MouseDown(ByVal sender As System.Object, ByVal e As MouseEventArgs) Handles ProbarButton.MouseDown
            ...
            ElseIf (e.Button = MouseButtons.Right) Then
                Dim obj As New DDOEnvioCorreoService
                obj.IniciarServicio()
            End If
        End Sub
...
#Region " Metodos "
        ...
        Private Sub LoadConfig()
            ...
            PasswordTextBox.Text = DDOEnvioCorreoConfig.Decrypt(Program.Config.Password)
        ...
        Private Sub SaveServico()
            If Validar() Then
                ...
                Program.Config.Password = DDOEnvioCorreoConfig.Encrypt(PasswordTextBox.Text)
                Program.Config.RutaLog = LogFolderTextBox.Text
                Program.Config.LogActivo = LogActivoCheckBox.Checked

                DDOEnvioCorreoConfig.Serialize(Program.Config, Program.AppDataPath)
        ...
        Private Sub ActivarGuardar()
            If Not _Cargando Then
                ...
                HayCambios = (Program.Config.User <> UserTextBox.Text) Or
                             ...
                             (DDOEnvioCorreoConfig.Decrypt(Program.Config.Password) <> PasswordTextBox.Text) Or
        ...
        Private Sub MonitorearServicio()
            ...
            Try
                ...
                For Each ServicioEncontrado As ServiceController In Servicios
                    If ServicioEncontrado.ServiceName = "DDOEnvioCorreoService" Then
                ...
                Else
                    ...
                    Select Case _Servicio.Status
                        Case ServiceControllerStatus.Running
                            ...
                            NotificacionNotifyIcon.Text = "DDOEnvioCorreoService [Activo]"

                        Case Else
                            EstadoStatusStripLabel.Text = "Servicio detenido"
                            NotificacionNotifyIcon.Icon = _NotifiIcon_Inactivo
                            NotificacionNotifyIcon.Text = "DDOEnvioCorreoService [Inactivo]"
        ...
        Private Sub IniciarServicio()
            Try
                ...
                NotificacionNotifyIcon.BalloonTipTitle = "DDOEnvioCorreoService"
                NotificacionNotifyIcon.BalloonTipText = "El servicio DDOEnvioCorreoService ha sido activado"
        ...
        Private Sub DetenerServicio()
            Try
                If _Servicio.CanStop Then
                    ...
                    NotificacionNotifyIcon.BalloonTipTitle = "DDOEnvioCorreoService"
                    NotificacionNotifyIcon.BalloonTipText = "El servicio DDOEnvioCorreoService ha sido desactivado"
                    NotificacionNotifyIcon.ShowBalloonTip(5000)
                End If
            Catch ex As Exception
        ...
        Public Sub ValidarServicio()
            ...
            Try
                Dim ConnectionStrings As DDOEnvioCorreoConfig.TypeConnectionString
                ...
                ConnectionStrings = DDOEnvioCorreoConfig.getCadenasConexion(WebService)
