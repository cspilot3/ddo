...
#Region " Código generado por el Diseñador de Windows Forms "
        ...
        Protected Overloads Overrides Sub Dispose(ByVal nDisposing As Boolean)
            If nDisposing Then
                If Not (components Is Nothing) Then
                    components.Dispose()
                End If
            End If
            MyBase.Dispose(nDisposing)
        End Sub
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            'pi
            '
            Me.pi.Image = Global.Miharu.FileSending.Monitor.My.Resources.Resources.FileSendingMonitor
            ...
            Me.btnAceptar.Image = Global.Miharu.FileSending.Monitor.My.Resources.Resources.Aceptar
...
#End Region
        ...
        Private Sub ShowData()
            ...
            Me.txtBoxDescription.Text = Program.AssemblyDescription & vbCrLf & vbCrLf & Program.AppDataPath
        End Sub
