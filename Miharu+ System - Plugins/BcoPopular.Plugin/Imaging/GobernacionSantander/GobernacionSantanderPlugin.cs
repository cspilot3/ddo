...
{
    public class GobernacionSantanderPlugin : IDesktopPlugin
    {
        ...
        private EventExecuterGobernacionSantander _EventExecuter;
        ...
        private FormImagingWorkSpaceWrapperGobernacionSantander _Wrapper;
        ...
        public GobernacionSantanderPlugin()
        {
            this._EventExecuter = new EventExecuterGobernacionSantander(this);
        }
        ...
        public FormImagingWorkSpaceWrapperGobernacionSantander Wrapper
        {
        ...
        public bool IsValidPlugin(Miharu.Desktop.Library.ProcessLibraryType nProcessType, int nEntidad, int nProyecto)
        {
            ...
            Imaging_BcoPopular_ProyectoId = 2;
        ...
        public void Activate()
        {
            try
            {
                this._Wrapper = new FormImagingWorkSpaceWrapperGobernacionSantander(this);
        ...
        {
            return "BancoPopular_GobernacionSantanderPlugin";
        }

        public string GetName()
        {
            return "Libreria especializada para BancoPopular-GobernacionSantander";
        }
