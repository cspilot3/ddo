...
using BcoPopular.Plugin.Imaging.GobernacionSantander.Forms;

namespace Imaging.GobernacionSantander
{
    public class FormImagingWorkSpaceWrapperGobernacionSantander
    {
        #region "Declaraciones"

        public GobernacionSantanderPlugin _plugin = null;
        ...
        public FormImagingWorkSpaceWrapperGobernacionSantander(GobernacionSantanderPlugin nPlugin)
        {
            _plugin = nPlugin;
        }
        #endregion
