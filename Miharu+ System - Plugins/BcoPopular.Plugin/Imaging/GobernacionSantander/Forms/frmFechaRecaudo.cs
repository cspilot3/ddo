...
namespace BcoPopular.Plugin.Imaging.GobernacionSantander.Forms
{
    public partial class frmFechaRecaudo : Form
    {
        ...
        public frmFechaRecaudo(bool matrices = false, string Tipo = "")
        {
            ...
            if (Tipo == "DETALLADO")
            {
                this.Text = "Rango Fecha Recaudo";
                this.lblFechaRecaudo.Text = "Fecha Inicial";

                this.lblFechaRecaudo2.Visible = true;
                this.lblFechaRecaudo2.Text = "Fecha Final";
                this.dtpFechaInicial2.Visible = true;
