...
namespace Imaging.GobernacionSantander
{
    public class EventExecuterGobernacionSantander : EventExecuter, IEventExecuter
    {
        ...
        public EventExecuterGobernacionSantander(GobernacionSantanderPlugin nPlugin)
        {
        ...
        public void FinalizarIndexacion(int nidCargue, short nidPaquete)
        {
            ...
            try
            {
                ...
                dbmIntegration.SchemaBcoPopular.PA_Finalizar_Indexacion.DBExecute(nidCargue, nidPaquete);
                dbmIntegration.Transaction_Commit();
            }
            catch (Exception ex)
            {
                dbmIntegration.Transaction_Rollback();
                DesktopMessageBoxControl.DesktopMessageShow("Finalizar Indexacion", ref ex);
            }
            finally
            {
        ...
        public void FinalizarReproceso(long nidExpediente, short nidFolder, short nidFile, short nidVersion)
        {
            ...
            try
            {
                dbmIntegration.Connection_Open(this._Plugin.Manager.Sesion.Usuario.id);
                dbmIntegration.Transaction_Begin();
                dbmIntegration.SchemaBcoPopular.PA_Finalizar_Reproceso.DBExecute(nidExpediente, nidFolder, nidFile, this._Plugin.Manager.ImagingGlobal.Entidad, this._Plugin.Manager.ImagingGlobal.Proyecto);
                dbmIntegration.Transaction_Commit();
            }
            catch (Exception ex)
            {
                dbmIntegration.Transaction_Rollback();
                DesktopMessageBoxControl.DesktopMessageShow("Finalizar Reproceso", ref ex);
            }
            finally
            {
                dbmIntegration.Connection_Close();
        ...
        public void FinalizarProcesoAdicionalCaptura(long nidExpediente, short nidFolder, short nidFile, short nidVersion)
        {
            ...
            try
            {
                dbmIntegration.Connection_Open(this._Plugin.Manager.Sesion.Usuario.id);
                dbmIntegration.Transaction_Begin();
                dbmIntegration.SchemaBcoPopular.PA_Finalizar_Captura_Adicional.DBExecute(nidExpediente, nidFolder, nidFile, nidVersion, this._Plugin.Manager.ImagingGlobal.Entidad, this._Plugin.Manager.ImagingGlobal.Proyecto);
                dbmIntegration.Transaction_Commit();
            }
            catch (Exception ex)
            {
                dbmIntegration.Transaction_Rollback();
                DesktopMessageBoxControl.DesktopMessageShow("Finalizar Captura Adicional", ref ex);
            }
            finally
            {
                dbmIntegration.Connection_Close();
        ...
        public void FinalizarCruceGenerico(short nidEntidad, short nidProyecto, int nidFechaProceso, int nidOT)
        {
            ...
            try
            {
                dbmIntegration.Connection_Open(this._Plugin.Manager.Sesion.Usuario.id);
                dbmIntegration.Transaction_Begin();
                dbmIntegration.SchemaBcoPopular.PA_Finalizar_Cruce_Santander.DBExecute(nidEntidad, nidProyecto, nidFechaProceso, nidOT);
                dbmIntegration.Transaction_Commit();
            }
            catch (Exception ex)
            {
                dbmIntegration.Transaction_Rollback();
                DesktopMessageBoxControl.DesktopMessageShow("Finalizar Cruce", ref ex);
            }
            finally
            {
                dbmIntegration.Connection_Close();
