...
{
    public class EventExecuterHacienda : EventExecuter, IEventExecuter
    {
        ...
        public EventExecuterHacienda(HaciendaPlugin nPlugin)
        {
        ...
        public void FinalizarCruceGenerico(short nidEntidad, short nidProyecto, int nidFechaProceso, int nidOT)
        {
            ...
            try
            {
                dbmIntegration.Connection_Open(this._Plugin.Manager.Sesion.Usuario.id);
                dbmIntegration.Transaction_Begin();
                dbmIntegration.SchemaBcoPopular.PA_Finalizar_Cruce_Santander.DBExecute(nidFechaProceso, nidEntidad, nidProyecto, nidOT);
                dbmIntegration.Transaction_Commit();
            }
            catch (Exception ex)
            {
