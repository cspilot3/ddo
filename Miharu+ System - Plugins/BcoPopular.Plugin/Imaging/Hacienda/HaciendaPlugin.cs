...
{
    public class HaciendaPlugin : IDesktopPlugin
    {
        ...
        private EventExecuterHacienda _EventExecuter;
        ...
        private FormImagingWorkSpaceWrapperHacienda _Wrapper;
        ...
        public HaciendaPlugin()
        {
            this._EventExecuter = new EventExecuterHacienda(this);
        }
        ...
        public FormImagingWorkSpaceWrapperHacienda Wrapper
        {
        ...
        public bool IsValidPlugin(Miharu.Desktop.Library.ProcessLibraryType nProcessType, int nEntidad, int nProyecto)
        {
            ...
            Imaging_BcoPopular_ProyectoId = 3;
        ...
        public void Activate()
        {
            try
            {
                this._Wrapper = new FormImagingWorkSpaceWrapperHacienda(this);
        ...
        {
            return "BancoPopular_HaciendaPlugin";
        }
