...
using BcoPopular.Plugin.Imaging.Asistidos.Forms;

namespace Imaging.Asistidos
{
    public class FormImagingWorkSpaceWrapperAsistidos
    {
        #region "Declaraciones"

        public AsistidosPlugin _plugin = null;
        ...
        public FormImagingWorkSpaceWrapperAsistidos(AsistidosPlugin nPlugin)
        {
            _plugin = nPlugin;
        }
        #endregion
