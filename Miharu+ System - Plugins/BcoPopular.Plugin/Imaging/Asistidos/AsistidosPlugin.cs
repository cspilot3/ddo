...
{
    public class AsistidosPlugin : IDesktopPlugin
    {
        ...
        private EventExecuterAsistidos _EventExecuter;
        ...
        private FormImagingWorkSpaceWrapperAsistidos _Wrapper;
        ...
        public AsistidosPlugin()
        {
            this._EventExecuter = new EventExecuterAsistidos(this);
        }
        ...
        public FormImagingWorkSpaceWrapperAsistidos Wrapper
        {
        ...
        public bool IsValidPlugin(Miharu.Desktop.Library.ProcessLibraryType nProcessType, int nEntidad, int nProyecto)
        {
            ...
            Imaging_BcoPopular_ProyectoId = 4;
        ...
        public void Activate()
        {
            try
            {
                this._Wrapper = new FormImagingWorkSpaceWrapperAsistidos(this);
        ...
        {
            return "BancoPopular_Plugin";
        }

        public string GetName()
        {
            return "Libreria especializada para BancoPopular-Asistidos";
        }
