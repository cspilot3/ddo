...
{
    public class EventExecuterGobernacionAntioquia : EventExecuter, IEventExecuter
    {
        ...
        public EventExecuterGobernacionAntioquia(GobernacionAntioquiaPlugin nPlugin)
        {
        ...
        public void FinalizarCruceGenerico(short nidEntidad, short nidProyecto, int nidFechaProceso, int nidOT)
        {
            ...
            try
            {
                dbmIntegration.Connection_Open(this._Plugin.Manager.Sesion.Usuario.id);
                dbmIntegration.Transaction_Begin();
                dbmIntegration.SchemaBcoPopular.PA_Finalizar_Cruce.DBExecute(nidEntidad, nidProyecto, nidFechaProceso, nidOT);
                dbmIntegration.Transaction_Commit();
            }
            catch (Exception ex)
            {
