...
using BcoPopular.Plugin.Imaging.GobernacionAntioquia.Forms;

namespace Imaging.GobernacionAntioquia
{
    public class FormImagingWorkSpaceWrapperGobernacionAntioquia
    {
        #region "Declaraciones"

        public GobernacionAntioquiaPlugin _plugin = null;
        ...
        public FormImagingWorkSpaceWrapperGobernacionAntioquia(GobernacionAntioquiaPlugin nPlugin)
        {
            _plugin = nPlugin;
        }
        #endregion
        ...
        public void AplicarCambios()
        {
            try
            {
                ...
                BancoPopularToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { ReportesToolStripMenuItem, ExportarToolStripMenuItem });
                ...
                ExportarToolStripMenuItem.Visible = _plugin.Manager.Sesion.Usuario.PerfilManager.PuedeAcceder(Permisos.Imaging.BancoPopular.Path);
