...
#Region " Propiedades "
    ...
    Friend Shared ModuloId As Short = 27
    ...
    Public Const ConfigurationPrefix = "PluginSantander_"

    ' Proyecto al que responde el Plugin
    Public Shared Property SantanderEntidadId() As Short = 27
    Public Shared Property Imagenes_ValidacionListas_ProyectoId() As Short = 1
    Public Shared Property Imagenes_Embargos_ProyectoId() As Short = 2
    Public Shared Property Imagenes_DesEmbargos_ProyectoId() As Short = 3
    Public Shared Property Imagenes_EmbargosDesembargos_ProyectoId() As Short = 5
