...
Namespace Imaging.Beps.Reportes.Rechazados
    Public Class ReportRechazados
        ...
        Public Overrides Sub Launch()
            ...
            If rangoFechasForm.ShowDialog() = DialogResult.OK Then
                ...
                Try
                    ...
                    Dim dsInforme = dbmIntegration.SchemaColpensionesBEPS.PA_Report_Estado.DBExecute(CInt(fechaInicio.ToString("yyyyMMdd")), CInt(fechaFinal.ToString("yyyyMMdd")), OT, 2)
                    ...
                    ReportViewer.MainReportViewer.LocalReport.ReportEmbeddedResource = "Colpensiones.Plugin.ReportRechazados.rdlc"
