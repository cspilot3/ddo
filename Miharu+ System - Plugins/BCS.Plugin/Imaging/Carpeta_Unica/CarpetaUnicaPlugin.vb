...
Namespace Imaging.Carpeta_Unica
    Public Class CarpetaUnicaPlugin
        Implements IDesktopPlugin

#Region " Declaraciones "

        Public Const ModuloId As Short = 32

        Public Const ConfigurationPrefix = "PluginBCS_"

        Private _EventExecuter As New EventExecuterCarpetaUnica(Me)

        Private _Manager As DesktopPluginManager

        Private _WorkSpace As FormImagingWorkSpace

        Private _CajaSocialConnectionString As String

        Private _ToolsConnectionString As String

        Private _SofTracConnectionString As String

        Private _Wrapper As FormImagingWorkSpaceWrapperCarpetaUnica
...
#Region " Propiedades "
        ...
        Public ReadOnly Property CajaSocialConnectionString() As String
            Get
                Return Me._CajaSocialConnectionString
            End Get
        End Property
        ...
        Public ReadOnly Property Wrapper As FormImagingWorkSpaceWrapperCarpetaUnica
            Get
                Return Me._Wrapper
            End Get
        End Property
        ...
        Public Shared Property Imaging_EntidadId() As Short = 28
        Public Shared Property Imaging_CarpetaUnica_ProyectoId() As Short = 1
...
#Region " Implementacion IDesktopPlugin "
        ...
        Public Function IsValidPlugin(nProcessType As Miharu.Desktop.Library.ProcessLibraryType, nEntidad As Integer, nProyecto As Integer) As Boolean Implements Miharu.Desktop.Library.Plugins.IDesktopPlugin.IsValidPlugin
            ...
            If (nProyecto <> Imaging_CarpetaUnica_ProyectoId) Then Return False
            Return True
        End Function
                ...
                If (ModuloDataTable.Count > 0) Then
                    For Each modulo In ModuloDataTable
                        Select Case modulo.id_Modulo
                            Case 32
                                Me._CajaSocialConnectionString = modulo.ConnectionString
                            Case 3
        ...
        Public Sub Activate() Implements Miharu.Desktop.Library.Plugins.IDesktopPlugin.Activate
            Try
                Me._Wrapper = New FormImagingWorkSpaceWrapperCarpetaUnica(Me)
