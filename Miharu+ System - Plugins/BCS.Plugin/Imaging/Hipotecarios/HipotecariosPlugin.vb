...
Namespace Imaging.Hipotecarios
    Public Class HipotecariosPlugin
...
#Region " Declaraciones "
        ...
        Private _EventExecuter As New EventExecuterHipotecarios(Me)
        ...
        Private _Wrapper As FormImagingWorkSpaceWrapperHipotecarios
...
#Region " Propiedades "
        ...
        Public ReadOnly Property Wrapper As FormImagingWorkSpaceWrapperHipotecarios
            Get
                Return Me._Wrapper
            End Get
        End Property
        ...
        Public Shared Property Imaging_Hipotecarios_ProyectoId() As Short = 3
...
#Region " Implementacion IDesktopPlugin "
        Public Sub Activate() Implements Miharu.Desktop.Library.Plugins.IDesktopPlugin.Activate
            Try
                Me._Wrapper = New FormImagingWorkSpaceWrapperHipotecarios(Me)
        ...
        Public Function IsValidPlugin(nProcessType As Miharu.Desktop.Library.ProcessLibraryType, nEntidad As Integer, nProyecto As Integer) As Boolean Implements Miharu.Desktop.Library.Plugins.IDesktopPlugin.IsValidPlugin
            ...
            If (nProyecto <> Imaging_Hipotecarios_ProyectoId) Then Return False
            Return True
        End Function
#End Region
