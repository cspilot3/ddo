...
#Region " Declaraciones "
    ...
    Private Shared _sesion As Miharu.Security.Library.Session.Sesion
    Private Shared _desktopGlobal As DesktopGlobal
    Private Shared _riskGlobal As RiskGlobal
    Private Shared _imagingGlobal As ImagingGlobal
...
#Region " Propiedades "
    ...
    Friend Shared Property Sesion() As Miharu.Security.Library.Session.Sesion
        Get
            Return _sesion
        End Get
