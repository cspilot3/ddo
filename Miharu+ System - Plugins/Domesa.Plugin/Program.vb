...
#Region " Propiedades "
    ...
    Friend Shared ModuloId As Short = 28
    ...
    Public Const ConfigurationPrefix = "PluginDomesa_"

    ' Proyecto al que responde el Plugin
    Public Shared Property DomesaEntidadId() As Short = 1
    Public Shared Property DomesaProyectoImagenesId() As Short = 1
