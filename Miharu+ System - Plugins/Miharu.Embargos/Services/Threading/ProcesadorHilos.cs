...
namespace Miharu.CentralizacionEmbargos.Services.Threading
{
    public class ProcesadorHilos
    {
        ...
        public CentralizacionEmbargosService servicio;

        #endregion

        public ProcesadorHilos()
        {
            numHilos = Program.ConnectionParametersStrings.threadCount;
        }
        ...
        #region " Metodos "
        public void AgregarHilo(DBEmbargos.SchemaProcess.CTA_Cruce_En_Linea_ProcesoRow nExpedienteRow)
        {
            if (!TieneHiloslibres())
            {
                do
