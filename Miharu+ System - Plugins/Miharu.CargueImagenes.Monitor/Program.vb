...
Imports Miharu.CargueImagenes.Monitor.Forms

Public Class Program
#Region " Declaraciones "

    Public Const ConfigFileName As String = "CargueImagenesConfig.dat"
    Public Shared Config As New CargueImagenesConfig
...
#Region " Propiedades "
    ...
    Friend Shared ReadOnly Property AppDataPath() As String
        Get
            Return Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData).TrimEnd("\"c) + "\PYC\Miharu.CargueImagenesDDO\"
        End Get
    End Property
