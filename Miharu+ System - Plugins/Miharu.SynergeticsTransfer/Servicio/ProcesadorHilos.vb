...
Public Class ProcesadorHilos
    ...
    Public servicio As SynergeticsService

    Public Sub AgregarHilo(nTransferenciarow As DBSofTrac.SchemaProcess.CTA_Registros_Transferencia_SynergeticsRow)
    ...
    Public Sub AgregarHiloArchivos(filaBatch As DBSofTrac.SchemaProcess.CTA_Get_Batch_MasivoRow)
        If TieneHiloslibres() = False Then
            Do
                Thread.Sleep(1000)
                If TieneHiloslibres() Then
