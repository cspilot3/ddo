...
Imports Miharu.Exportar.Servicio
Imports DBSecurity
Imports DB_Users_Explorer
...
#Region " Eventos "
        ...
        Private Sub ProbarButton_MouseDown(ByVal sender As System.Object, ByVal e As MouseEventArgs) Handles ProbarButton.MouseDown
            ...
            ElseIf (e.Button = MouseButtons.Right) Then
                Dim obj As New ExportarService
                obj.IniciarServicio()
            End If
        End Sub
        ...
        Private Sub PasswordTextBox_TextChanged(ByVal sender As System.Object, ByVal e As EventArgs) Handles PasswordTextBox.TextChanged
            ActivarGuardar()
        End Sub
        Private Sub CarpetaSalidaTextBox_TextChanged(sender As System.Object, e As System.EventArgs) Handles CarpetaSalidaTextBox.TextChanged
            ActivarGuardar()
        End Sub
#End Region
...
#Region " Metodos "
        ...
        Private Sub LoadConfig()
            ...
            CarpetaSalidaTextBox.Text = Program.Config.RutaPath
            PasswordTextBox.Text = DescargaMasivaImagenesConfig.Decrypt(Program.Config.Password)
        ...
        Private Sub SaveServico()
            If Validar() Then
                ...
                Program.Config.RutaPath = CarpetaSalidaTextBox.Text
                Program.Config.Password = DescargaMasivaImagenesConfig.Encrypt(PasswordTextBox.Text)

                DescargaMasivaImagenesConfig.Serialize(Program.Config, Program.AppDataPath)
        ...
        Private Sub ActivarGuardar()
            If Not _Cargando Then
                ...
                HayCambios = (Program.Config.User <> UserTextBox.Text) Or _
                             (Program.Config.RutaPath <> CarpetaSalidaTextBox.Text) Or _
                             (Program.Config.SecurityWebServiceURL <> ServicioWebTextBox.Text) Or _
                             (DescargaMasivaImagenesConfig.Decrypt(Program.Config.Password) <> PasswordTextBox.Text) Or _
        ...
        Private Sub MonitorearServicio()
            ...
            Try
                ...
                For Each ServicioEncontrado As ServiceController In Servicios
                    If ServicioEncontrado.ServiceName = "ExportarService" Then
                ...
                Else
                    ...
                    Select Case _Servicio.Status
                        Case ServiceControllerStatus.Running
                            ...
                            NotificacionNotifyIcon.Text = "ExportarService [Activo]"

                        Case Else
                            EstadoStatusStripLabel.Text = "Servicio detenido"
                            NotificacionNotifyIcon.Icon = _NotifiIcon_Inactivo
                            NotificacionNotifyIcon.Text = "ExportarService [Inactivo]"
        ...
        Private Sub IniciarServicio()
            Try
                ...
                NotificacionNotifyIcon.BalloonTipTitle = "ExportarService"
                NotificacionNotifyIcon.BalloonTipText = "El servicio ExportarService ha sido activado"
        ...
        Private Sub DetenerServicio()
            Try
                If _Servicio.CanStop Then
                    ...
                    NotificacionNotifyIcon.BalloonTipTitle = "ExportarService"
                    NotificacionNotifyIcon.BalloonTipText = "El servicio ExportarService ha sido desactivado"
                    NotificacionNotifyIcon.ShowBalloonTip(5000)
                End If
            Catch ex As Exception
        ...
        Public Sub ValidarServicio()
            ...
            Try
                Dim ConnectionStrings As DescargaMasivaImagenesConfig.TypeConnectionString
                ...
                ConnectionStrings = DescargaMasivaImagenesConfig.getCadenasConexion(WebService)
                ...
                'Dim dbmInterfazDescarga As DB_Users_Explorer.DB_Users_ExplorerDataBaseManager = Nothing
                'Try
                '    dbmInterfazDescarga = New DB_Users_Explorer.DB_Users_ExplorerDataBaseManager(ConnectionStrings.DescargaMasiva)
                '    dbmInterfazDescarga.Connection_Open(2) ' Service
                'Catch ex As Exception
                '    Throw New Exception("No se pudo realizar la conexión a la base de datos Interfaz Exportar", ex)
                'Finally
                '    If (dbmInterfazDescarga IsNot Nothing) Then dbmInterfazDescarga.Connection_Close()
                'End Try
...
#End Region
        ...
        Private Sub BuscarCarpetaButton_Click(sender As System.Object, e As System.EventArgs) Handles BuscarCarpetaButton.Click
            ...
            If (Selector.ShowDialog() = DialogResult.OK) Then
                CarpetaSalidaTextBox.Text = Selector.SelectedPath
            End If
        End Sub
    End Class
End Namespace
