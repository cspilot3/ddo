...
#Region " Funciones "
        ...
        Public Function ProcesaUniversal(ByRef data As DataTable, ByVal fileName As String, ByRef CargueBackgroundWorker As BackgroundWorker) As DesktopConfig.TypeResult
            ...
            Try
                ...
                If resultValidacion.Result Then
                    ...
                    Cargue.fk_Entidad = _Plugin.Manager.RiskGlobal.Entidad
                    Cargue.fk_Proyecto = CShort(_Plugin.Manager.RiskGlobal.Proyecto)
                    ...
                    Cargue.fk_Usuario_Log = _Plugin.Manager.Sesion.Usuario.id
                    ...
                    For Each row As DataRow In data.Rows
                        ...
                        dbmArchiving.SchemaRisk.TBL_Universal_Folder.DBInsert(idUniversal_Folder, idCargue, DesktopConfig.FolderEstado.Pendiente, CShort(nIdEsquema), _Plugin.Manager.RiskGlobal.Entidad, _Plugin.Manager.RiskGlobal.Proyecto)
        ...
        Public Function ProcesaParcial(ByVal data As DataTable, ByVal fileName As String, ByVal idEntidad As Short, ByVal idEsquema As Short, ByVal TipoCargue As Short, ByRef CargueBackgroundWorker As BackgroundWorker, _TipoCargue As DesktopConfig.TipoCargue) As DesktopConfig.TypeResult
            ...
            Try
                ...
                If _TipoCargue = DesktopConfig.TipoCargue.Parcial Then
                    BulkInsert.InsertDataTable(data, dbmArchiving, tabla)
                ElseIf _TipoCargue = DesktopConfig.TipoCargue.Prevalidar Then
                    BulkInsert.InsertDataTableColumna(data, dbmArchiving, tabla)
                End If

                '1.
                dbmArchiving.Transaction_Begin()
                'Valida e inserta los datos cargados
                Dim TablaErrores As System.Data.DataTable

                If _TipoCargue = DesktopConfig.TipoCargue.Parcial Then
                    TablaErrores = dbmArchiving.SchemaLoad.PA_Cargue_Parcial_Coomeva.DBExecute(_Plugin.Manager.RiskGlobal.Entidad, _Plugin.Manager.RiskGlobal.Proyecto, tabla, _Plugin.Manager.Sesion.Usuario.id, fileName, idEsquema, idEntidad, _Plugin.Manager.DesktopGlobal.CentroProcesamientoRow.fk_Sede, TipoCargue)
                ElseIf _TipoCargue = DesktopConfig.TipoCargue.Prevalidar Then
                    TablaErrores = dbmArchiving.SchemaLoad.PA_Prevalidar_Cargue_Parcial_Coomeva.DBExecute(_Plugin.Manager.RiskGlobal.Entidad, _Plugin.Manager.RiskGlobal.Proyecto, tabla, _Plugin.Manager.Sesion.Usuario.id, fileName, idEsquema, idEntidad, _Plugin.Manager.DesktopGlobal.CentroProcesamientoRow.fk_Sede, TipoCargue)
                End If
