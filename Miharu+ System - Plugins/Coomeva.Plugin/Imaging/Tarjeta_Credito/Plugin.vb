...
#Region " Propiedades "
        ...
        Public Shared Property Imagenes_EntidadId() As Short = 15
        Public Shared Property Imagenes_Tarjeta_Credito_ProyectoId() As Short = 3
...
#Region " Implementacion IDesktopPlugin "
        ...
        Public Function IsValidPlugin(ByVal nProcessType As ProcessLibraryType, ByVal nEntidad As Integer, ByVal nProyecto As Integer) As Boolean Implements IDesktopPlugin.IsValidPlugin
            ...
            If (nProyecto <> Imagenes_Tarjeta_Credito_ProyectoId) Then Return False
            Return True
        End Function
        ...
        Public Function GetName() As String Implements IDesktopPlugin.GetName
            Return "Libreria especializada para el cliente Coomeva - Imágenes"
        End Function
