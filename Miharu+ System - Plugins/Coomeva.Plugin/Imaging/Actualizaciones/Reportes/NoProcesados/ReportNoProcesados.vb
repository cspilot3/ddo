...
Namespace Imaging.Actualizaciones.Reportes.NoProcesados

    Public Class ReportNoProcesados
        ...
        Public Overrides Sub Launch()
            ...
            If rangoFechasForm.ShowDialog() = DialogResult.OK Then
                ...
                Try
                    ...
                    Dim dsInforme = dbmIntegration.SchemaCoomevaReport.PA_No_Procesados.DBExecute(fechaInicio, fechaFinal)

                    Dim informeReportDataSource As New ReportDataSource("ReporteNoProcesadosActDataSet", dsInforme)
                    ...
                    ReportViewer.MainReportViewer.LocalReport.ReportEmbeddedResource = "Coomeva.Plugin.ReportNoProcesados.rdlc"
