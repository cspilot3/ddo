...
Namespace Imaging.Actualizaciones.Reportes.Sobrantes

    Public Class ReportSobrantes
        ...
        Public Overrides Sub Launch()
            ...
            If rangoFechasForm.ShowDialog() = DialogResult.OK Then
                ...
                Try
                    ...
                    Dim dsInforme = dbmIntegration.SchemaCoomevaReport.PA_Soportes_Sobrantes.DBExecute(fechaInicio, fechaFinal)

                    Dim informeReportDataSource As New ReportDataSource("ReporteSobrantesDataSet", dsInforme)
                    ...
                    ReportViewer.MainReportViewer.LocalReport.ReportEmbeddedResource = "Coomeva.Plugin.ReportSobrantes.rdlc"
