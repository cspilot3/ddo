...
Namespace Imaging.Actualizaciones.Reportes.Facturacion

    Public Class ReportFacturacionAct
        ...
        Public Overrides Sub Launch()
            ...
            If rangoFechasForm.ShowDialog() = DialogResult.OK Then
                ...
                Try
                    ...
                    Dim dsInforme = dbmIntegration.SchemaCoomeva.PA_Reporte_Facturacion_Actualizaciones.DBExecute(fechaInicio, fechaFinal)

                    Dim informeReportDataSource As New ReportDataSource("ReporteFacturacionActualizacionesDataSet", dsInforme)
                    ...
                    ReportViewer.MainReportViewer.LocalReport.ReportEmbeddedResource = "Coomeva.Plugin.ReportFacturacionAct.rdlc"
