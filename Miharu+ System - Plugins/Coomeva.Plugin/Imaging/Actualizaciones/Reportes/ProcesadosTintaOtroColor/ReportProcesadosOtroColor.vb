...
Namespace Imaging.Actualizaciones.Reportes.ProcesadosTintaOtroColor

    Public Class ReportProcesadosOtroColor
...
#Region " Propiedades "
        ...
        Overrides ReadOnly Property ReportName As String
            Get
                Return "Procesados_Tinta_Otro_Color"
            End Get
        End Property
        ...
        Public Overrides Sub Launch()
            ...
            If rangoFechasForm.ShowDialog() = DialogResult.OK Then
                ...
                Try
                    ...
                    Dim dsInforme = dbmIntegration.SchemaCoomevaReport.PA_Procesados_Tinta_Otro_Color.DBExecute(fechaInicio, fechaFinal)

                    Dim informeReportDataSource As New ReportDataSource("ReporteProcesadosOtroColorDataSet", dsInforme)
                    ...
                    ReportViewer.MainReportViewer.LocalReport.ReportEmbeddedResource = "Coomeva.Plugin.ReportProcesadosOtroColor.rdlc"
