...
Namespace Imaging.Actualizaciones.Reportes.Procesados

    Public Class ReportProcesados
        ...
        Public Overrides Sub Launch()
            ...
            If rangoFechasForm.ShowDialog() = DialogResult.OK Then
                ...
                Try
                    ...
                    Dim dsInforme = dbmIntegration.SchemaCoomevaReport.PA_Procesados.DBExecute(fechaInicio, fechaFinal)

                    Dim informeReportDataSource As New ReportDataSource("ReporteProcesadosDataSet", dsInforme)
                    ...
                    ReportViewer.MainReportViewer.LocalReport.ReportEmbeddedResource = "Coomeva.Plugin.ReportProcesados.rdlc"
