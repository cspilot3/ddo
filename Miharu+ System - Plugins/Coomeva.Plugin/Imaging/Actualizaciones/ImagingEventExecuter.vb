...
#Region " Implementacion IEventExecuter "
        ...
        Public Sub FinalizarPrecaptura(ByVal nidExpediente As Long, ByVal nidFolder As Short, ByVal nidFile As Short, ByVal nidVersion As Short) Implements IEventExecuter.FinalizarPreCaptura
            ...
            Dim dbmCoomeva As DBIntegration.DBIntegrationDataBaseManager
            Try
                ...
                'Insercion de registros No Procesables, devuelve la cantidad de registros insertados en la TBL_No_Procesables por Expediente
                Dim validacionFalse = dbmCoomeva.SchemaCoomeva.PA_Busqueda_Validacion_Respuesta_False_Expediente.DBExecute(nidExpediente, nidFolder, nidFile, DBImaging.EnumEtapaCaptura.Precaptura)

                If validacionFalse > 0 Then
