...
Namespace Imaging.Anexos.Reportes.Facturacion
        ...
        Public Overrides Sub Launch()
            ...
            If rangoFechasForm.ShowDialog() = DialogResult.OK Then
                ...
                Try
                    ...
                    Dim dsInforme = dbmIntegration.SchemaCoomeva.PA_Reporte_Facturacion.DBExecute(Plugin.Imagenes_EntidadId, Miharu.Imaging.Library.Program.ImagingGlobal.Proyecto, fechaInicio, fechaFinal)

                    Dim informeReportDataSource As New ReportDataSource("ReporteFacturacionDataSet", dsInforme)
                    ...
                    ReportViewer.MainReportViewer.LocalReport.ReportEmbeddedResource = "Coomeva.Plugin.ReportFacturacion.rdlc"
