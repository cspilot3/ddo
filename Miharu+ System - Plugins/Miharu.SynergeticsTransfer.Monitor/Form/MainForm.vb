...
Imports Miharu.SynergeticsTransfer.Servicio
Imports DBSecurity
Imports DBSoftrac
...
#Region " Eventos "
        ...
        Private Sub ProbarButton_MouseDown(ByVal sender As System.Object, ByVal e As MouseEventArgs) Handles ProbarButton.MouseDown
            ...
            ElseIf (e.Button = MouseButtons.Right) Then
                Dim obj As New SynergeticsService
                obj.IniciarServicio()
            End If
        End Sub
...
#Region " Metodos "
        ...
        Private Sub LoadConfig()
            ...
            PasswordTextBox.Text = SynergeticsConfig.Decrypt(Program.Config.Password)
        ...
        Private Sub SaveServico()
            If Validar() Then
                ...
                Program.Config.Password = SynergeticsConfig.Encrypt(PasswordTextBox.Text)

                SynergeticsConfig.Serialize(Program.Config, Program.AppDataPath)
        ...
        Private Sub ActivarGuardar()
            If Not _Cargando Then
                ...
                HayCambios = (Program.Config.User <> UserTextBox.Text) Or _
                             ...
                             (SynergeticsConfig.Decrypt(Program.Config.Password) <> PasswordTextBox.Text) Or _
        ...
        Private Sub MonitorearServicio()
            ...
            Try
                ...
                For Each ServicioEncontrado As ServiceController In Servicios
                    If ServicioEncontrado.ServiceName = "SynergeticsService" Then
                ...
                Else
                    ...
                    Select Case _Servicio.Status
                        Case ServiceControllerStatus.Running
                            ...
                            NotificacionNotifyIcon.Text = "SynergeticsService [Activo]"

                        Case Else
                            EstadoStatusStripLabel.Text = "Servicio detenido"
                            NotificacionNotifyIcon.Icon = _NotifiIcon_Inactivo
                            NotificacionNotifyIcon.Text = "SynergeticsService [Inactivo]"
        ...
        Private Sub IniciarServicio()
            Try
                ...
                NotificacionNotifyIcon.BalloonTipTitle = "SynergeticsService"
                NotificacionNotifyIcon.BalloonTipText = "El servicio SynergeticsService ha sido activado"
        ...
        Private Sub DetenerServicio()
            Try
                If _Servicio.CanStop Then
                    ...
                    NotificacionNotifyIcon.BalloonTipTitle = "SynergeticsService"
                    NotificacionNotifyIcon.BalloonTipText = "El servicio SynergeticsService ha sido desactivado"
                    NotificacionNotifyIcon.ShowBalloonTip(5000)
                End If
            Catch ex As Exception
        ...
        Public Sub ValidarServicio()
            ...
            Try
                Dim ConnectionStrings As SynergeticsConfig.TypeConnectionString
                ...
                ConnectionStrings = SynergeticsConfig.getCadenasConexion(WebService)
