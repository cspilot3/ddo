...
#Region " Enumeraciones "
    ...
    Public Enum ServidorData As Byte
        Bogota = 1
        Medellin = 2
        Cali = 3
        Barranquilla = 4
    ...
    Public Enum ServidorImages As Byte
        Bogota = 1
        Medellin = 2
        Cali = 3
        Barranquilla = 4
...
#Region " Declaraciones "
    ...
    Public Shared Config As New MailConfig
    Public Shared ConnectionStrings As MailConfig.TypeConnectionString
...
#Region " Propiedades "
    ...
    Friend Shared ReadOnly Property AppDataPath() As String
        Get
            Return Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData).TrimEnd("\"c) + "\PYC\Miharu.Mail\"
        End Get
    End Property
