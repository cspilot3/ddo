...
Namespace Imaging.Reportes.Facturacion
    Public Class ReportFacturacion
...
#Region " Propiedades "
        ...
        Protected _plugin As Imaging.Plugin

#End Region

#Region " Constructores "

        Public Sub New(ByRef nReportViewer As DesktopReportViewerControl, ByVal nPlugin As Imaging.Plugin)
        ...
        Public Overrides Sub Launch()
            ...
            If rangoFechasForm.ShowDialog() = DialogResult.OK Then
                ...
                Try
                    ...
                    Dim dsInforme = dbmIntegration.SchemaRipley.PA_Reporte_Facturacion.DBExecute(Program.RipleyEntidadId, Miharu.Imaging.Library.Program.ImagingGlobal.Proyecto, fechaInicio, fechaFinal)

                    Dim informeReportDataSource As New ReportDataSource("ReporteFacturacionRipleyDataSet", dsInforme)
                    ...
                    ReportViewer.MainReportViewer.LocalReport.ReportEmbeddedResource = "Ripley.Plugin.ReportFacturacion.rdlc"
