...
#Region " Declaraciones "
        ...
        Private _RipleyConnectionString As String
...
#Region " Propidades "
        ...
        Public ReadOnly Property RipleyConnectionString() As String
            Get
                Return Me._RipleyConnectionString
            End Get
        End Property
...
#Region " Implementacion IDesktopPlugin "
        ...
        Public Function IsValidPlugin(ByVal nProcessType As ProcessLibraryType, ByVal nEntidad As Integer, ByVal nProyecto As Integer) As Boolean Implements IDesktopPlugin.IsValidPlugin
            ...
            If (nEntidad <> Program.RipleyEntidadId) Then Return False
            'If (nProyecto <> Program.RipleyProyectoImagenesId) Then Return False
            Return True
        End Function
        ...
        Public Sub Initialize(ByVal nManager As DesktopPluginManager) Implements IDesktopPlugin.Initialize
            ...
            Try
                ...
                If (ModuloDataTable.Count > 0) Then
                    Me._RipleyConnectionString = ModuloDataTable(0).ConnectionString
                Else
        ...
        Public Function GetCode() As String Implements IDesktopPlugin.GetCode
            Return "RipleyPluginImaging"
        End Function

        Public Function GetName() As String Implements IDesktopPlugin.GetName
            Return "Libreria especializada para el cliente Ripley - Imágenes"
        End Function
