...
Namespace Imaging.Reportes.DetalleDestapeEmpaque
    ...
    Public Class ReportTiempoCiudadesDetalladoDestape
...
#Region " Propiedades "
        ...
        Overrides ReadOnly Property ReportName As String
            Get
                Return "Reporte Tiempo Ciudades Detallado Destape/Empaque"
            End Get
        End Property
...
#Region " Metodos "
        ...
        Public Overrides Sub Launch()
            Dim parametrosForm As New FormTiempoCiudadesDetalladoDestape(_plugin)
            ...
            If parametrosForm.ShowDialog() = DialogResult.OK Then
                reporte = parametrosForm.Reporte
                usuario = parametrosForm.Usuario
                contenedor = parametrosForm.Contenedor
                tipoDetalle = parametrosForm.TipoDetalle
                ...
                Try
                    ...
                    datos = dmBanAgrario.SchemaReport.PA_Consulta_Tiempo_Ciudades_Detalle.DBExecute(usuario, contenedor, reporte)

                    Dim informeReportDataSource As New ReportDataSource("DsContenedoresConsolidado", datos)
                    Dim parametros As New List(Of ReportParameter)
                    parametros.Add(New ReportParameter("TipoDetalle", tipoDetalle))

                    Me.ReportViewer.MainReportViewer.Reset()
                    Me.ReportViewer.MainReportViewer.LocalReport.ReportEmbeddedResource = "Banagrario.Plugin.Report_TiempoCiudadesDetalladoDestape.rdlc"
