Imports Banagrario.Plugin.Imaging.Reportes.Contenedor
Imports Miharu.Desktop.Controls.DesktopMessageBox
Imports Microsoft.Reporting.WinForms
Imports Miharu.Desktop.Controls.DesktopReportViewer

Namespace Imaging.Reportes.Novedades

    Public Class Report_NovedadesContenedor
...
#Region " Propiedades "
        ...
        Overrides ReadOnly Property ReportName As String
            Get
                Return "Reporte Novedades Contenedor"
            End Get
        End Property
        ...
        Public Overrides Sub Launch()
            ...
            If ParametrosForm.ShowDialog() = Windows.Forms.DialogResult.OK Then
                ...
                Try
                    ...
                    datos = dbmAgrario.SchemaReport.PA_Novedades_Contenedor.DBExecute(Regional, _
                                                                                      Cob, _
                                                                                      Oficina, _
                    ...
                    Dim InformeReportDataSource As New ReportDataSource("DsContenedorNovedades", datos)
                    ...
                    Me.ReportViewer.MainReportViewer.LocalReport.ReportEmbeddedResource = "Banagrario.Plugin.Report_NovedadesContenedor.rdlc"
                ...
                Catch ex As Exception
                    DesktopMessageBoxControl.DesktopMessageShow("Reporte_ContenedorNovedades ", ex)
                Finally
