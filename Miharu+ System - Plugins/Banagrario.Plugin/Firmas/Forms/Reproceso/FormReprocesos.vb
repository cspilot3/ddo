...
Namespace Firmas.Forms.Reprocesos
...
#Region " Declaraciones "
        ...
        Private workspace As Firmas.FormWrappers.FormImagingWorkSpaceWrapper_Firmas
...
#Region " Constructores "
        ...
        Public Sub New(ByRef nPlugin As FirmasImagingPlugin)
            Me._Plugin = nPlugin
...
#Region " Eventos "
        ...
        Private Sub SedeoComboBox_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As EventArgs) Handles SedeComboBox.SelectedIndexChanged
            Dim dbmSecurity As New DBSecurity.DBSecurityDataBaseManager(_Plugin.Manager.DesktopGlobal.ConnectionStrings.Security)
            dbmSecurity.Connection_Open(_Plugin.Manager.Sesion.Usuario.id)

            Dim CentroDataTable = dbmSecurity.SchemaConfig.TBL_Centro_Procesamiento.DBFindByfk_Entidadfk_Sede(_Plugin.Manager.DesktopGlobal.CentroProcesamientoRow.fk_Entidad, CShort(SedeComboBox.SelectedValue))
...
#Region " Metodos "
        ...
        Private Sub BuscarReprocesos()
            ...
            Try
                ...
                Dim ReprocesosDataTable = dbmImaging.SchemaProcess.PA_Obtiene_Items_Reproceso.DBExecute(_Plugin.Manager.ImagingGlobal.ProyectoImagingRow.fk_Entidad, _
                                                                                                        _Plugin.Manager.ImagingGlobal.ProyectoImagingRow.fk_Proyecto, _
                                                                                                        _Plugin.Manager.DesktopGlobal.CentroProcesamientoRow.fk_Entidad, _
                                                                                                        numSede, _
                                                                                                        numCentro, _
                                                                                                        numMotivo, _
                                                                                                        Me.OT)
        ...
        Private Sub CargaControles()
            ...
            Try
                dbmImaging = New DBImaging.DBImagingDataBaseManager(_Plugin.Manager.DesktopGlobal.ConnectionStrings.Imaging)
                dbmSecurity = New DBSecurity.DBSecurityDataBaseManager(_Plugin.Manager.DesktopGlobal.ConnectionStrings.Security)
                ...
                Dim SedeDataTable = dbmSecurity.SchemaConfig.TBL_Sede.DBGet(_Plugin.Manager.DesktopGlobal.CentroProcesamientoRow.fk_Entidad, Nothing)

                Dim CentroDataTable = dbmSecurity.SchemaConfig.TBL_Centro_Procesamiento.DBGet(_Plugin.Manager.DesktopGlobal.CentroProcesamientoRow.fk_Entidad, _Plugin.Manager.DesktopGlobal.CentroProcesamientoRow.fk_Sede, Nothing)
                ...
                SedeComboBox.SelectedValue = _Plugin.Manager.DesktopGlobal.CentroProcesamientoRow.fk_Sede
                Utilities.LlenarCombo(CentroComboBox, CentroDataTable, CentroDataTable.id_Centro_ProcesamientoColumn.ColumnName, CentroDataTable.Nombre_Centro_ProcesamientoColumn.ColumnName, True, "-1", "Todos...")
                CentroComboBox.SelectedValue = _Plugin.Manager.DesktopGlobal.CentroProcesamientoRow.id_Centro_Procesamiento
            ...
            Try
                ...
                For Each row As DataGridViewRow In ReprocesosDataGridView.Rows
                    If CBool(row.Cells(ReprocesosDataGridView.Columns("R").Index).Value) Then
                        ...
                        newFilesEstadoType.fk_Usuario = _Plugin.Manager.Sesion.Usuario.id
        ...
        Private Sub VisualizaImagen(ByVal rowData As DataRow)
            Try
                ...
                Me.Cursor = Cursors.AppStarting
                Dim formVisor As New FormVisorImagen(_Plugin, Expediente, Folder, File)
        ...
        Private Sub ReemplazarItems()
            ...
            Try
                ...
                Dim ImagenOpenFileDialog = New OpenFileDialog() With {
                    ...
                    .Filter = "Imágenes (*" & _Plugin.Manager.ImagingGlobal.ProyectoImagingRow.Extension_Formato_Imagen_Entrada & ")|*" & _Plugin.Manager.ImagingGlobal.ProyectoImagingRow.Extension_Formato_Imagen_Entrada & ""
                }
                ...
                If Respuesta = DialogResult.OK Then
                    ...
                    manager.CreateItem(idExpediente, idFolder, idFile, FileImgType.id_Version, _Plugin.Manager.ImagingGlobal.ProyectoImagingRow.Extension_Formato_Imagen_Salida, FileImgType.File_Unique_Identifier)
        ...
        Private Sub CargaPermisos()
            Try
                ...
                SedeComboBox.Enabled = _Plugin.Manager.Sesion.Usuario.PerfilManager.PuedeConsultar(Permisos.Imaging.Proceso.Captura.Reprocesos)
                CentroComboBox.Enabled = _Plugin.Manager.Sesion.Usuario.PerfilManager.PuedeConsultar(Permisos.Imaging.Proceso.Captura.Reprocesos)
                SedeProcesaminetoL.Enabled = _Plugin.Manager.Sesion.Usuario.PerfilManager.PuedeConsultar(Permisos.Imaging.Proceso.Captura.Reprocesos)
                CentroProcesamientoL.Enabled = _Plugin.Manager.Sesion.Usuario.PerfilManager.PuedeConsultar(Permisos.Imaging.Proceso.Captura.Reprocesos)
        ...
        Private Sub ProcesarItem()
            If (ValidaSeleccionItems()) Then
                If (ReprocesosDataGridView.SelectedRows.Count = 1) Then
                    ...
                    Dim launchUtil_ As New LaunchUtil_Firmas(_Plugin)

                    launchUtil_.Indexar(OT, GetType(Firmas.Controller.Indexer.Capturas.Reproceso.ReProcessController_Firmas), DBCore.EstadoEnum.Reproceso, LaunchUtil.EtapaEnum.Reprocesos, _Plugin.WorkSpace, Me.ProcesarButton, False, "SetData", Parameters)
                    'launchUtil_.Indexar(OT, GetType(Firmas.Controller.Indexer.Capturas.Reproceso.ReProcessController_Firmas), DBCore.EstadoEnum.Reproceso, LaunchUtil.EtapaEnum.Reprocesos, _Plugin.WorkSpace, Me.ProcesarButton, False)
        ...
        Private Sub ProcesarDemanda()
            If (CStr(MotivoComboBox.SelectedValue) <> "-1") Then
                ...
                'launchUtil_.Indexar(OT, GetType(Firmas.Controller.Indexer.Capturas.Reproceso.ReProcessController_Firmas), DBCore.EstadoEnum.Reproceso, LaunchUtil.EtapaEnum.Reprocesos, _Plugin.WorkSpace, Me.ProcesarDemandaButton, True, "SetData", Parameters)
                launchUtil_.Indexar(OT, GetType(Firmas.Controller.Indexer.Capturas.Reproceso.ReProcessDemandaController_Firmas), DBCore.EstadoEnum.Reproceso, LaunchUtil.EtapaEnum.Reprocesos, _Plugin.WorkSpace, Me.ProcesarDemandaButton, True, "SetData", Parameters)
        ...
        Private Sub ReIndexar()
            ...
            If (listaFiles.Count = 0) Then
                MessageBox.Show("Debe seleccionar almenos un registro para Re Indexar", Program.AssemblyName, MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Return
            End If
            ...
            Try
                ...
                Dim BloqueoDatatable = dbmImaging.SchemaProcess.PA_Dashboard_Capturas_get.DBExecute(_Plugin.Manager.DesktopGlobal.SesionId)
                ...
                For Each listaFile In listaFiles
                    ...
                    If (Not dashboardRow.IsSesionNull() AndAlso dashboardRow.Sesion.ToString() <> _Plugin.Manager.DesktopGlobal.SesionId.ToString()) Then
                    ...
                    dashboardType.fk_Usuario_log = _Plugin.Manager.Sesion.Usuario.id
                    dashboardType.Sesion = _Plugin.Manager.DesktopGlobal.SesionId
                    dashboardType.PCName = _Plugin.Manager.DesktopGlobal.PcName
            ...
            launchUtil_.Indexar(OT, GetType(Firmas.Controller.Indexer.Capturas.Reproceso.ReProcessController_Firmas), DBCore.EstadoEnum.Reproceso, LaunchUtil.EtapaEnum.Reprocesos, _Plugin.WorkSpace, Me.reIndexarButton, False)
