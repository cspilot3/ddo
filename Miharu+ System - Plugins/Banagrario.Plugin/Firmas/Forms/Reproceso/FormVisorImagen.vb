...
#Region " Contructor "
        ...
        Sub New(ByRef nPlugin As FirmasImagingPlugin, ByVal nExpediente As Long, ByVal nFolder As Short, ByVal nFile As Short)
...
#Region " Metodos "
        ...
        Private Sub CargarImagen()
            ...
            Try
                ...
                manager = New FileProviderManager(_Expediente, _Folder, dbmImaging, _Plugin.Manager.Sesion.Usuario.id)
                manager.Connect()
                    ...
                    For folio = CShort(1) To Folios
                        ...
                        Using ms = New MemoryStream(Imagen)
                            Using bm = New FreeImageAPI.FreeImageBitmap(ms)
                                ImageManager.Save(bm, _tempPath & folio.ToString() & _Plugin.Manager.ImagingGlobal.ProyectoImagingRow.Extension_Formato_Imagen_Salida, "", Formato, Compresion, False, _tempPath)
                            End Using
                        End Using

                        _ListImages.Add(_tempPath & folio.ToString() & _Plugin.Manager.ImagingGlobal.ProyectoImagingRow.Extension_Formato_Imagen_Salida)
                    Next
