...
Namespace Firmas.Reportes.InformesProcesados

    Public Class Report_Procesados
...
#Region " Declaraciones "
        ...
        Public Overrides ReadOnly Property ReportName As String
            Get
                Return "Procesados - Banco Agrario"
            End Get
        End Property
...
#Region " Metodos "
        ...
        Public Overrides Sub Launch()
            ...
            If RangoFechasForm.ShowDialog = Windows.Forms.DialogResult.OK Then
                ...
                Dim InformeDataTable As New DBAgrario.SchemaFirmasReport.CTA_ProcesadosDataTable

                Try
                    dbmFirmas.Connection_Open(_plugin.Manager.Sesion.Usuario.id)
                    InformeDataTable.Clear()
                    InformeDataTable = dbmFirmas.SchemaFirmasReport.PA_Procesados.DBExecute(Integer.Parse(FechaInicio.ToString("yyyy/MM/dd").Replace("/", "")), Integer.Parse(FechaFinal.ToString("yyyy/MM/dd").Replace("/", "")))
                ...
                Dim InformeReportDataSource As New ReportDataSource("DS_Procesados", CType(InformeDataTable, DataTable))
                ...
                Me.ReportViewer.MainReportViewer.LocalReport.ReportEmbeddedResource = "Banagrario.Plugin.Report_Procesados.rdlc"
