...
Namespace Firmas.Reportes.InformeFaltantes
...
#Region " Declaraciones "
        ...
        Public Overrides ReadOnly Property ReportName As String
            Get
                Return "Faltantes - Banco Agrario"
            End Get
        End Property
...
#Region " Metodos "
        ...
        Public Overrides Sub Launch()
            ...
            If RangoFechasForm.ShowDialog = Windows.Forms.DialogResult.OK Then
                ...
                Dim InformeDataTable As New DBAgrario.SchemaFirmasReport.CTA_FaltantesDataTable

                Try
                    dbmFirmas.Connection_Open(_plugin.Manager.Sesion.Usuario.id)
                    InformeDataTable.Clear()
                    InformeDataTable = dbmFirmas.SchemaFirmasReport.PA_Faltantes.DBExecute(Integer.Parse(FechaInicio.ToString("yyyy/MM/dd").Replace("/", "")), Integer.Parse(FechaFinal.ToString("yyyy/MM/dd").Replace("/", "")))
                ...
                Me.ReportViewer.MainReportViewer.LocalReport.ReportEmbeddedResource = "Banagrario.Plugin.Report_Faltantes.rdlc"
