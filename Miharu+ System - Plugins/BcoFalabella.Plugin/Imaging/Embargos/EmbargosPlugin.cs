...
namespace BcoFalabella.Plugin.Imaging.Embargos
{
    public class EmbargosPlugin : IDesktopPlugin
    {
        ...
        public const string ConfigurationPrefix = "PluginBcoFalabella_";
        ...
        private string _BcoFalabellaConnectionString;
        ...
        public string BcoFalabellaConnectionString
        {
            get { return this._BcoFalabellaConnectionString; }
        }
        ...
        public static short Imaging_BcoFalabella_ProyectoId { get; set; }
        ...
        {
            Imaging_EntidadId = 53;
            Imaging_BcoFalabella_ProyectoId = 1;
            ...
            if ((nEntidad != Imaging_EntidadId))
                return false;
            if ((nProyecto != Imaging_BcoFalabella_ProyectoId))
                return false;
            return true;
        }
            ...
            try
            {
                ...
                if ((ModuloDataTable.Count > 0))
                {
                    foreach (var modulo_loopVariable in ModuloDataTable)
                    {
                        ...
                        {
                            case 33:
                                this._BcoFalabellaConnectionString = modulo_loopVariable.ConnectionString;
                                break;
                            case 3:
        ...
        {
            return "BancoFalabellaEmbargo_Plugin";
        }

        public string GetName()
        {
            return "Libreria especializada para BancoFalabella-Embargo";
        }
