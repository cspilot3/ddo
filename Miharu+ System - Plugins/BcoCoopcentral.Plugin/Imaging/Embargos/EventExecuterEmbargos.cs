...
namespace BcoCoopcentral.Plugin.Imaging.Embargos
{
    public class EventExecuterEmbargos : EventExecuter, IEventExecuter
    {
        ...
        {
            DBIntegration.DBIntegrationDataBaseManager dbmIntegration = new DBIntegration.DBIntegrationDataBaseManager(this._Plugin.BcoCoopcentralConnectionString);
            DBImaging.DBImagingDataBaseManager dbmImaging = new DBImaging.DBImagingDataBaseManager(Plugin.Program.DesktopGlobal.ConnectionStrings.Imaging);
            ...
            try
            {
                ...
                //preparar data ppor expediente
                dbmImaging.SchemaProcess.PA_Preparar_Data_Expediente.DBExecute(Plugin.Program.ImagingGlobal.Entidad, Plugin.Program.ImagingGlobal.Proyecto, nidExpediente, nidFolder, nidFile);

                dbmIntegration.SchemaBcoCoopcentral.PA_Finalizar_Preparar_Data_Expediente_Folder_File.DBExecute(Plugin.Program.ImagingGlobal.Entidad, Plugin.Program.ImagingGlobal.Proyecto, nidExpediente, nidFolder, nidFile);
                
                //cruce por expediente
                dbmImaging.SchemaProcess.PA_Cruce_Generico_Expediente.DBExecute(Plugin.Program.ImagingGlobal.Entidad, Plugin.Program.ImagingGlobal.Proyecto, nidExpediente, nidFolder, nidFile, "1");

                dbmIntegration.SchemaBcoCoopcentral.PA_Insercion_Data_Documento_Respuesta_Expediente_Folder_File.DBExecute(Plugin.Program.ImagingGlobal.Entidad, Plugin.Program.ImagingGlobal.Proyecto, nidExpediente, nidFolder, nidFile, this._Plugin.Manager.Sesion.Usuario.id);

            }
            catch (Exception ex)
            {
                DesktopMessageBoxControl.DesktopMessageShow("Finalizar Corrección Data", ref ex);
            }
            finally
            {
        ...
        public void FinalizarCruceGenerico(short nidEntidad, short nidProyecto, int nidFechaProceso, int nidOt)
        {
            ...
            try
            {
                ...
                dbmIntegration.SchemaBcoCoopcentral.PA_Insercion_Data_Documento_Respuesta.DBExecute(nidEntidad, nidProyecto, nidFechaProceso, nidOt, _Plugin.Manager.Sesion.Usuario.id);
        ...
        public void FinalizarPrepararDataGenerico(short nidEntidad, short nidProyecto, int nidFechaProceso, int nidOt)
        {
            ...
            try
            {
                dbmIntegration.Connection_Open(this._Plugin.Manager.Sesion.Usuario.id);
                dbmIntegration.Transaction_Begin();
                dbmIntegration.SchemaBcoCoopcentral.PA_Finalizar_Preparar_Data.DBExecute(nidEntidad, nidProyecto, nidFechaProceso, nidOt);
                dbmIntegration.Transaction_Commit();
            }
            catch (Exception ex)
            {
