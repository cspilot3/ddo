...
using Miharu.Tools.Progress; //to do: validar si toca crear uno por cada proyecto

namespace BcoCoopcentral.Plugin.Imaging.Embargos.Form
{
        ...
        { 
            ...
            try
            {
                if (Validar())
                {
                    ...
                    //TO DO: HACER UNO CONFIGURABLE O EL PROPIO
                    ...
                    var NoClientesDataTable = dbmIntegration.SchemaBcoCoopcentral.PA_Get_No_ClientesCR.DBExecute(System.Convert.ToInt32(OTDesktopComboBox.SelectedValue), _plugin.Manager.ImagingGlobal.Entidad, _plugin.Manager.ImagingGlobal.Proyecto);
                    ...
                    if (ExpedientesDataTable.Rows.Count > 0)
                    {
                        ...
                        ProgressForm.SetProceso("Generando Cartas");
                        ...
                        foreach (var ExpedientesRow in ExpedientesDataTable)
                        {
                            ...
                            DataTable NoClientesDT = NoClientesDataTable.Select("fk_Expediente = " + ExpedientesRow.fk_Expediente.ToString()).CopyToDataTable();
                            ...
                            var NoClientesDataSource = new ReportDataSource("CTA_No_ClientesCRDataSet", NoClientesDT);

                            this.ReportViewer1.LocalReport.ReportEmbeddedResource = "BcoCoopcentral.Plugin.Imaging.Embargos.Form.Report_GenerarCartas.rdlc";
                            ...
                            this.ReportViewer1.LocalReport.DataSources.Add(NoClientesDataSource);
                            ...
                            var identificador = Guid.Parse(ExpedientesRow.File_Unique_Identifier);
                            ...
                            {
                                var dataImage = ImageManager.GetFolioData(FileName, folio, formato, compresion);
