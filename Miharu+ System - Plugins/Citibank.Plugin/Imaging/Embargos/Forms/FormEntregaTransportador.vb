                ...
                Else
                    ...
                    If File.Rows.Count > 0 Then
                        ...
                        If EstadoFile(0).fk_Estado = 42 Then
                            Dim Registro As New DBCore.SchemaProcess.TBL_File_EstadoType
                            ...
                            Data.fk_Campo = 3 'No. Guia
                            Data.Valor_File_Data = NoGuiaTextBox.Text
                            Data.Conteo_File_Data = NoGuiaTextBox.Text.Length
                            dbmCore.SchemaProcess.TBL_File_Data.DBInsert(Data)

                            Data.fk_Campo = 4 'Fecha entrega transportador
                            Data.Valor_File_Data = Date.Now.ToString("dd/MM/yyyy")
                            Data.Conteo_File_Data = 10
                            dbmCore.SchemaProcess.TBL_File_Data.DBInsert(Data)
