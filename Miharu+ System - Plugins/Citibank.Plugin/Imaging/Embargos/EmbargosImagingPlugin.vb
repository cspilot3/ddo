...
Namespace Imaging.Embargos
    Public Class EmbargosImagingPlugin
        Inherits MarshalByRefObject
        Implements IDesktopPlugin

#Region " Declaraciones "
        Private _EventExecuter As New EmbargosImagingEventExecuter(Me)
        ...
        Private _Wrapper As EmbargosImagingWrapper
#End Region
...
#Region " Propiedades "
        ...
        Public ReadOnly Property Wrapper As EmbargosImagingWrapper
            Get
                Return Me._Wrapper
            End Get
        End Property
...
#Region " Implementacion IDesktopPlugin "
        Public Function IsValidPlugin(ByVal nProcessType As ProcessLibraryType, ByVal nEntidad As Integer, ByVal nProyecto As Integer) As Boolean Implements IDesktopPlugin.IsValidPlugin
            ...
            If (nProyecto <> Program.Imagenes_Embargos_ProyectoId And nProyecto <> Program.Imagenes_DesEmbargos_ProyectoId) Then Return False
            Return True
        End Function
        ...
        Public Sub Activate() Implements IDesktopPlugin.Activate
            Try
                Me._Wrapper = New EmbargosImagingWrapper(Me)
        ...
        Public Function GetCode() As String Implements IDesktopPlugin.GetCode
            Return "CitibankEmbargosPluginImaging"
        End Function

        Public Function GetName() As String Implements IDesktopPlugin.GetName
            Return "Libreria especializada para el cliente Citibank - Embargos"
        End Function
