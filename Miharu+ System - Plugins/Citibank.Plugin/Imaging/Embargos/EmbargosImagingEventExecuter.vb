...
Namespace Imaging.Embargos
    Public Class EmbargosImagingEventExecuter
...
#Region " Implementacion IEventExecuter "
        ...
        Public Sub FinalizarCrucegenerico(nidEntidad As Short, nidProyecto As Short, nidFechaProceso As Integer, nidOT As Integer) Implements IEventExecuter.FinalizarCruceGenerico
            ...
            Try
                ...
                dbmIntegration.SchemaCITIBANK.PA_Insercion_Data_Documento_Respuesta.DBExecute(_plugin.Manager.ImagingGlobal.Entidad, _plugin.Manager.ImagingGlobal.Proyecto, nidFechaProceso, nidOT, _plugin.Manager.Sesion.Usuario.id)
            Catch ex As Exception
                MessageBox.Show("Error : " & ex.Message, "FinalizarCruceGenerico", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Finally
