...
using BcoBogota.Plugin.Imaging.Impuestos.Forms;

namespace Imaging.Impuestos
{
    public class FormImagingWorkSpaceWrapperImpuestos
    {
        #region "Declaraciones"

        public ImpuestosPlugin _plugin = null;
        TabPage pageReportes = new TabPage();
        private bool hideReporte = false;
        public ToolStripMenuItem BancoBogotaToolStripMenuItem = new ToolStripMenuItem();
        ...
        public FormImagingWorkSpaceWrapperImpuestos(ImpuestosPlugin nPlugin)
        {
            _plugin = nPlugin;
        }
        #endregion
        ...
        public void AplicarCambios()
        {
            try
            {
                ...
                BancoBogotaToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] {CargueLogToolStripMenuItem,
                ...
                BancoBogotaToolStripMenuItem.Name = "BancoBogotaToolStripMenuItem";
                BancoBogotaToolStripMenuItem.Size = new System.Drawing.Size(193, 22);
                BancoBogotaToolStripMenuItem.Text = "Banco de Bogota ...";
                BancoBogotaToolStripMenuItem.Visible = _plugin.Manager.Sesion.Usuario.PerfilManager.PuedeAcceder(Permisos.Imaging.BancoBogota.Path);
                ...
                _plugin.WorkSpace.MainMenuStrip.Items.AddRange(new ToolStripItem[] { BancoBogotaToolStripMenuItem });


            }
            catch (Exception ex)
            {
                DesktopMessageBoxControl.DesktopMessageShow("No fue posible aplicar los cambios de Banco de Bogota-Impuestos al workspace, " + ex.Message, "Plugin workspace", DesktopMessageBoxControl.IconEnum.ErrorIcon, true);
            }
        }
        ...
        public void DeshacerCambios()
        {
            ...
            {
                DesktopMessageBoxControl.DesktopMessageShow("No fue posible deshacer los cambios de Banco de Bogota-Impuestos al workspace, " + ex.Message, "Plugin workspace", DesktopMessageBoxControl.IconEnum.ErrorIcon, true);
            }
        }
        #endregion
        ...
        {
            quitarTabPage();
            dynamic frmCargueLog = new frmCargueLog(this._plugin);
