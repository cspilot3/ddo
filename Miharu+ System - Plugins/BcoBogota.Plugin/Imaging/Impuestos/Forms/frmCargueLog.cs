...
namespace BcoBogota.Plugin.Imaging.Impuestos.Forms
{
    public partial class frmCargueLog : Form
    {
        ...
        #region Constructor
        public frmCargueLog(ImpuestosPlugin _plugin)
        {
...
//            this.Fecha_Recaudo = "";
        ...
        {
            DesktopConfig.TypeResult trReturn = new DesktopConfig.TypeResult();
            DBIntegrationDataBaseManager dbmIntregation = new DBIntegrationDataBaseManager(_Plugin.BcoBogotaConnectionString);
            ...
            try
            {
                ...
                var ColumnsAdicionalesLogData = dbmIntregation.SchemaBcoBogota.TBL_Log_Data.DBGet(0).Columns;
                ...
                if (dsref.Tables.Count > 0)
                {
                    ...
                    //{
                    DBIntegration.SchemaBcoBogota.TBL_Log_DataType Data_Log = new DBIntegration.SchemaBcoBogota.TBL_Log_DataType();
            ...
            try
            {
                ...
                //OK: if VALIDACIONES
                    ...
                    { //.EXCEL
                        ...
                        var LogPrevioPorFechaRecaudo = dbmIntregation.SchemaBcoBogota.TBL_Log_Data.DBFindByfk_Entidadfk_Proyectofk_Tipo_logFecha_ProcesoFecha_Recaudo(_Plugin.Manager.ImagingGlobal.Entidad, _Plugin.Manager.ImagingGlobal.Proyecto, IdTipo_log, null, Fecha_Real_Recaudo_hoja1);
        ...
        {
            dynamic nTempPath = ImpuestosPlugin.AppPath + ImpuestosPlugin.TempPath;
            if ((UsarReferencia))
            {
                if ((dtRef != null))
                {
