...
namespace BcoBogota.Plugin.Imaging.Impuestos.Forms
{
    public partial class frmRelacion_CuentasDispersadas : Form
    {
        ...
        public frmRelacion_CuentasDispersadas(ImpuestosPlugin plugin)
        {
            this._plugin = plugin;
            InitializeComponent();
        }
        ...
        private void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataTable ReportCuentas_Dispersadas = dbmIntegration.SchemaBcoBogota.PA_SelectStament_Municipios_Dispersion.DBExecute(this._StrFechaRecaudo);
                EliminaColumnas(ReportCuentas_Dispersadas);
                _nombreReporte = string.Format(dbmIntegration.SchemaBcoBogota.TBL_Config_Reporte.DBFindByNombre_Reporte("REPORTE_FORM_DISPERSION").FirstOrDefault().Formato_Reporte, DateTime.Now);
        ...
        private void CargarGrilla()
        {
            ...
            try
            {
                ...
                Dispersados = dbmIntegration.SchemaBcoBogota.PA_SelectStament_Municipios_Dispersion.DBExecute(this._StrFechaRecaudo);

                if (Dispersados.Rows.Count == 0)
                {
                    dbmIntegration.SchemaBcoBogota.PA_Dispersion_2.DBExecute(this._StrFechaRecaudo, false);
                    Dispersados = dbmIntegration.SchemaBcoBogota.PA_SelectStament_Municipios_Dispersion.DBExecute(this._StrFechaRecaudo);
                }
