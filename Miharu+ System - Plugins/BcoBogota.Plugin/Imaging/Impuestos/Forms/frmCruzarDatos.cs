...
namespace BcoBogota.Plugin.Imaging.Impuestos.Forms
{
    public partial class frmCruzarDatos : Form
    {
        ...
        public frmCruzarDatos(ImpuestosPlugin _plugin, string TipoCruce)
        {
            ...
            try
            {
                ...
                //{
                    ...
                    if (this._tipoCruce == "MEDIO_PAGO")
                    {
                        ...
                        ResultadoCruceMedioPago = dbmIntegration.SchemaBcoBogota.PA_NEW_00_Cruce_MedioPago.DBExecute(this.strFechaProceso);
                    ...
                    else
                    {
                        ...
                        ResultadoCruceFormulario = dbmIntegration.SchemaBcoBogota.PA_NEW_00_Cruce.DBExecute(this.strFechaProceso, this._PluginBcoBogota.Manager.ImagingGlobal.Entidad, this._PluginBcoBogota.Manager.ImagingGlobal.Proyecto);
                        ...
                        ResultadoCruceValor = dbmIntegration.SchemaBcoBogota.PA_NEW_00_Cruce_Por_Valor .DBExecute(this.strFechaProceso);
