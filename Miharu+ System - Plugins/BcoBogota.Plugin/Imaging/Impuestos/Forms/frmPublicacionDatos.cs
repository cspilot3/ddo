...
namespace BcoBogota.Plugin.Imaging.Impuestos.Forms
{
    public partial class frmPublicacionDatos : Form
    {
        ...
        private ImpuestosPlugin _PluginBcoBogota;
        ...
        #region "Constructor"
        public frmPublicacionDatos(ImpuestosPlugin _plugin)
        {
            InitializeComponent();
        ...
        private void PublicarDatos()
        {
            ...
            DBIntegrationDataBaseManager dbmIntegration = new DBIntegrationDataBaseManager(_PluginBcoBogota.BcoBogotaConnectionString);
            int hayError = 0;
            ...
            try
            {
                ...
                var dtResult = dbmIntegration.SchemaBcoBogota.PA_NEW_00_Reporte_ImpuestosMunicipio1_BBogota.DBExecute(this.Entidad, this.Proyecto, this.strFechaProceso, this._PluginBcoBogota.Manager.Sesion.Usuario.id,false);
        ...
        public void CruzarDatos()
        {
            ...
            try
            {
                dbmIntegration  = new DBIntegration.DBIntegrationDataBaseManager(_PluginBcoBogota.BcoBogotaConnectionString);
                dbmIntegration.Connection_Open(_PluginBcoBogota.Manager.Sesion.Usuario.id);

                this.backgroundWorkerPublicacion.ReportProgress(0, "Realizando Cruzado de Datos...Progreso General");
                dbmIntegration.SchemaBcoBogota.PA_NEW_00_Cruce.DBExecute(this.strFechaProceso, this._PluginBcoBogota.Manager.ImagingGlobal.Entidad, this._PluginBcoBogota.Manager.ImagingGlobal.Proyecto);
