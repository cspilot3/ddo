...
namespace BcoBogota.Plugin.Imaging.Impuestos.Forms
{
    public partial class frmReportesImpuestos : Form
    {
        ...
        public frmReportesImpuestos(ImpuestosPlugin _plugin)
        {
            InitializeComponent();
        ...
        private void backgroundWorkerReport_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            if (!e.Cancel)
            {
                if (this._tipoReporte == "Matriz1")
                {
                    ...
                    this.Matriz1 = dbmIntegration.SchemaBcoBogota.PA_Reporte_Matriz1_BBogota.DBExecute(strFechaRecaudo);

                    if (this.Matriz1.Rows.Count > 0)
                    {
                        _nombreReporte = string.Format(dbmIntegration.SchemaBcoBogota.TBL_Config_Reporte.DBFindByNombre_Reporte("MATRIZ1").FirstOrDefault().Formato_Reporte, frmFechaRecaudo.Fecha_Recaudo);
                ...
                {
                    this.Matriz2 = dbmIntegration.SchemaBcoBogota.PA_Reporte_Matriz2_BBogota.DBExecute(strFechaRecaudo);

                    if (this.Matriz2.Rows.Count > 0)
                    {
                        _nombreReporte = string.Format(dbmIntegration.SchemaBcoBogota.TBL_Config_Reporte.DBFindByNombre_Reporte("MATRIZ2").FirstOrDefault().Formato_Reporte, frmFechaRecaudo.Fecha_Recaudo);
            ...
            try
            {
               ...
               frmFechaRecaudo = new frmFechaRecaudo(true);
                ...
                if ((frmFechaRecaudo.ShowDialog() == System.Windows.Forms.DialogResult.OK))
                {
                    ...
                    dtFranquicias = dbmIntegration.SchemaBcoBogota.PA_Reporte_Franquicias.DBExecute(frmFechaRecaudo.Fecha_Recaudo.ToString("yyyy/MM/dd"));
                    string reportFormat = dbmIntegration.SchemaBcoBogota.TBL_Config_Reporte.DBFindByNombre_Reporte("REPORTE_FRANQUICIAS").FirstOrDefault().Formato_Reporte;
                    ...
                    string Extension = dbmIntegration.SchemaBcoBogota.TBL_Config_Reporte.DBFindByNombre_Reporte("REPORTE_FRANQUICIAS").FirstOrDefault().Extension_Salida;
        ...
        private void Reportes_Empaque()
        {
            ...
            try
            {
                ...
                if (ElegirFecha.FechaFinal != null && ElegirFecha.FechaInicial != null)
                {
                    ...
                    dtReportesEmpaque1 = dbmIntegration.SchemaBcoBogota.PA_Reportes_Empaque.DBExecute(ElegirFecha.FechaInicial, ElegirFecha.FechaFinal, 1);
                    dtReportesEmpaque1.TableName = "Reporte Empaque 1";
                    dtReportesEmpaque2 = dbmIntegration.SchemaBcoBogota.PA_Reportes_Empaque.DBExecute(ElegirFecha.FechaInicial, ElegirFecha.FechaFinal, 2);
                    dtReportesEmpaque2.TableName = "Reporte Empaque 2";
                    dtReportesEmpaque3 = dbmIntegration.SchemaBcoBogota.PA_Reportes_Empaque.DBExecute(ElegirFecha.FechaInicial, ElegirFecha.FechaFinal, 3);
                    ...
                    if (dtReportesEmpaque1.Rows.Count > 0 && dtReportesEmpaque2.Rows.Count > 0 && dtReportesEmpaque3.Rows.Count > 0)
                    {
                        ...
                        this._nombreReporte = string.Format(dbmIntegration.SchemaBcoBogota.TBL_Config_Reporte.DBFindByNombre_Reporte("REPORTES_EMPAQUE").FirstOrDefault().Formato_Reporte, DateTime.Now);
                        string Extension = dbmIntegration.SchemaBcoBogota.TBL_Config_Reporte.DBFindByNombre_Reporte("REPORTES_EMPAQUE").FirstOrDefault().Extension_Salida;
        ...
        private void Reporte_Infivalle()
        {
            ...
            try
            {
                ...
                if ((frmFechaRecaudo.ShowDialog() == System.Windows.Forms.DialogResult.OK))
                {
                    ...
                    dtDetallado_Novalle = dbmIntegration.SchemaBcoBogota.PA_Reporte_FechaRecaudo_Infivalle.DBExecute(frmFechaRecaudo.Fecha_Recaudo.ToString("yyyy/MM/dd"));
                    this._nombreReporte = dbmIntegration.SchemaBcoBogota.TBL_Config_Reporte.DBFindByNombre_Reporte("FECHA_RECAUDO_DETALLADO_INFIVALLE").FirstOrDefault().Formato_Reporte;
                    string Extension = dbmIntegration.SchemaBcoBogota.TBL_Config_Reporte.DBFindByNombre_Reporte("FECHA_RECAUDO_DETALLADO_INFIVALLE").FirstOrDefault().Extension_Salida;
        ...
        private void FechaRecaudo_Detallado_Novalle()
        {
            ...
            try
            {
                ...
                if ((frmFechaRecaudo.ShowDialog() == System.Windows.Forms.DialogResult.OK))
                {
                    ...
                    dtDetallado_Novalle = dbmIntegration.SchemaBcoBogota.PA_Reporte_FechaRecaudo_Detallado.DBExecute(frmFechaRecaudo.Fecha_Recaudo.ToString("yyyy/MM/dd"));

                    this._nombreReporte = dbmIntegration.SchemaBcoBogota.TBL_Config_Reporte.DBFindByNombre_Reporte("FECHA_RECAUDO_DETALLADO_NOVALLE").FirstOrDefault().Formato_Reporte;
                    string Extension = dbmIntegration.SchemaBcoBogota.TBL_Config_Reporte.DBFindByNombre_Reporte("FECHA_RECAUDO_DETALLADO_NOVALLE").FirstOrDefault().Extension_Salida;
        ...
        private void Dispersion_2_Resumida()
        {
            ...
            try
            {
                ...
                if ((frmFechaRecaudo.ShowDialog() == System.Windows.Forms.DialogResult.OK))
                {
                    ...
                    var resumidaGeneral =   dbmIntegration.SchemaBcoBogota.PA_SelectStament_Municipios_Dispersion.DBExecute(frmFechaRecaudo.Fecha_Recaudo.ToString("yyyy/MM/dd"));
        ...
        private void Dispersion_1()
        {
            ...
            if ((frmFechaRecaudo.ShowDialog() == System.Windows.Forms.DialogResult.OK))
            {
                ...
                try
                {
                    ...
                    _nombreReporte = string.Format(dbmIntegration.SchemaBcoBogota.TBL_Config_Reporte.DBFindByNombre_Reporte("DISPERSION_DETALLADA").FirstOrDefault().Formato_Reporte, frmFechaRecaudo.Fecha_Recaudo);

                    this.ltReportDataSources.Clear();
                    InformeDataTable.Clear();
                    InformeDataTable = dbmIntegration.SchemaBcoBogota.PA_Reportes_AuxiliaresBBogota_Impuestos.DBExecute("", 10, strFechaRecaudo, this._Plugin.Manager.ImagingGlobal.Entidad);


                    //Recaudo Municipios Valle
                    dtRecaudoValle.Clear();
                    dtRecaudoValle = dbmIntegration.SchemaBcoBogota.PA_Reportes_AuxiliaresBBogota_Impuestos.DBExecute("", 1, strFechaRecaudo, this._Plugin.Manager.ImagingGlobal.Entidad);

                    //Recaudo Municipios Otros
                    dtRecaudoOtrosMunicipios.Clear();
                    dtRecaudoOtrosMunicipios = dbmIntegration.SchemaBcoBogota.PA_Reportes_AuxiliaresBBogota_Impuestos.DBExecute("", 2, strFechaRecaudo, this._Plugin.Manager.ImagingGlobal.Entidad);

                    //Consolidado Oficinas 
                    ConsolidadoOficinas.Clear();
                    ConsolidadoOficinas = dbmIntegration.SchemaBcoBogota.PA_Reportes_AuxiliaresBBogota_Impuestos.DBExecute("", 4, strFechaRecaudo, this._Plugin.Manager.ImagingGlobal.Entidad);

                    //Consolidados Formas de Pago
                    ConsolidadoFormasPago.Clear();
                    ConsolidadoFormasPago = dbmIntegration.SchemaBcoBogota.PA_Reportes_AuxiliaresBBogota_Impuestos.DBExecute("", 5, strFechaRecaudo, this._Plugin.Manager.ImagingGlobal.Entidad);

                    //Tipos Formularios
                    TiposFormularios.Clear();
                    TiposFormularios = dbmIntegration.SchemaBcoBogota.PA_Reportes_AuxiliaresBBogota_Impuestos.DBExecute("", 6, strFechaRecaudo, this._Plugin.Manager.ImagingGlobal.Entidad);

                    //Valores Formularios
                    valoresFormularios.Clear();
                    valoresFormularios = dbmIntegration.SchemaBcoBogota.PA_Reportes_AuxiliaresBBogota_Impuestos.DBExecute("", 7, strFechaRecaudo, this._Plugin.Manager.ImagingGlobal.Entidad);
                    ...
                    this.reportViewerImpuestos.LocalReport.ReportEmbeddedResource = "BcoBogota.Plugin.Imaging.Impuestos.Forms.Rpts.Reporte_Dispersion1.Reporte_Dispersion1.rdlc";
        ...
        private void Reporte_Todos()
        {
            ...
            {
                dbmIntegration.Connection_Open(this._Plugin.Manager.Sesion.Usuario.id);
                var Reportes = dbmIntegration.SchemaBcoBogota.TBL_Config_Reporte.DBGet(null);
                 ...
                 if ((frmFechaRecaudo.ShowDialog() == System.Windows.Forms.DialogResult.OK))
                 {
                     ...
                     for (int i = 0; i <= Reportes.Count - 1; i++)
                     {
                         ...
                         if (AplicaTodos)
                         {
                             ...
                             _nombreReporte = string.Format(dbmIntegration.SchemaBcoBogota.TBL_Config_Reporte.DBFindByNombre_Reporte(ReportName).FirstOrDefault().Formato_Reporte, DateTime.Now);
                             ...
                             if (ReportName == "FALTANTES" || ReportName == "SOBRANTES")
                             {
                                 ...
                                 Resumen = dbmIntegration.SchemaBcoBogota.PA_SeleccionaReporte.DBExecute(ReportName, StrFechaProceso, true);
                                 Detalle = dbmIntegration.SchemaBcoBogota.PA_SeleccionaReporte.DBExecute(ReportName, StrFechaProceso, false);
                             ...
                             else
                             {
                                 ...
                                 dtAux = dbmIntegration.SchemaBcoBogota.PA_SeleccionaReporte.DBExecute(ReportName, StrFechaProceso, false);
        ...
        private void Reporte_Conciliacion()
        {
            ...
            try
            {
                ...
                if ((frmFechaRecaudo.ShowDialog() == System.Windows.Forms.DialogResult.OK))
                {
                    DataTable Conciliacion = dbmIntegration.SchemaBcoBogota.PA_Reporte_Conciliacion.DBExecute();

                    _nombreReporte = string.Format(dbmIntegration.SchemaBcoBogota.TBL_Config_Reporte.DBFindByNombre_Reporte("CONCILIACION").FirstOrDefault().Formato_Reporte, DateTime.Now);
        ...
        private void Reporte_Sobrantes()
        {
            ...
            try
            {
                ...
                if ((frmFechaRecaudo.ShowDialog() == System.Windows.Forms.DialogResult.OK))
                {
                    DataTable Sobrantes_Resumen = dbmIntegration.SchemaBcoBogota.PA_Reporte_Sobrantes.DBExecute(frmFechaRecaudo.Fecha_Recaudo.ToString("yyyy/MM/dd"), true);
                    DataTable Sobrantes_Detalle = dbmIntegration.SchemaBcoBogota.PA_Reporte_Sobrantes.DBExecute(frmFechaRecaudo.Fecha_Recaudo.ToString("yyyy/MM/dd"), false);
                    ...
                    _nombreReporte = string.Format(dbmIntegration.SchemaBcoBogota.TBL_Config_Reporte.DBFindByNombre_Reporte("SOBRANTES").FirstOrDefault().Formato_Reporte, DateTime.Now);
        ...
        private void Reporte_Fantantes()
        {
            ...
            try
            {
                ...
                if ((frmFechaRecaudo.ShowDialog() == System.Windows.Forms.DialogResult.OK))
                {
                    DataTable Faltantes_Resumen = dbmIntegration.SchemaBcoBogota.PA_Reporte_Faltantes.DBExecute(frmFechaRecaudo.Fecha_Recaudo.ToString("yyyy/MM/dd"), true);
                    DataTable Faltantes_Detalle = dbmIntegration.SchemaBcoBogota.PA_Reporte_Faltantes.DBExecute(frmFechaRecaudo.Fecha_Recaudo.ToString("yyyy/MM/dd"), false);
                    ...
                    _nombreReporte = string.Format(dbmIntegration.SchemaBcoBogota.TBL_Config_Reporte.DBFindByNombre_Reporte("FALTANTES").FirstOrDefault().Formato_Reporte, DateTime.Now);
        ...
        { 
            ...
            if ((frmFechaRecaudo.ShowDialog() == System.Windows.Forms.DialogResult.OK))
            {
                ...
                try
                {
                    ...
                    _nombreReporte = string.Format(dbmIntegration.SchemaBcoBogota.TBL_Config_Reporte.DBFindByNombre_Reporte("WORD1").FirstOrDefault().Formato_Reporte, frmFechaRecaudo.Fecha_Recaudo);
                    ...
                    this.reportViewerImpuestos.Reset();
                    this.reportViewerImpuestos.LocalReport.DisplayName = _nombreReporte;
                    this.reportViewerImpuestos.LocalReport.ReportEmbeddedResource = "BcoBogota.Plugin.Imaging.Impuestos.Forms.Rpts.ReporteMunicipios1_Banco_de_BogotaImpuestos.Reporte1_BBogotaImpuestos.rdlc";
                    this.reportViewerImpuestos.LocalReport.SetParameters(Parametros);
                    this.reportViewerImpuestos.LocalReport.DataSources.Clear();
        ...
        private void Reporte_Municipios_2()
        {
            ...
            if ((frmFechaRecaudo.ShowDialog() == System.Windows.Forms.DialogResult.OK)) {
                ...
                try {
                    ...
                    dtDetalladoValle = dbmIntegration.SchemaBcoBogota.PA_Reportes_AuxiliaresBBogota_Impuestos.DBExecute("", 8, strFechaRecaudo, this._Plugin.Manager.ImagingGlobal.Entidad);

		            //Detallado Otros Municipios
		            dtDetalladoOtrosMunicipios.Clear();
                    dtDetalladoOtrosMunicipios = dbmIntegration.SchemaBcoBogota.PA_Reportes_AuxiliaresBBogota_Impuestos.DBExecute("", 9, strFechaRecaudo, this._Plugin.Manager.ImagingGlobal.Entidad);
                    ...
                    this.reportViewerImpuestos.LocalReport.ReportEmbeddedResource = "BcoBogota.Plugin.Imaging.Impuestos.Forms.Rpts.ReporteMunicipios2_Detallado_BBogota.Reporte2_BBogotaImpuestos.rdlc";
                    this.reportViewerImpuestos.LocalReport.SetParameters(Parametros);
                    this.reportViewerImpuestos.LocalReport.DataSources.Clear();
                    this.reportViewerImpuestos.Visible = true;
        ...
        private void Genera_matriz1_Background(string strFechaRecaudo, DBIntegration.DBIntegrationDataBaseManager  dbmIntegration)
        {
            try
            {
                ...
                //Ejecuta faltantes
                dbmIntegration.SchemaBcoBogota.PA_Reporte_Faltantes.DBExecute(strFechaRecaudo, true);

                var Faltantes_FechaRecaudo = dbmIntegration.SchemaBcoBogota.PA_Reporte_Faltantes.DBExecute(strFechaRecaudo, true);
        ...
        public void Reporte_CartaEntrega()
        {
            ...
            try
            {
                ...
                if (ElegirFecha.FechaFinal != null && ElegirFecha.FechaInicial != null)
                {
                    ...
                    dtReporteCarta_R1 = dbmIntegration.SchemaBcoBogota.PA_Reporte_CartaEntrega_Fisico_R1.DBExecute(ElegirFecha.FechaInicial, ElegirFecha.FechaFinal);
                    dtReporteCarta_R2 = dbmIntegration.SchemaBcoBogota.PA_Reporte_CartaEntrega_Fisico_R2.DBExecute(ElegirFecha.FechaInicial, ElegirFecha.FechaFinal);

                    this._nombreReporte = dbmIntegration.SchemaBcoBogota.TBL_Config_Reporte.DBFindByNombre_Reporte("REPORTE_CARTA_ENTREGA_FISICO").FirstOrDefault().Formato_Reporte;
                    ...
                    this.reportViewerImpuestos.Reset();
                    this.reportViewerImpuestos.LocalReport.DisplayName = _nombreReporte;
                    this.reportViewerImpuestos.LocalReport.ReportEmbeddedResource = "BcoBogota.Plugin.Imaging.Impuestos.Forms.Rpts.Reporte_Carta_EntregaFisico.Reporte_Carta_EntregaFisico.rdlc";
                    this.reportViewerImpuestos.LocalReport.SetParameters(Parametros);
                    this.reportViewerImpuestos.LocalReport.DataSources.Clear();
        ...
        private void Reporte_AgrupadoDepartamentos()
        {
            ...
            try
            {
                ...
                if (ElegirFecha.FechaFinal != null && ElegirFecha.FechaInicial != null)
                {
                    dtAgrupadosNoValle = dbmIntegration.SchemaBcoBogota.PA_Reporte_Agrupado_Departamentos.DBExecute(ElegirFecha.FechaInicial, ElegirFecha.FechaFinal);
                }
                else
                {
                    DesktopMessageBoxControl.DesktopMessageShow("No hay datos para este rango de Fechas!!", "Error", DesktopMessageBoxControl.IconEnum.AdvertencyIcon, true);
                ...
                this._nombreReporte = dbmIntegration.SchemaBcoBogota.TBL_Config_Reporte.DBFindByNombre_Reporte("REPORTE_DETALLADO_DPTOS_NOVALLE").FirstOrDefault().Formato_Reporte;

                this.reportViewerImpuestos.Reset();
                this.reportViewerImpuestos.LocalReport.DisplayName = _nombreReporte;
                this.reportViewerImpuestos.LocalReport.ReportEmbeddedResource = "BcoBogota.Plugin.Imaging.Impuestos.Forms.Rpts.Reporte_Agrupado_Departamentos_NOVALLE.Reporte_Agrupado_Departamentos_NOVALLE.rdlc";
                //this.reportViewerImpuestos.LocalReport.SetParameters(Parametros);
                this.reportViewerImpuestos.LocalReport.DataSources.Clear();
