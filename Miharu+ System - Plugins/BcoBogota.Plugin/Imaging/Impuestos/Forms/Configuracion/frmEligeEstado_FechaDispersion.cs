...
namespace BcoBogota.Plugin.Imaging.Impuestos.Forms.Configuracion
{
    public partial class frmEligeEstado_FechaDispersion : Form
    {
        ...
        public frmEligeEstado_FechaDispersion(ImpuestosPlugin plugin, List<int> ltIdEditar)
        {
        ...
        private void frmEligeEstado_FechaDispersion_Load(object sender, EventArgs e)
        {
            ...
            DBIntegrationDataBaseManager dbmIntegation = new DBIntegrationDataBaseManager(this._Plugin.BcoBogotaConnectionString);
            try
            {
                dbmIntegation.Connection_Open(this._Plugin.Manager.Sesion.Usuario.id);

                var EstadosDispersion = dbmIntegation.SchemaBcoBogota.TBL_Estados_Dispersion.DBGet(null);
        ...
        private void ActualizarRegistros()
        {
            ...
            DBIntegrationDataBaseManager dbmIntegration = new DBIntegration.DBIntegrationDataBaseManager(this._Plugin.BcoBogotaConnectionString);
            ...
            try
            {
                ...
                {
                    DBIntegration.SchemaBcoBogota.TBL_Relacion_Municipios_DispersionType rowUpdate = null;

                    foreach (var itemIds in this._ltIdEditar)
                    {
                        contadorUpdate++;
                        this.pbActualizando.Value = contadorUpdate;
                        rowUpdate = new DBIntegration.SchemaBcoBogota.TBL_Relacion_Municipios_DispersionType();
                        ...
                        dbmIntegration.SchemaBcoBogota.TBL_Relacion_Municipios_Dispersion.DBUpdate(rowUpdate, itemIds);
