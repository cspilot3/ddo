...
{
    public class ImpuestosPlugin : IDesktopPlugin 
    {
        #region "Declaraciones"

        public const short ModuloId = 33;

        public const string ConfigurationPrefix = "PluginBcoBogota_";

        private EventExecuterImpuestos _EventExecuter; 

        private DesktopPluginManager _Manager;

        private FormImagingWorkSpace _WorkSpace;

        private string _BcoBogotaConnectionString;

        private string _ToolsConnectionString;

        private FormImagingWorkSpaceWrapperImpuestos _Wrapper;
        ...
        public ImpuestosPlugin() {
                this._EventExecuter = new EventExecuterImpuestos(this);
        }
        ...
        public string BcoBogotaConnectionString
        {
            get { return this._BcoBogotaConnectionString; }
        }
        ...
        public FormImagingWorkSpaceWrapperImpuestos Wrapper
        {
        ...
        public static short Imaging_BcoBogota_ProyectoId { get; set; }
        ...
        {
            Imaging_EntidadId = 30;
            Imaging_BcoBogota_ProyectoId = 1;
            ...
            if ((nEntidad != Imaging_EntidadId))
                return false;
            if ((nProyecto != Imaging_BcoBogota_ProyectoId))
                return false;
            return true;
        }
		        ...
		        if ((ModuloDataTable.Count > 0)) {
			        foreach (var modulo_loopVariable in ModuloDataTable) {
				        ...
				        switch (modulo_loopVariable.id_Modulo) {
					        case 33:
                                this._BcoBogotaConnectionString = modulo_loopVariable.ConnectionString;
						        break;
					        case 3:
        ...
        public void Activate()
        {
            try
            {
                this._Wrapper = new FormImagingWorkSpaceWrapperImpuestos(this);
        ...
        {
            return "BancoBogota_ImpuestosPlugin";
        }

        public string GetName()
        {
            return "Libreria especializada para BancoBogota-Impuestos";
        }
