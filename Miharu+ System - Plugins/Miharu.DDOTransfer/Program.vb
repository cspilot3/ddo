...
#Region " Declaraciones "
    ...
    Public Shared Config As New DDOTransferConfig
    Public Shared ConnectionStrings As DDOTransferConfig.TypeConnectionString
...
#Region " Propiedades "
    ...
    Friend Shared ReadOnly Property AppDataPath() As String
        Get
            Return Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData).TrimEnd("\"c) + "\PYC\Miharu.DDOTransfer\"
        End Get
    End Property
