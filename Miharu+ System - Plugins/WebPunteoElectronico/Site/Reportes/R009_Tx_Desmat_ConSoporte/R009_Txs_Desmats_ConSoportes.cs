...
namespace WebPunteoElectronico.Site.Reportes.R009_OperacionSinSoporteDefinido
{
    public class R009_Txs_Desmats_ConSoportes : WebReport
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "3.1.10";
        ...
        {
            get { return "09-Transacciones Desmaterializadas con Soporte Físico"; }
        }
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_09_Transacciones_Desmaterializadas_Con_Soporte_Físico.DBExecute(IdRegional,
                                                                                                    idCOB,
                                                                                                    IdOficina,
                ...
                var reportDataSource = new ReportDataSource("CTA_09_Transacciones_Desmaterializadas_Con_Soporte_Físico", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.R009_Tx_Desmat_ConSoporte.R009_Txs_Desmats_ConSoportes;
