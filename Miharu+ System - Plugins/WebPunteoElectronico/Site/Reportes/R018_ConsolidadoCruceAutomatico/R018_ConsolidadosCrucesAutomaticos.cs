...
namespace WebPunteoElectronico.Site.Reportes.R018_ConsolidadoCruceAutomatico
{
    public class R018_ConsolidadosCrucesAutomaticos : WebReport
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "3.2.8";
        ...
        {
            get { return "18-Consolidado del cruce automático"; }
        }
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_18_Consolidado_Cruce_Automatico.DBExecute(IdRegional,
                                                                                                    idCOB,
                                                                                                    IdOficina,
                ...
                var reportDataSource = new ReportDataSource("CTA_18_Consolidado_Cruce_Automatico", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.R018_ConsolidadoCruceAutomatico.R018_ConsolidadosCrucesAutomaticos;
