<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterForm.Master" AutoEventWireup="true"
    CodeBehind="WebReportViewerG.aspx.cs" Inherits="WebPunteoElectronico.Site.Reportes.WebReportViewerG" %>
            ...
            <td>
                <table border="0" cellpadding="0" cellspacing="0" class="page-table">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="UsuarioFindDropDownList" runat="server" Width="300px" AutoPostBack="True"
                                CssClass="textbox">
                            </asp:DropDownList>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="RadicacionFindTextBox" runat="server" Width="300px" value="0"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="cs50 label">
                        ...
                        <td class="label">
                            <asp:Label ID="FechaProcesoLabel" runat="server" CssClass="label" Text="Rango fecha"></asp:Label>
                        </td>
                        <td class="cs10">
                            &nbsp;
                        </td>
