...
namespace WebPunteoElectronico.Site.Reportes.R001_ContenedoresOficina
{
    public class R001_ContenedoresOficinas : WebReport
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "3.1.1";
        public string Query = "";
        ...
        {
            get { return "01-Contenedores Oficinas"; }
        }
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_01_Contenedor_Oficina.DBExecute(IdRegional,
                                                                                                        idCOB,
                                                                                                        IdOficina,
                ...
                var reportDataSource = new ReportDataSource("CTA_01_Contenedor_Oficina", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.R001_ContenedorOficina.R001_ContenedoresOficinas;
