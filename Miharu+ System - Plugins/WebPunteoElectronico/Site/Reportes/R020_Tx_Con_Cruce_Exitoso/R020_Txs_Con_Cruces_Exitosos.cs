...
namespace WebPunteoElectronico.Site.Reportes.R020_Tx_Con_Cruce_Exitoso
{
    public class R020_Txs_Con_Cruces_Exitosos : WebReport
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "3.2.5";
        ...
        {
            get { return "20-Transacciones Con Cruce Exitoso"; }
        }
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_20_Tx_Con_Cruce_Exitoso.DBExecute(IdRegional,
                                                                                                    idCOB,
                                                                                                    IdOficina,
                ...
                var reportDataSource = new ReportDataSource("CTA_20_Tx_Con_Cruce_Exitoso", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.DisplayName = "R020_Tx_Con_Cruce_Exitoso " + FechaProcesoInicial; 
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.R020_Tx_Con_Cruce_Exitoso.R020_Txs_Con_Cruces_Exitosos;
