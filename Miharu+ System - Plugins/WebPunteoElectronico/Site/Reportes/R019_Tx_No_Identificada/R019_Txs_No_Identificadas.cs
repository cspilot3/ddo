...
namespace WebPunteoElectronico.Site.Reportes.R019_Tx_No_Identificada
{
    public class R019_Txs_No_Identificadas : WebReport
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "3.2.4";
        ...
        {
            get { return "19-Transacciones No Identificadas"; }
        }
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_19_Tx_No_Identificada.DBExecute(IdRegional,
                                                                                                    idCOB,
                                                                                                    IdOficina,
                ...
                var reportDataSource = new ReportDataSource("CTA_19_Tx_No_IdentificadaDataSet", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.R019_Tx_No_Identificada.R019_Txs_No_Identificadas;
