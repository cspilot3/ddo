...
using System.Data;
namespace WebPunteoElectronico.Site.Reportes.R007_OficinaPendienteProceso
{
    public class R007_OficinasPendienteProceso : WebReport
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "3.1.8";
        ...
        {
            get { return "07-Oficinas Pendientes Proceso"; }
        }
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_07_Oficina_Pendiente_Proceso.DBExecute(IdRegional,
                                                                                                                idCOB,
                                                                                                                IdOficina,
                ...
                var reportDataSource = new ReportDataSource("CTA_07_Oficina_Pendiente_Proceso", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.R007_OficinaPendienteProceso.R007_OficinasPendienteProceso;
