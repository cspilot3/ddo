<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterForm.Master" AutoEventWireup="true"
    CodeBehind="WebReportViewerF.aspx.cs" Inherits="WebPunteoElectronico.Site.Reportes.WebReportViewerF" %>
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="page-table">
                    <tr>
                        ...
                        <td class="label" style="width: 200px">
                            <asp:Label ID="LabelModo" runat="server" CssClass="label" Text="Modo:"></asp:Label>
                        </td>
                        <td class="cs10">
                            &nbsp;
                        </td>
                        <td style="text-align:left;">
                            <asp:DropDownList ID="ModoFindDropDownList" runat="server" AutoPostBack="True">
                                <asp:ListItem Text="Fecha Movimiento Banco" Value="1" Selected="True" />
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 200px">
                            <cc1:DFecha ID="FechaMovimientoTextBox" runat="server" DateFormat="yyyy/MM/dd" MaskFormat="YearMonthDay"
                                CssClass="textbox" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="left">
                            <asp:Button ID="FacturarButton" runat="server" onclick="FacturarButton_Click" 
                                Text="Facturar" Visible="false"/>
                        </td>
                    </tr>
                </table>
            </td>
