...
namespace WebPunteoElectronico.Site.Reportes.R002_DiferenciaDocEnviadoReportado
{
    public class R002_DiferenciasDocsEnviadosReportados : WebReport
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "3.1.2";
        public string Query = "";
        ...
        {
            get { return "02-Diferencias entre documentos físicos en tula y en contenedores"; }
        }
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_02_Diferencias_entre_Doc_Fisicos_en_Tula_y_en_Contenedores.DBExecute(IdRegional,
                                                                                                    idCOB,
                                                                                                    IdOficina,
                ...
                var reportDataSource = new ReportDataSource("CTA_02_Diferencias_entre_Doc_Fisicos_en_Tula_y_en_Contenedores", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.R002_DiferenciaDocEnviadoReportado.R002_DiferenciasDocsEnviadosReportados;
