...
{
    public partial class WebReportViewerC : FormBase
    {
        #region Propiedades
        ...
        protected override void Config_Page()
        {
            ...
            this.FechaProcesoInicialTextBox.Text = DateTime.Now.AddDays(-1).ToString("yyyy/MM/dd").Replace('-','/');
            this.FechaProcesoFinalTextBox.Text = this.FechaProcesoInicialTextBox.Text;
        ...
        {
            if (!Slyg.Tools.DataConvert.IsDate(this.FechaProcesoInicialTextBox.Text, Slyg.Tools.DataConvert.EnumDateFormat.yyyyMMdd, '/'))
            {
                this.Master.ShowAlert("La fecha de proceso inicial debe tener un formáto válido", MsgBoxIcon.IconWarning);
            }
            else if (!Slyg.Tools.DataConvert.IsDate(this.FechaProcesoFinalTextBox.Text, Slyg.Tools.DataConvert.EnumDateFormat.yyyyMMdd, '/'))
            {
                this.Master.ShowAlert("La fecha de proceso final debe tener un formáto válido", MsgBoxIcon.IconWarning);
            }            
            else if (Slyg.Tools.DataConvert.ToDate(this.FechaProcesoInicialTextBox.Text, Slyg.Tools.DataConvert.EnumDateFormat.yyyyMMdd, '/').Value > Slyg.Tools.DataConvert.ToDate(this.FechaProcesoFinalTextBox.Text, Slyg.Tools.DataConvert.EnumDateFormat.yyyyMMdd, '/').Value)
            {
