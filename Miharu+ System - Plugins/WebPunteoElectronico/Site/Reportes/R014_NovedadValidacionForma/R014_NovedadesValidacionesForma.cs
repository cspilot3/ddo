...
namespace WebPunteoElectronico.Site.Reportes.R014_NovedadValidacionForma
{
    public class R014_NovedadesValidacionesForma : WebReport
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "3.1.5";
        ...
        {
            get { return "14-Novedades en validaciones de forma"; }
        }
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_14_Novedades_en_validaciones_de_Forma.DBExecute(IdRegional,
                                                                                                    idCOB,
                                                                                                    IdOficina,
                ...
                var reportDataSource = new ReportDataSource("CTA_14_Report_Novedades_En_Validaciones_Forma", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.R014_NovedadValidacionForma.R014_NovedadesValidacionesForma;
