...
namespace WebPunteoElectronico.Site.Reportes.R013_ResultadoCruceAutomatico_Medio
{
    public class R013_ResultadosCruceAutomatico_Medio : WebReport
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "3.2.13.4";
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_13_Resultado_Proceso_Cruce_Automatico_Medios_Pago.DBExecute(IdRegional,
                                                                                                    idCOB,
                                                                                                    IdOficina,
                                                                                                    FechaMovimiento);
                ...
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.R013_ResultadoCruceAutomatico_Medio.R013_ResultadosCruceAutomatico_Medio;
