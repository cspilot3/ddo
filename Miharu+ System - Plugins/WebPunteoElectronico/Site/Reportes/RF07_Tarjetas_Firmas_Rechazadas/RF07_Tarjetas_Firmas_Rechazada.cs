...
namespace WebPunteoElectronico.Site.Reportes.RF07_Tarjetas_Firmas_Rechazadas
{
    public class RF07_Tarjetas_Firmas_Rechazada : WebReport
    {
        ...
        {
            get { return "RF07 - Tarjetas de Firmas Rechazadas"; }
        }
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaFirmasReport.PA_Tarjetas_Rechazadas.DBExecute(IdRegional,
                                                                                                              idCOB,
                                                                                                              IdOficina,
                ...
                var reportDataSource = new ReportDataSource("TBL_Tarjetas_RechazadasDataSet", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.DisplayName = "RF07_Tarjetas_Firmas_Rechazada " + FechaProcesoInicial;
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.RF07_Tarjetas_Firmas_Rechazadas.RF07_Tarjetas_Firmas_Rechazada;
