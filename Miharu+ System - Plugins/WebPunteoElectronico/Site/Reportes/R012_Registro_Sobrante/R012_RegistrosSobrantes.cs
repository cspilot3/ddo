...
namespace WebPunteoElectronico.Site.Reportes.R012_Registro_Sobrante
{
    public class R012_RegistrosSobrantes : WebReport
    {
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_12_Registros_Sobrantes.DBExecute(IdRegional,
                                                                                                     idCOB,
                                                                                                     IdOficina,
                ...
                reportParameters.Add(new ReportParameter("Url", Program.LocalServerURL  + Program.VisorTxDetalle));
                ...
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.R012_Registro_Sobrante.R012_RegistrosSobrantes;
