...
namespace WebPunteoElectronico.Site.Reportes.R025_Oficina_Pendiente_Cierre
{
    public class R025_Oficinas_Pendientes_Cierre : WebReport
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "3.1.9";
        ...
        {
            get { return "25-Oficinas Pendientes de Cierre"; }
        }
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_25_Oficinas_Pendientes_Cierre.DBExecute(IdRegional,
                                                                                                    idCOB,
                                                                                                    IdOficina,
                                                                                                    FechaProcesoInicial,
                                                                                                    FechaProcesoFinal
                ...
                var reportDataSource = new ReportDataSource("CTA_25_Oficinas_Pendientes_Cierre", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.R025_Oficina_Pendiente_Cierre.R025_Oficinas_Pendientes_Cierre;
