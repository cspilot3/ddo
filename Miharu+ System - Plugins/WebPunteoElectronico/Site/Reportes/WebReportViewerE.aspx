<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterForm.Master" AutoEventWireup="true"
    CodeBehind="WebReportViewerE.aspx.cs" Inherits="WebPunteoElectronico.Site.Reportes.WebReportViewerE" %>
            ...
            <td>
                <table border="0" cellpadding="0" cellspacing="0" class="page-table">
                    ...
                    <tr>
                        ...
                        <td class="label">
                            <asp:Label ID="FechaMovimientoLabel" runat="server" CssClass="label" Text="Fecha de Movimiento"></asp:Label>
                        </td>
                        <td class="cs10">
                            &nbsp;
                        </td>
                        <td align="left" style="width: 200px">
                            <cc1:DFecha ID="FechaMovimientoTextBox" runat="server" DateFormat="yyyy/MM/dd"
