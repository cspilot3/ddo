<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterForm.Master" AutoEventWireup="true"
    CodeBehind="WebReportViewerH.aspx.cs" Inherits="WebPunteoElectronico.Site.Reportes.WebReportViewerH" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server">
            ...
            <td>
                <table border="0" cellpadding="0" cellspacing="0"  class="page-table" style="text-align:left;">
                    <tr>
                        ...
                        <td rowspan="3" align="right" style="width: 360px">
                            ...
                            <asp:LinkButton ID="ExportarLinkButton" runat="server" CssClass="button" Height="70px" Visible ="false"><img src="../../Images/basic/Save.png" alt="" /><br />Exportar</asp:LinkButton> 
                        </td>
                    </tr>
                    <tr>
                        <td class="cs50 label">
    ...
    <div style="position: absolute; z-index: 0; top: 140px; right: 10px; left: 10px;
        bottom: 5px">
