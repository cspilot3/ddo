...
namespace WebPunteoElectronico.Site.Reportes.RF01_Gestion_Tarjetas_Firmas_Faltantes
{
    public class RF01_Gestion_Tarjetas_Firmas_Faltante : WebReport
    {
        ...
        {
            get { return "RF01 - Gestion de Tarjetas de Firmas Faltantes"; }
        }
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            var Estado = int.Parse(nParameters["Estado"].ToString());
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaFirmasReport.PA_Gestion_Tarjetas_Firmas_Faltantes.DBExecute(IdRegional,
                                                                                                     idCOB,
                                                                                                     IdOficina,
                ...
                var reportParameters = new List<ReportParameter> {new ReportParameter("UsuarioLogin", Login), new ReportParameter("Regional", NombreRegional), new ReportParameter("Cob", NombreCOB), new ReportParameter("Oficina", NombreOficina), new ReportParameter("Url", Program.LocalServerURL + Program.VisorTxDetalleFirmas), new ReportParameter("Img", Program.URLVisorImagenInterno)};

                // Si se pasan los parámetros como null o "", tampoco aparece el reporte...

                var reportDataSource = new ReportDataSource("TBL_Gestion_Tarjetas_Firmas_FaltantesDataSet", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.DisplayName = "RF01_Gestion_Tarjetas_Firmas_Faltantes " + FechaProcesoInicial;
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.RF01_Gestion_Tarjetas_Firmas_Faltantes.RF01_Gestion_Tarjetas_Firmas_Faltante;
