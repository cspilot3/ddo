...
namespace WebPunteoElectronico.Site.Reportes.R013_ResultadoCruceAutomatico_Valor
{
    public class R013_ResultadosCruceAutomatico_Valor : WebReport
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "3.2.13.5";
        ...
        {
            get { return "13-Resultado Proceso cruce automático"; }
        }
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_13_Resultado_Proceso_Cruce_Automatico_Valor.DBExecute(IdRegional,
                                                                                                    idCOB,
                                                                                                    IdOficina,
                                                                                                    FechaMovimiento);
                ...
                reportParameters.Add(new ReportParameter("Url", Program.URLVisorImagen));
                ...
                reportParameters.Add(new ReportParameter("Titulo", "Report_Resultado_Proceso_Cruce_Automatico"));
                
                var reportDataSource = new ReportDataSource("CTA_13_Report_Resultado_Proceso_Cruce_Automatico", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.R013_ResultadoCruceAutomatico_Valor.R013_ResultadosCruceAutomatico_Valor;
