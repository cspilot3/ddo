...
namespace WebPunteoElectronico.Site.Reportes.R022_Tx_Excluida_Cruce
{
    public class R022_Txs_Excluidas_Cruce : WebReport
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "3.2.11";
        ...
        {
            get { return "22-Transacciones Excluidas de Cruce"; }
        }
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_22_Tx_Excluidas_Archivo_Detalle.DBExecute(IdRegional,
                                                                                                    idCOB,
                                                                                                    IdOficina,
                ...
                var reportDataSource = new ReportDataSource("CTA_22_Transacciones_Excluidas_Archivo_Detalle", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.R022_Tx_Excluida_Cruce.R022_Txs_Excluidas_Cruce;
