...
namespace WebPunteoElectronico.Site.Reportes.RF04_Cruce_Exitoso
{
    public class RF04_Cruce_Exitosos : WebReport
    {
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaFirmasReport.PA_Cruce_Exitoso.DBExecute(IdRegional,
                                                                                                              idCOB,
                                                                                                              IdOficina,
                ...
                var reportDataSource = new ReportDataSource("TBL_Cruce_ExitosoDataSet", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.DisplayName = "RF04_Cruce_Exitoso " + FechaProcesoInicial;
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.RF04_Cruce_Exitoso.RF04_Cruce_Exitosos;
