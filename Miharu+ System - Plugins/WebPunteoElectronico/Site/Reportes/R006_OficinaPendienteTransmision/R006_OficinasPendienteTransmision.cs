...
namespace WebPunteoElectronico.Site.Reportes.R006_OficinaPendienteTransmision
{
    public class R006_OficinasPendienteTransmision : WebReport
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "3.1.7";
        ...
        {
            get { return "06-Oficinas Pendientes de Transmisión y/o Envío Movimiento"; }
        }
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_06_Oficina_Sin_Transmision_No_Envio_Movimiento.DBExecute(IdRegional,
                                                                                                    idCOB,
                                                                                                    IdOficina,
                ...
                var reportDataSource = new ReportDataSource("CTA_06_Oficina_Sin_Transmision", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.R006_OficinaPendienteTransmision.R006_OficinasPendienteTransmision;
