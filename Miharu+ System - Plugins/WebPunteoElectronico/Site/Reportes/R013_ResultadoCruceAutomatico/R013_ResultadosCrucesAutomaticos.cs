...
namespace WebPunteoElectronico.Site.Reportes.R013_ResultadoCruceAutomatico
{
    public class R013_ResultadosCrucesAutomaticos : WebReport
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "3.2.3";
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_13_Resultado_Proceso_Cruce_Automatico.DBExecute(IdRegional,
                                                                                                    idCOB,
                                                                                                    IdOficina,
                ...
                reportParameters.Add(new ReportParameter("Titulo", "1"));
                reportParameters.Add(new ReportParameter("Url", Program.LocalServerURL + Program.URLVisorImagen));
                ...
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.R013_ResultadoCruceAutomatico.R013_ResultadosCrucesAutomaticos;
