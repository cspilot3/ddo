...
namespace WebPunteoElectronico.Site.Reportes.RF05_Transacciones_Excluidas_Cruce
{
    public class RF05_Transacciones_Excluida_Cruce : WebReport
    {
        ...
        {
            get { return "RF05 - Transacciones excluidas de cruce"; }
        }
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaFirmasReport.PA_Transacciones_Excluidas_Cruce.DBExecute(IdRegional,
                                                                                                              idCOB,
                                                                                                              IdOficina,
                ...
                var reportDataSource = new ReportDataSource("TBL_Transacciones_Excluidas_CruceDataSet", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.DisplayName = "RF05_Transacciones_Excluidas_Cruce " + FechaProcesoInicial;
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.RF05_Transacciones_Excluidas_Cruce.RF05_Transacciones_Excluida_Cruce;
