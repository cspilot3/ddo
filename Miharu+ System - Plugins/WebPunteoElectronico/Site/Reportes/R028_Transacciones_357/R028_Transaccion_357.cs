...
namespace WebPunteoElectronico.Site.Reportes.R028_Transacciones_357
{
    public class R028_Transaccion_357 : WebReport
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "3.2.9";
        ...
        {
            get { return "26-Transacciones 357"; }
        }
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            var Url = Program.LocalServerURL  + Program.URLVisorImagen;
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_28_Informe_Transaccion_357.DBExecute(IdRegional,
                                                                                                    idCOB,
                                                                                                    IdOficina,
                ...
                var reportParameters = new List<ReportParameter> {new ReportParameter("UsuarioLogin", Login), new ReportParameter("Regional", NombreRegional), new ReportParameter("Cob", NombreCOB), new ReportParameter("Oficina", NombreOficina), new ReportParameter("Url", Url)};

                // Si se pasan los parámetros como null o "", tampoco aparece el reporte...


                var reportDataSource = new ReportDataSource("CTA_28_Informe_Transaccion_357", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.R028_Transacciones_357.R028_Transaccion_357;
