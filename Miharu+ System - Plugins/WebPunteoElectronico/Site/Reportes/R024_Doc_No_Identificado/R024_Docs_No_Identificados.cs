...
namespace WebPunteoElectronico.Site.Reportes.R024_Doc_No_Identificado
{
    public class R024_Docs_No_Identificados : WebReport
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "3.2.6";
        ...
        {
            get { return "24-Documentos No Identificados"; }
        }
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_24_Doc_No_Identificado.DBExecute(IdRegional,
                                                                                                    idCOB,
                                                                                                    IdOficina,
                ...
                var reportDataSource = new ReportDataSource("CTA_24_Doc_No_IdentificadoDataSet", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.R024_Doc_No_Identificado.R024_Docs_No_Identificados;
