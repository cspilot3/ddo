...
namespace WebPunteoElectronico.Site.Reportes.R023_Tx_Reversada_Log
{
    public class R023_Txs_Reversadas_Log : WebReport
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "3.2.12";
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_23_Tx_Reversadas_Archivo_Detalle.DBExecute(IdRegional,
                                                                                                    idCOB,
                                                                                                    IdOficina,
                ...
                reportParameters.Add(new ReportParameter("Url", Program.LocalServerURL  +  Program.VisorTxDetalleLog));

                var reportDataSource = new ReportDataSource("CTA_23_Transacciones_Reversadas_Archivo_Detalle", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.R023_Tx_Reversada_Log.R023_Txs_Reversadas_Log;
