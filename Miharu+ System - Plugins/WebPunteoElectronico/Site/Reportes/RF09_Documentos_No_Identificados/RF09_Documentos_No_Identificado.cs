...
namespace WebPunteoElectronico.Site.Reportes.RF09_Documentos_No_Identificados
{
    public class RF09_Documentos_No_Identificado : WebReport
    {
        ...
        {
            get { return "RF09 - Documentos no Identificados"; }
        }
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaFirmasReport.PA_Documentos_No_Identificado.DBExecute(IdRegional,
                                                                                                              idCOB,
                                                                                                              IdOficina,
                ...
                var reportDataSource = new ReportDataSource("TBL_Documentos_No_IdentificadoDataSet", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.DisplayName = "RF09_Documentos_No_Identificado " + FechaProcesoInicial;
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.RF09_Documentos_No_Identificados.RF09_Documentos_No_Identificado;
