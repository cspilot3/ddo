...
namespace WebPunteoElectronico.Site.Reportes.R004_TranNoOriginaloIlegible
{
    public class R004_TransNoOriginaloIlegible : WebReport
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "3.1.4";
        public string Query = "";
        ...
        {
            get { return "04-Soportes Transacciones Con Inconsistencias y/o Anexos Faltantes"; }
        }
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_04_Soportes_Transacciones_Con_Inconsistencias_y_o_Anexos_Faltantes.DBExecute(IdRegional,
                                                                                                idCOB,
                                                                                                IdOficina,
                ...
                reportParameters.Add(new ReportParameter("Url",Program.VisorTxDetalle));

                var reportDataSource = new ReportDataSource("CTA_04_Soportes_Transacciones_Con_Inconsistencias_y_o_Anexos_Faltantes", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.R004_TranNoOriginaloIlegible.R004_TransNoOriginaloIlegible;
