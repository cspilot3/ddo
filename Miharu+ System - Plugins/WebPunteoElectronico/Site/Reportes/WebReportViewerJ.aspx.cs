...
{
    public partial class WebReportViewerJ : FormBase
    {
        #region Propiedades
        ...
        protected override void Config_Page()
        {
            ...
            this.Master.Title = WebReport.ReportName;

            this.FechaProcesoTextBox.Text = DateTime.Now.AddDays(-1).ToString("yyyy/MM/dd").Replace('-', '/');
            ...
            this.RegionalFindDropDownList.SelectedValue = WebReport.getParameter("idRegional");
                ...
                var Parametros = new Dictionary<string, object>
                                 {
                                     ...
                                     {"IdRegional", short.Parse(this.RegionalFindDropDownList.SelectedValue)},
                                     {"NombreRegional", this.RegionalFindDropDownList.SelectedItem.Text},
                                     {"IdCOB", short.Parse(this.COBFindDropDownList.SelectedValue)},
                                     {"NombreCOB", this.COBFindDropDownList.SelectedItem.Text},
                                     {"IdOficina", int.Parse(this.OficinaFindDropDownList.SelectedValue)},
                                     {"NombreOficina", this.OficinaFindDropDownList.SelectedItem.Text},
                                     {"FechaProceso", this.FechaProcesoTextBox.Text},
                                     {"Login", this.MiharuSession.Usuario.Login},
                                     {"IdUsuario", this.MiharuSession.Usuario.id},
                                     {"Detallado", this.DetalladoCheck.Checked}
                                 };
        ...
        {
            if (!Slyg.Tools.DataConvert.IsDate(this.FechaProcesoTextBox.Text, Slyg.Tools.DataConvert.EnumDateFormat.yyyyMMdd, '/'))
            {
