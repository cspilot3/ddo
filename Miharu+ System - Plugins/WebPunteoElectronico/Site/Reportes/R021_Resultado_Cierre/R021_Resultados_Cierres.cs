...
namespace WebPunteoElectronico.Site.Reportes.R021_Resultado_Cierre
{
    public class R021_Resultados_Cierres : WebReport
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "3.2.7";
        ...
        {
            get { return "21-Resultado Cierre"; }
        }
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_21_Reporte_Cierre.DBExecute(IdRegional,
                                                                                                idCOB,
                                                                                                IdOficina,
                ...
                var reportDataSource = new ReportDataSource("CTA_21_Reporte_Cierre", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.R021_Resultado_Cierre.R021_Resultados_Cierres;
