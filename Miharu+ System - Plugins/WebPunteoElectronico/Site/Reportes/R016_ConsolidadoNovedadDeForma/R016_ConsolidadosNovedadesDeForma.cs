...
namespace WebPunteoElectronico.Site.Reportes.R016_ConsolidadoNovedadDeForma
{
    public class R016_ConsolidadosNovedadesDeForma : WebReport
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "3.1.6";
        ...
        {
            get { return "16-Consolidado de novedades en validaciones de forma"; }
        }
        ...
        public override void Launch(ref ReportViewer nReportViewer, Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_16_Consolidado_Novedades_De_Forma.DBExecute(IdRegional,
                                                                                                    idCOB,
                                                                                                    IdOficina,
                ...
                var reportDataSource = new ReportDataSource("CTA_16_Consolidado_Novedades_De_Forma", DatosDataTable);

                nReportViewer.LocalReport.DataSources.Clear();
                nReportViewer.LocalReport.ReportPath = Reports.Site.Reportes.R016_ConsolidadoNovedadDeForma.R016_ConsolidadosNovedadesDeForma;
