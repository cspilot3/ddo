...
{
    public partial class WebReportViewerE : FormBase
    {
        #region Propiedades
        ...
        protected override void Config_Page()
        {
            ...
            bool IsReload = this.Request.QueryString["Reload"] == "1";

            if (IsReload)
            {
                this.FechaMovimientoTextBox.Text = this.WebReport.getParameter("FechaMovimiento");
                this.WebReport.Reload(ref this.PageReportViewer);
            }
            else
            {
