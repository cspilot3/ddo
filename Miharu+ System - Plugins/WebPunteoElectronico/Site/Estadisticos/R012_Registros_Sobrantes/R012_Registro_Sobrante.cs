...
namespace WebPunteoElectronico.Site.Estadisticos.R012_Registros_Sobrantes
{
    public class R012_Registro_Sobrante : WebGraph
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "7.2.2";
        public string Query = "";
        ...
        {
            get { return "EstadisticoRegistrosSobrantes"; }
        }

        public override string ZipFileName
        {
            get { return "estadistico_registros_sobrantes.zip"; }
        }
        ...
        public override bool Load(Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_Estadistico_12_Registros_Sobrantes.DBExecute(IdRegional,
                                                                                                                    idCOB,
                                                                                                                    IdOficina,
