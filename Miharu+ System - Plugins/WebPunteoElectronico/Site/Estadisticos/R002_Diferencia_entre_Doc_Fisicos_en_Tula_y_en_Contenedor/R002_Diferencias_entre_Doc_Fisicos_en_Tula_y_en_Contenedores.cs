...
namespace WebPunteoElectronico.Site.Estadisticos.R002_Diferencia_entre_Doc_Fisicos_en_Tula_y_en_Contenedor
{
    public class R002_Diferencias_entre_Doc_Fisicos_en_Tula_y_en_Contenedores : WebGraph
    {

        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "7.1.2";
        public string Query = "";
        ...
        {
            get { return "02-Diferencias entre documentos físicos en tulas y folios"; }
        }

        public override string ReportId
        {
            get { return "Diferencias_entre_Doc_Fisicos_en_Tula_y_en_Contenedores"; }
        }

        public override string ZipFileName
        {
            get { return "Diferencias_entre_Doc_Fisicos_en_Tula_y_en_Contenedores.zip"; }
        }
        ...
        public override bool Load(Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_Estadistico_02_Diferencias_entre_Doc_Fisicos_en_Tula_y_en_Contenedores.DBExecute(IdRegional,
                                                                                                                    idCOB,
                                                                                                                    IdOficina,
