...
namespace WebPunteoElectronico.Site.Estadisticos.R011_Ajuste_Soporte_Sobrante
{
    public class R011_Ajuste_Soportes_Sobrantes : WebGraph
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "7.4.1";
        public string Query = "";
        ...
        {
            get { return "11-Ajuste Soportes Sobrantes"; }
        }

        public override string ReportId
        {
            get { return "EstadisticoAjusteSoportesSobrantes"; }
        }

        public override string ZipFileName
        {
            get { return "estadistico_Ajuste_soportes_sobrantes.zip"; }
        }
        ...
        public override bool Load(Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_Estadistico_11_Ajuste_Soporte_Sobrante.DBExecute(IdRegional,
                                                                                                                    idCOB,
                                                                                                                    IdOficina,
