...
namespace WebPunteoElectronico.Site.Estadisticos.R028_Transaccion_357
{
    public class R028_Transacciones_357 : WebGraph
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "7.2.10";
        public string Query = "";
        ...
        {
            get { return "28-Transacción 357"; }
        }

        public override string ReportId
        {
            get { return "Transaccion357"; }
        }

        public override string ZipFileName
        {
            get { return "Estadistico_Transaccion_357.zip"; }
        }
        ...
        public override bool Load(Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_Estadistico_28_Transaccion_357.DBExecute(IdRegional,
                                                                                                                    idCOB,
                                                                                                                    IdOficina,
