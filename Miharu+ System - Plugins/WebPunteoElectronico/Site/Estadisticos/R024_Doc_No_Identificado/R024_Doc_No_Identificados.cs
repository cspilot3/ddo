...
namespace WebPunteoElectronico.Site.Estadisticos.R024_Doc_No_Identificado
{
    public class R024_Doc_No_Identificados : WebGraph
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "7.2.8";
        public string Query = "";
        ...
        {
            get { return "EstadisticoDocumentosNoidentificados"; }
        }

        public override string ZipFileName
        {
            get { return "Documentos_No_identificados.zip"; }
        }
        ...
        public override bool Load(Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_Estadistico_24_Doc_No_Identificado.DBExecute(IdRegional,
                                                                                                                    idCOB,
                                                                                                                    IdOficina,
