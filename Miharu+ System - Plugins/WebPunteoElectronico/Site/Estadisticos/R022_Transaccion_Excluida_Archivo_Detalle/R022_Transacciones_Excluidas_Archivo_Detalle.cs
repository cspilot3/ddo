...
namespace WebPunteoElectronico.Site.Estadisticos.R022_Transaccion_Excluida_Archivo_Detalle
{
    public class R022_Transacciones_Excluidas_Archivo_Detalle : WebGraph
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "7.2.6";
        public string Query = "";
        ...
        {
            get { return "22-Transacciones Excluidas en LOG"; }
        }

        public override string ReportId
        {
            get { return "TransaccionesExcluidasArchivoDetalle"; }
        }

        public override string ZipFileName
        {
            get { return "Transacciones_Excluidas_Archivo_Detalle.zip"; }
        }
        ...
        public override bool Load(Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_Estadistico_22_Transacciones_Excluidas_Archivo_Detalle.DBExecute(IdRegional,
                                                                                                                    idCOB,
                                                                                                                    IdOficina,
