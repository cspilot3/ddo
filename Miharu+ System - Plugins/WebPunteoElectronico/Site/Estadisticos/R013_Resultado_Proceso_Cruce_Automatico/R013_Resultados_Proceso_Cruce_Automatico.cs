...
namespace WebPunteoElectronico.Site.Estadisticos.R013_Resultado_Proceso_Cruce_Automatico
{
    public class R013_Resultados_Proceso_Cruce_Automatico : WebGraph
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "7.2.3";
        public string Query = "";
        ...
        {
            get { return "13-Resultado del proceso de cruce automático."; }
        }

        public override string ReportId
        {
            get { return "EstadisticoResultadoprocesocruceautomatico."; }
        }

        public override string ZipFileName
        {
            get { return "estadistico_resultado_proceso_cruce_automatico.zip"; }
        }
        ...
        public override bool Load(Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_Estadistico_13_Resultado_Proceso_Cruce_Automatico.DBExecute(IdRegional,
                                                                                                                    idCOB,
                                                                                                                    IdOficina,
