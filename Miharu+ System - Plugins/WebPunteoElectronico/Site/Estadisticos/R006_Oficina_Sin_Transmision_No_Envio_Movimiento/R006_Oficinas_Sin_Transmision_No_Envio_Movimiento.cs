...
namespace WebPunteoElectronico.Site.Estadisticos.R006_Oficina_Sin_Transmision_No_Envio_Movimiento
{
    public class R006_Oficinas_Sin_Transmision_No_Envio_Movimiento : WebGraph
    {

        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "7.1.5";
        public string Query = "";
        ...
        {
            get { return "06-Oficinas, áreas, Cobs y centros de efectivo pendientes de transmisión y/o envío de movimiento"; }
        }

        public override string ReportId
        {
            get { return "Estadistico_Oficina_Sin_Transmision_No_Envio_Movimiento"; }
        }

        public override string ZipFileName
        {
            get { return "Oficina_Sin_Transmision_No_Envio_Movimiento.zip"; }
        }
        ...
        public override bool Load(Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_Estadistico_06_Oficina_Sin_Transmision_No_Envio_Movimiento.DBExecute(IdRegional,
                                                                                                                    idCOB,
                                                                                                                    IdOficina,
