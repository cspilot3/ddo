...
namespace WebPunteoElectronico.Site.Estadisticos.R018_Consolidado_Cruce_Automatico
{
    public class R018_Consolidado_Cruces_Automaticos : WebGraph
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "7.3.3";
        public string Query = "";
        ...
        {
            get { return "18-Consolidado Cruce automático"; }
        }

        public override string ReportId
        {
            get { return "EstadisticoConsolidadoCruceautomatico"; }
        }

        public override string ZipFileName
        {
            get { return "Estadistico_Consolidado_Cruce_automatico.zip"; }
        }
        ...
        public override bool Load(Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_Estadistico_18_Consolidado_Cruce_Automatico.DBExecute(IdRegional,
                                                                                                                    idCOB,
                                                                                                                    IdOficina,
