...
namespace WebPunteoElectronico.Site.Estadisticos.R000_Transaccion_Procesada_Mensualmente_Tipo
{
    public class R000_Transacciones_Procesadas_Mensualmente_Tipos : WebGraph
    {

        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "7.3.2";
        public string Query = "";
        #endregion
        ...
        {
            get { return "08-Transacciones procesadas mensualmente"; }
        }

        public override string ReportId
        {
            get { return "EstadisticoReporteTransaccionesprocesadasmensualmente"; }
        }

        public override string ZipFileName
        {
            get { return "EstadisticoReporteTransaccionesprocesadasmensualmente.zip"; }
        }
        ...
        public override bool Load(Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_Estadistico_Reporte_Transacciones_Procesadas_Mensualmente_Tipos.DBExecute(IdRegional,
                                                                                                                    idCOB,
                                                                                                                    IdOficina,
                ...
                base.DataReporte.CampoMostrarX = "Fecha_Movimiento";
