...
namespace WebPunteoElectronico.Site.Estadisticos.R019_Tx_No_Identificada
{
    public class R019_Tx_No_Identificadas : WebGraph
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "7.2.4";
        public string Query = "";
        ...
        {
            get { return "EstadisticoTransaccionesNoidentificadas"; }
        }

        public override string ZipFileName
        {
            get { return "Transacciones_No_identificadas.zip"; }
        }
        ...
        public override bool Load(Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_Estadisticos_19_Tx_No_Identificada.DBExecute(IdRegional,
                                                                                                                    idCOB,
                                                                                                                    IdOficina,
