...
namespace WebPunteoElectronico.Site.Estadisticos.R016_Consolidado_Novedad_De_Forma
{
    public class R016_Consolidado_Novedades_De_Forma : WebGraph
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "7.3.1";
        public string Query = "";
        ...
        {
            get { return "16-Consolidado Novedades en validaciones de forma"; }
        }

        public override string ReportId
        {
            get { return "ConsolidadoNovedadesvalidacionesforma."; }
        }

        public override string ZipFileName
        {
            get { return "Consolidado_Novedades_validaciones_forma.zip"; }
        }
        ...
        public override bool Load(Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_Estadistico_16_Consolidado_Novedades_De_Forma.DBExecute(IdRegional,
                                                                                                                    idCOB,
                                                                                                                    IdOficina,
