...
namespace WebPunteoElectronico.Site.Estadisticos.R012_Ajuste_Registro_Sobrante
{
    public class R012_Ajuste_Registros_Sobrantes : WebGraph
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "7.4.2";
        public string Query = "";
        ...
        {
            get { return "12-Ajuste Registros Sobrantes"; }
        }

        public override string ReportId
        {
            get { return "EstadisticoAjusteRegistrosSobrantes"; }
        }

        public override string ZipFileName
        {
            get { return "estadistico_ajuste_registros_sobrantes.zip"; }
        }
        ...
        public override bool Load(Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_Estadistico_12_Ajuste_Registros_Sobrantes.DBExecute(IdRegional,
                                                                                                                    idCOB,
                                                                                                                    IdOficina,
