...
namespace WebPunteoElectronico.Site.Estadisticos.R023_Transaccion_Reversada_Archivo_Detalle
{
    public class R023_Transacciones_Reversadas_Archivo_Detalle : WebGraph
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "7.2.7";
        public string Query = "";
        ...
        {
            get { return "TransaccionesReversadasArchivoDetalle"; }
        }

        public override string ZipFileName
        {
            get { return "Transacciones_Reversadas_Archivo_Detalle.zip"; }
        }
        ...
        public override bool Load(Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_Estadistico_23_Transacciones_Reversadas_Archivo_Detalle.DBExecute(IdRegional,
                                                                                                                    idCOB,
                                                                                                                    IdOficina,
