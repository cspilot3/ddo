...
namespace WebPunteoElectronico.Site.Estadisticos.R009_Transaccion_Desmaterializadas_Con_Soporte_Fisico
{
    public class R009_Transacciones_Desmaterializadas_Con_Soporte_Fisico : WebGraph
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "7.1.7";
        public string Query = "";
        ...
        {
            get { return "EstadisticoReporteTransaccionesDesmaterializadasSoporteFisico"; }
        }

        public override string ZipFileName
        {
            get { return "TransaccionesDesmaterializadasSoporteFisico.zip"; }
        }
        ...
        public override bool Load(Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_Estadistico_09_Transacciones_Desmaterializadas_Con_Soporte_Físico.DBExecute(IdRegional,
                                                                                                                    idCOB,
                                                                                                                    IdOficina,
