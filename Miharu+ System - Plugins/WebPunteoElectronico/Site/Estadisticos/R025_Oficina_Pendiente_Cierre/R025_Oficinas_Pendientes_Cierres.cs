...
namespace WebPunteoElectronico.Site.Estadisticos.R025_Oficina_Pendiente_Cierre
{
    public class R025_Oficinas_Pendientes_Cierres : WebGraph
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "7.2.9";
        public string Query = "";
        ...
        {
            get { return "OficinasPendientesCierre"; }
        }

        public override string ZipFileName
        {
            get { return "Estadistico_Oficinas_Pendientes_Cierre.zip"; }
        }
        ...
        public override bool Load(Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_Estadistico_25_Oficinas_Pendientes_Cierre.DBExecute(IdRegional,
                                                                                                                    idCOB,
                                                                                                                    IdOficina,
