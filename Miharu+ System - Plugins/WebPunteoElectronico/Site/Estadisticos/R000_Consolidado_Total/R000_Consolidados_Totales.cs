...
namespace WebPunteoElectronico.Site.Estadisticos.R000_Consolidado_Total
{
    public class R000_Consolidados_Totales : WebGraph 
    {
        ...
        {
            get { return "Consolidado General"; }
        }

        public override string ReportId
        {
            get { return "ConsolidadoGeneral"; }
        }

        public override string ZipFileName
        {
            get { return "Consolidado_General.zip"; }
        }
        ...
        public override void Draw(ref System.Web.UI.WebControls.Literal nLiteral, TipoReporteEnum nTipo, short nWidth, short nHeight)
        {
            ...
            nLiteral.Text = ReportGenerator.CreateGraphFiltered(base.DataReporte, nWidth, nHeight);
        }
        ...
        public override bool Load(Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_Estadistico_Consolidado_Total.DBExecute(IdRegional,
                                                                                                                    idCOB,
                                                                                                                    IdOficina,
                ...
                base.DataReporte.EjeX = "Registros";
                ...
                base.DataReporte.CampoMostrarX = "Tipo";
        ...
        public override byte[] BuildZipData()
        {
            ...
            return ReportGenerator.BuildZipData_Consolidado(this.DataReporte.Datos, this.ZipFileName);
        }
