...
namespace WebPunteoElectronico.Site.Estadisticos.R020_Tx_Con_Cruce_Exitoso
{
    public class R020_Tx_Con_Cruces_Exitosos : WebGraph
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "7.2.5";
        public string Query = "";
        ...
        {
            get { return "EstadisticoTransaccionesconcruceexitoso"; }
        }

        public override string ZipFileName
        {
            get { return "transacciones_cruce_exitoso.zip"; }
        }
        ...
        public override bool Load(Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_Estadistico_20_Tx_Con_Cruce_Exitoso.DBExecute(IdRegional,
                                                                                                                    idCOB,
                                                                                                                    IdOficina,
