...
namespace WebPunteoElectronico.Site.Estadisticos.R004_Soporte_Tx_Con_Inconsistencia_y_o_Anexo_Faltante
{
    public class R004_Soportes_Tx_Con_Inconsistencias_y_o_Anexos_Faltantes : WebGraph
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "7.1.4";
        public string Query = "";
        ...
        {
            get { return "04-Soporte de transacciones con inconsistencias o anexos faltantes o sobrantes"; }
        }

        public override string ReportId
        {
            get { return "EstadisticoReporteSoporteTransaccionesInconsistenciasAnexosFaltantesSobrantes"; }
        }

        public override string ZipFileName
        {
            get { return "SoporteTransaccionesInconsistenciasAnexosFaltantesSobrantes.zip"; }
        }
        ...
        public override bool Load(Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_Estadistico_04_Soportes_Tx_Con_Inconsistencias_y_o_Anexos_Faltantes.DBExecute(IdRegional,
                                                                                                                    idCOB,
                                                                                                                    IdOficina,
