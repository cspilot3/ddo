...
namespace WebPunteoElectronico.Site.Estadisticos.R007_Oficina_Pendiente_Proceso
{
    public class R007_Oficinas_Pendiente_Proceso : WebGraph
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "7.1.6";
        public string Query = "";
        ...
        {
            get { return "07-Oficina Pendiente Proceso"; }
        }

        public override string ReportId
        {
            get { return "OficinaPendienteProceso"; }
        }

        public override string ZipFileName
        {
            get { return "OficinaPendienteProceso.zip"; }
        }
        ...
        public override bool Load(Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_Estadistico_07_Oficina_Pendiente_Proceso.DBExecute(IdRegional,
                                                                                                                    idCOB,
                                                                                                                    IdOficina,
                ...
                base.DataReporte.EjeY = "Cantidad Oficinas";
