...
namespace WebPunteoElectronico.Site.Estadisticos.R014_Novedad_en_validacion_de_Forma
{
    public class R014_Novedades_en_validaciones_de_Forma : WebGraph
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "7.1.8";
        public string Query = "";
        ...
        {
            get { return "EstadisticoNovedadesvalidacionesforma"; }
        }

        public override string ZipFileName
        {
            get { return "EstadisticoNovedadesvalidacionesforma.zip"; }
        }
        ...
        public override bool Load(Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_Estadistico_14_Novedades_en_validaciones_de_Forma.DBExecute(IdRegional,
                                                                                                                    idCOB,
                                                                                                                    IdOficina,
