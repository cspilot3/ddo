...
namespace WebPunteoElectronico.Site.Estadisticos.R011_Soporte_Sobrante
{
    public class R011_Soportes_Sobrantes : WebGraph
    {
        #region Declaraciones

        private int IdUsuario;
        public string Path_Nodo = "7.2.1";
        public string Query = "";
        ...
        {
            get { return "EstadisticoSoportesSobrantes"; }
        }

        public override string ZipFileName
        {
            get { return "estadistico_soportes_sobrantes.zip"; }
        }
        ...
        public override bool Load(Dictionary<string, object> nParameters)
        {
            ...
            try
            {
                ...
                DataTable DatosDataTable = dbmBanagrario.SchemaReport.PA_Estadistico_11_Soporte_Sobrante.DBExecute(IdRegional,
                                                                                                                    idCOB,
                                                                                                                    IdOficina,
