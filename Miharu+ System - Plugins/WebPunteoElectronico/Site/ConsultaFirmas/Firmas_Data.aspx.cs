...
{
    public partial class Firmas_Data : System.Web.UI.Page
    {
        ...
        public void ConsultarData()
        {
            ...
            try
            {
                int VerificaSize = PageSize;
                int VerificaSizeLength = VerificaSize.ToString().Length;
                if (VerificaSizeLength > 2)
                {
                    int Val1 = int.Parse(VerificaSize.ToString().Substring(0, VerificaSizeLength / 2));
                    int Val2 = int.Parse(VerificaSize.ToString().Substring((VerificaSizeLength / 2), VerificaSizeLength / 2));
            ...
            try
            {
                ...
                var FechaInicio = (SlygNullable<string>)GetValorParametro("FechaInicial_Input", typeof(string));
                var FechaFin = (SlygNullable<string>)GetValorParametro("FechaFinal_Input", typeof(string));
    ...
    //    private List<string> GetRowData(DataRow nRow)
    //    {
