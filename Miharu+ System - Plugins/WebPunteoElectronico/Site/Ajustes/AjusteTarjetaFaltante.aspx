<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterConfig.Master" AutoEventWireup="true"
    CodeBehind="AjusteTarjetaFaltante.aspx.cs" Inherits="WebPunteoElectronico.Site.Ajustes.AjusteTarjetaFaltante" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContentPlaceHolder" runat="server">
    <script type="text/javascript">
        ...
        function flexigridCellFormat(name, idx, cellHtml, cell) 
        {
            ...
            {
                if (isNaN(cellHtml))
                    return "<span class='link' onclick='window.open(\"../../Site/VisorImagenes/VerImagen.aspx?token=" + cellHtml + "\", \"Detalle\", \"width=1000px,height=600px,resizable=yes\")'>Imagen</span>";
                else
                    return "<span class='link' onclick='window.open(\"../../Site/ConsultaFirmas/VerTxLog.aspx?tx=" + cellHtml + "\", \"Detalle\", \"width=1000px,height=600px,resizable=yes\")'>Registro</span>";
            }
            else
            {
                return cellHtml;
...
<asp:Content ID="DetalleContent" runat="server" ContentPlaceHolderID="TabContentPlaceHolderDetalle">
    <table id="Table1" runat="server">
        <tr id="tr1" runat="server">
            ...
            <td id="tdControlAprobar" runat="server"  visible="false">
                <%--<asp:LinkButton ID="lnkAprobar" OnClick="lnkAprobar_Click" runat="server" CssClass="button"><img src="../../Images/basic/Aprobar.png" alt=""/><br />
                    Aprobar ajuste</asp:LinkButton>--%>
            </td>
            <td>
            </td>
            <td id="tdControlRechazar" runat="server" visible="false">
                <%--<asp:LinkButton ID="lnkRechazar" OnClick="lnkAprobar_Click" runat="server" CssClass="button"><img src="../../Images/basic/Rechazar.png" alt=""/><br />Rechazar ajuste</asp:LinkButton>
            --%></td>
            <td>
            </td>
        </tr>
    ...
    <table>
        <tr>
            ...
            <td align="right">
                <asp:LinkButton ID="VerRegistroButton" runat="server" CssClass="button">Ver registro
                </asp:LinkButton>
            </td>
        </tr>
        <tr>
            <td colspan="3" style="color: #003300; font-weight: bold">
                Datos de la Tarjeta Faltante:
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                <%--<cc1:DTexto ID="txtObservacion" runat="server" Multiline="MultiLine" ValidationGroup="Guardar"
                                    MaxLength="298" Width="320px" Heigth="70px" IsRequiered="True" EmptyValueMessage=" <BR /> Debe ingresar una observación sobre el Ajuste"
    ...
    <div id="VentanaObservacion_Div" style="border-style: solid; border-width: 1px; border-color: #808080 #000000 #000000 #808080;
        display: none; background-color: #CCCCCC; width: 650px; height: 100px; position: absolute !important;
...
<asp:Content ID="FinalScriptContent" runat="server" ContentPlaceHolderID="FinalScriptContentPlaceHolder">
    <script src="AjustesFirmasScript.js" type="text/javascript"></script>
</asp:Content>
