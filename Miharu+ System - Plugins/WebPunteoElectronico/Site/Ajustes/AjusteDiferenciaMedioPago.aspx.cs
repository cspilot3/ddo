...
{
    public partial class AjusteDiferenciaMedioPago : FormBase
    {
        #region Declaraciones

        public string Query = "";
        public string Path_Nodo = "4.3.2";
        ...
        {
            tdControlAjustar.Visible = (this.MiharuSession.Usuario.PerfilManager.PuedeAcceder(Program.Permiso_Ajustes_Diferencia_Medios_Pago_Ajustar) || this.MiharuSession.Usuario.PerfilManager.PuedeAcceder(Program.Permiso_Ajustes_Diferencia_Medios_Pago_Reabrir));
            tdControlAprobar.Visible = (this.MiharuSession.Usuario.PerfilManager.PuedeAcceder(Program.Permiso_Ajustes_Diferencia_Medios_Pago_Aprobar));
            tdControlRechazar.Visible = (this.MiharuSession.Usuario.PerfilManager.PuedeAcceder(Program.Permiso_Ajustes_Diferencia_Medios_Pago_Reabrir));
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            this.Master.Title = "Ajuste Diferencia en Medio de Pago";

        }

        private void ConfigMainGrid()
        {
            MainGrid.Initialize(new CTA_Detalle_Ajuste_Diferencia_Medio_PagoDataTable());
            MainGrid.IsMultiCheck = true;
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.id_Error.ColumnName, Header = "ID Error", IsColumnID = true, Width = 50 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.fk_Core_Index.ColumnName, Header = "ID Tx", Width = 50 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Fecha_Movimiento.ColumnName, Header = "Fecha movimiento", Width = 90 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Fecha_Proceso.ColumnName, Header = "Fecha proceso", Width = 90 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Fecha_Ultimo_Proceso.ColumnName, Header = "Fecha Ajuste o Calificación Web", Width = 140 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.id_Regional.ColumnName, Header = "Codigo Regional", Ignore = true});
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Nombre_Regional.ColumnName, Header = "Regional", Width = 80 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.id_COB.ColumnName, Header = "Codigo COB", Ignore = true });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Nombre_COB.ColumnName, Header = "COB", Width = 80 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.fk_Oficina.ColumnName, Header = "Oficina", Width = 60 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Nombre_Oficina.ColumnName, Header = "Nombre Oficina", Width = 160 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Nombre_Oficina_Tipo.ColumnName, Header = "Tipo Oficina", Width = 60 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Codigo_Tx.ColumnName, Header = "Codigo Tx", Width = 60 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Nombre_Tx.ColumnName, Header = "Nombre Tx", Width= 250 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Materializada_Original.ColumnName, Header = "Tipo de Registro BAC", Width=70 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Valor_Transaccion.ColumnName, Header = "Valor PyC", Width = 120 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Valor_Original.ColumnName, Header = "Valor BAC", Width = 120 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Comision_Original.ColumnName, Header = "Comisión BAC", Width= 70 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Valor_Fisico.ColumnName, Header = "MP Físico", Width=120 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Valor_Archivo.ColumnName, Header = "MP LOG", Width=120 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Campo_Diez_Original.ColumnName, Header = "No. Secuencial y/o Operación BAC", Width=130 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Producto.ColumnName, Header = "No. Producto BAC", Width=130 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Campo_Uno_Original.ColumnName, Header = "Campo 10 BAC", Width=130 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Numero_Cuenta_Afectada_Original.ColumnName, Header = "Campo 30 BAC", Width=130 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Tx_Caja_Extendida_Original.ColumnName, Header = "Tx Caja Extendida BAC", Width=120 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Url.ColumnName, Header = "Link Imagen", Width= 80 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Url_Anexo.ColumnName, Header = "Link Anexo", Width = 80 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Nombre_Campo.ColumnName, Ignore = true });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.fk_Archivo_Detalle.ColumnName, Ignore = true });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Ajustado.ColumnName, Header = "Ajustado", Width = 40 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.id_Ajuste.ColumnName, Header = "Id Ajuste", Width = 40, Ignore = true });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Fecha_Ultimo_Ajuste.ColumnName, Header = "Fecha Ajuste", Width = 90 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Nombre_Estado_Ajuste.ColumnName, Header = "Estado", Width = 90 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Usuario.ColumnName, Header = "Usuario", Width = 90 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Activo.ColumnName, Ignore = true });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.id_Estado_Ajuste.ColumnName, Ignore = true });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Valor_Proceso.ColumnName, Header = "Valor Proceso", Width = 90 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Ajusta.ColumnName, Header = "Ajusta", Width = 90 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.Observacion_Ajuste.ColumnName, Header = "Observacion", Width = 200 });
            MainGrid.ColModel.Add(new FlexColumnMap { ColumnName = CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.fk_Ajuste_Observacion.ColumnName, Ignore = true });
        ...
        protected void Consultar()
        {
            ...
            try
            {
                ...
                MainGrid.DataSource = dbmBanagrario.SchemaProcess.PA_Detalle_Ultimo_Ajuste_Diferencia_Medio_Pago.DBExecute(
                ...
                if (MainGrid.DataSource.Rows.Count == 0)
                    Master.ShowAlert("No se encontraron Diferencias en Medio de Pago que cumplan con el criterio de Búsqueda", MsgBoxIcon.IconInformation);
                else
                    Master.SelectTab(Tabs.Filtro);
            }
            catch (Exception ex)
        ...
        protected void CargarDetalle(int nIdError)
        {
            ...
            try
            {
                ...
                var errorData = (CTA_Detalle_Ajuste_Diferencia_Medio_PagoRow[])MainGrid.DataSource.Select(CTA_Detalle_Ajuste_Diferencia_Medio_PagoEnum.id_Error.ColumnName + "=" + nIdError.ToString());
                var e = errorData[0]; //'.ToCTA_Detalle_Ajuste_Diferencia_Medio_PagoType()
                ...
                lblDataMedioPagoLog.Text = e.Valor_Archivo;
                lblDataMedioPagoProceso.Text = e.Valor_Fisico;
        ...
        protected void CargarDetalleMultiple()
        {
            ...
            var Seleccionados = (CTA_Detalle_Ajuste_Diferencia_Medio_PagoRow[])MainGrid.GetSelectedRows();
            ...
            lblDataMedioPagoLog.Text = "(Valores multiples)";
            lblDataMedioPagoProceso.Text = "(Valores multiples)";
        ...
        protected void Guardar(EstadoAjusteEnum nEstadoAjuste)
        {
            ...
            try
            {
                ...
                var Seleccionados = (CTA_Detalle_Ajuste_Diferencia_Medio_PagoRow[])this.MiharuSession.Parameter["Seleccionados"];
                ...
                if (Seleccionados.Length != 0)
                {
                    ...
                    foreach (var nRow in Seleccionados)
                    {
                        ...
                        if (nEstadoAjuste == EstadoAjusteEnum.Reapertura_sin_aprobacion && !this.MiharuSession.Usuario.PerfilManager.PuedeAcceder(Program.Permiso_Ajustes_Diferencia_Medios_Pago_Reabrir))
        ...
        protected void LimpiarControles()
        {
            ...
            lblDataMedioPagoLog.Text = "";
            lblDataMedioPagoProceso.Text = "";
        ...
        protected void ExportToWord()
        {
            ...
            this.MiharuSession.Pagina.Parameter["ContentName"] = "AjusteDiferenciaMedioDePago.doc";
        ...
        protected void ExportToExcel()
        {
            try
            {
                ...
                t.Columns["Valor_Fisico"].ColumnTitle = "MP Fisico";
                t.Columns["Valor_Archivo"].ColumnTitle = "MP LOG";
                ...
                this.MiharuSession.Pagina.Parameter["ContentName"] = "AjusteDiferenciaMedioDePago.csv";
