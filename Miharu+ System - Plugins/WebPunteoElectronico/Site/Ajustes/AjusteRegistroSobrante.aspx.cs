...
{
    public partial class AjusteRegistroSobrante : FormBase
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            this.VerRegistroButton.Click += new EventHandler(VerRegistroButton_Click);
            ...
            this.Master.Title = "Ajuste de Registros Sobrantes";
        ...
        {
            MainGrid.Initialize(new CTA_Detalle_Ajuste_Registro_SobranteDataTable());
            MainGrid.IsMultiCheck = true;
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.id_Error.ColumnName, Header = "ID Error", IsColumnID = true, Width = 50 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.fk_Archivo_Detalle.ColumnName, Header = "ID Tx", Width = 50 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Fecha_Movimiento.ColumnName, Header = "Fecha movimiento", Width = 90 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Fecha_Proceso.ColumnName, Header = "Fecha proceso", Width = 90 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Fecha_Ultimo_Proceso.ColumnName, Header = "Fecha Ajuste o Calificación Web", Width = 140 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.id_Regional.ColumnName, Header = "Codigo Regional", Ignore = true });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Nombre_Regional.ColumnName, Header = "Regional", Width = 80 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.id_COB.ColumnName, Header = "Codigo COB", Ignore = true });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Nombre_COB.ColumnName, Header = "COB", Width = 80 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.fk_Oficina.ColumnName, Header = "Oficina", Width = 60 }); 
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Nombre_Oficina.ColumnName, Header = "Nombre Oficina", Width = 160 });          
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Nombre_Oficina_Tipo.ColumnName, Header = "Tipo Oficina", Width = 60 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Codigo_Tx.ColumnName, Header = "Codigo Tx", Width = 60 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Nombre_Tx.ColumnName, Header = "Nombre Tx",  Width = 250});
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Materializada.ColumnName, Header = "Tipo de Registro BAC", Width = 70 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Valor.ColumnName, Header = "Valor BAC", Width = 120 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Comision.ColumnName, Header = "Comisión BAC", Width = 70 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Campo_Diez.ColumnName, Header = "No. Secuencial y/o Operación BAC", Width = 130 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Numero_Producto.ColumnName, Header = "No. Producto BAC", Width = 130 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Campo_Uno.ColumnName, Header = "Campo 10 BAC", Width = 130 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Numero_Cuenta_Afectada.ColumnName, Header = "Campo 30 BAC", Width = 130 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Tx_Caja_Extendida.ColumnName, Header = "Tx Caja Extendida BAC", Width = 120 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Usuario_Log.ColumnName, Header = "Usuario BAC", Width = 90 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Url.ColumnName, Header = "Link", Width = 80 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Ajustado.ColumnName, Header = "Ajustado", Width = 40 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.id_Ajuste.ColumnName, Header = "Id Ajuste", Width = 40, Ignore = true });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Fecha_Ultimo_Ajuste.ColumnName, Header = "Fecha Ajuste", Width = 90 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Nombre_Estado_Ajuste.ColumnName, Header = "Estado", Width = 90 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Usuario.ColumnName, Header = "Usuario", Width = 90 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Activo.ColumnName, Ignore = true });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.id_Estado_Ajuste.ColumnName, Hidden = true });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.fk_Ajuste_Observacion.ColumnName, Ignore = true });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Observacion_Ajuste.ColumnName, Header = "Observacion", Width = 200 });
            MainGrid.ColModel.Add(new FlexColumnMap() { ColumnName = CTA_Detalle_Ajuste_Registro_SobranteEnum.Ajusta.ColumnName, Header = "Ajusta", Width = 90 });   
        }
        ...
        protected void Consultar()
        {
            ...
            try
            {
                ...
                MainGrid.DataSource = dbmBanagrario.SchemaProcess.PA_Detalle_Ultimo_Ajuste_Registro_Sobrante.DBExecute(
                ...
                if (MainGrid.DataSource.Rows.Count == 0)
                    Master.ShowAlert("No se encontraron Registros Sobrantes que cumplan con el críterio de Búsqueda", MsgBoxIcon.IconInformation);
                else
                    Master.SelectTab(Tabs.Filtro);
            }
            catch (Exception ex)
        ...
        protected void CargarDetalle(int nIdError)
        {
            ...
            try
            {
                ...
                var errorData = (CTA_Detalle_Ajuste_Registro_SobranteRow[])MainGrid.DataSource.Select(CTA_Detalle_Ajuste_Registro_SobranteEnum.id_Error.ColumnName + "=" + nIdError.ToString());
        ...
        protected void CargarDetalleMultiple()
        {
            ...
            var Seleccionados = (CTA_Detalle_Ajuste_Registro_SobranteRow[])MainGrid.GetSelectedRows();
            txtObservacion.Text = "";
        ...
        protected void Guardar(EstadoAjusteEnum nEstadoAjuste)
        {
            ...
            try
            {
                var Seleccionados = (CTA_Detalle_Ajuste_Registro_SobranteRow[])this.MiharuSession.Parameter["Seleccionados"];
        ...
        private void VerRegistro()
        {
            ...
            if (Seleccionados.Length != 0)
            {
                var Path = System.Configuration.ConfigurationManager.AppSettings["VisorTxDetalle"];
        ...
        private void EditarSeleccionados()
        {
            ...
            if (Seleccionados.Length == 1)
                CargarDetalle((int)((CTA_Detalle_Ajuste_Registro_SobranteRow)(Seleccionados[0])).id_Error);
            else
            {
                if (Seleccionados.Length > 0)
        ...
        protected void ExportToWord()
        {
            ...
            this.MiharuSession.Pagina.Parameter["ContentName"] = "AjusteRegistrosSobrantes.doc";
        ...
        protected void ExportToExcel()
        {
            try
            {
                ...
                t.Columns["fk_Archivo_Detalle"].ColumnTitle = "Id Tx";
                ...
                t.Columns["Materializada"].ColumnTitle = "Tipo de registro BAC";
                t.Columns["Codigo_Tx"].ColumnTitle = "Codigo Tx";
                t.Columns["Nombre_Tx"].ColumnTitle = "Nombre Tx";
                t.Columns["Valor"].ColumnTitle = "Valor BAC";
                t.Columns["Valor"].Format = "$ #,###0.00";
                t.Columns["Numero_Producto"].ColumnTitle = "No. Producto BAC";
                t.Columns["Campo_Uno"].ColumnTitle = "Campo 10 BAC";
                t.Columns["Campo_Diez"].ColumnTitle = "No. Secuencial y/o Operacion BAC";
                t.Columns["Numero_Cuenta_Afectada"].ColumnTitle = "Campo 30 BAC";
                t.Columns["Fecha_Ultimo_Proceso"].ColumnTitle = "Fecha Ajuste o Calificación Web";
                t.Columns["Comision"].ColumnTitle = "Comision BAC";
                t.Columns["Comision"].Format = "$ #,###0.00";
                t.Columns["Url"].ColumnTitle = "Registro";
                
                t.Columns["Nombre_Regional"].ColumnTitle = "Regional";
                t.Columns["fk_Oficina"].ColumnTitle = "Oficina";
                t.Columns["Tx_Caja_Extendida"].ColumnTitle = "Tx Caja Extendida BAC";
                ...
                t.Columns["Usuario_Log"].ColumnTitle = "Usuario BAC";
                ...
                t.Columns["id_Estado_Ajuste"].ColumnTitle = "Estado Ajuste";
                ...
                this.MiharuSession.Pagina.Parameter["ContentName"] = "AjusteRegistrosSobrantes.csv";
