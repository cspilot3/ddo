<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterConfig.Master" AutoEventWireup="true"
    CodeBehind="AjusteDiferenciaMedioPago.aspx.cs" Inherits="WebPunteoElectronico.Site.Ajustes.AjusteDiferenciaMedioPago" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContentPlaceHolder" runat="server">
    <script type="text/javascript">
        ...
        function flexigridCellFormat(name, idx, cellHtml, cell) {
           if (name == "Valor_Transaccion" || name == "Valor_Original" || name == "Comision_Original") {
...
<asp:Content ID="Content2" ContentPlaceHolderID="TabContentPlaceHolderFiltro" runat="server">
...
<asp:Content ID="Content3" ContentPlaceHolderID="TabContentPlaceHolderDetalle" runat="server">
    ...
    <table>
        ...
        <tr>
            <td colspan="3" style="color: #003300; font-weight: bold">
                Datos de la Transacción con Diferencia de Medio de pago:
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="lblDataMedioPagoProceso" runat="server" Text=""></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <asp:Label ID="lblDataMedioPagoLog" runat="server" Text=""></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="3">
        ...
        <tr>
            ...
            <td>
                <asp:RadioButtonList ID="rbtValor" runat="server" RepeatDirection="Horizontal">
                    <asp:ListItem Text="Medio pago Log" Value="0"></asp:ListItem>
                    <asp:ListItem Text="Medio pago Capturado" Value="1"></asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
    ...
    <div id="VentanaObservacion_Div" style="border-style: solid; border-width: 1px; border-color: #808080 #000000 #000000 #808080;
        ...
        <table width="100%">
            ...
            <tr>
                <td>
                    <input type="button" class="button" value="Aceptar" onclick="AceptarObservacion_Click();" />
                </td>
                <td align="right">
                    <input type="button" class="button" id="CancelarObservacion" value="Cancelar" onclick="CancelarObservacion_Click();" />
                </td>
            </tr>
        </table>
    </div>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="FinalScriptContentPlaceHolder" runat="server">
