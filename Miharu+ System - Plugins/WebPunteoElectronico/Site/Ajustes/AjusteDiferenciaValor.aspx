<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterConfig.Master" AutoEventWireup="true"
    CodeBehind="AjusteDiferenciaValor.aspx.cs" Inherits="WebPunteoElectronico.Site.Ajustes.AjusteDiferenciaValor" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContentPlaceHolder" runat="server">
    <script type="text/javascript">
        ...
        function flexigridCellFormat(name, idx, cellHtml, cell) {
               if (name == "Valor_Transaccion" || name == "Valor_Original" || name == "Comision_Original" || name == "Valor_Fisico" || name == "Valor_Archivo") {
    ...
    <table>
        ...
        <tr>
            <td colspan="3" style="color: #003300; font-weight: bold">
                Datos de la Transacción con Diferencia de Valor:
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="lblDataValorLog" runat="server" Text=""></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <asp:Label ID="lblDataValorCap" runat="server" Text=""></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="3">
        ...
        <tr>
            ...
            <td>
                <asp:RadioButtonList ID="rbtValor" runat="server" RepeatDirection="Horizontal">
                    <asp:ListItem Text="Valor Log" Value="0"></asp:ListItem>
                    <asp:ListItem Text="Valor Capturado" Value="1"></asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
