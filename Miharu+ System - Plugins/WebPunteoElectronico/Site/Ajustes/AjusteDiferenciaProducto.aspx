<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterConfig.Master" AutoEventWireup="true"
    CodeBehind="AjusteDiferenciaProducto.aspx.cs" Inherits="WebPunteoElectronico.Site.Ajustes.AjusteDiferenciaProducto" %>
    ...
    <table>
        ...
        <tr>
            <td colspan="3" style="color: #003300; font-weight: bold">
                Datos de la Transacción con Diferencia de Producto:
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:RadioButtonList ID="rbtValor" runat="server" RepeatDirection="Horizontal">
                    <asp:ListItem Text="Producto Log" Value="0"></asp:ListItem>
                    <asp:ListItem Text="Producto Capturado" Value="1"></asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
