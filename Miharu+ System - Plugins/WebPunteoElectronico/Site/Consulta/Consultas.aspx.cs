...
namespace WebPunteoElectronico.Site.Consulta
{
    public partial class Consultas : FormBase
    {
        ...
        private string ColumnsToShow = CTA_Consulta_Proceso_DetalleEnum.fk_Oficina.ColumnName + "," +
                                       CTA_Consulta_Proceso_DetalleEnum.Fecha_Movimiento.ColumnName + "," +
                                       CTA_Consulta_Proceso_DetalleEnum.Producto.ColumnName + "," +
                                       CTA_Consulta_Proceso_DetalleEnum.Codigo_Tx.ColumnName + "," +
                                       CTA_Consulta_Proceso_DetalleEnum.Numero_Cuenta_Afectada.ColumnName + "," +
                                       CTA_Consulta_Proceso_DetalleEnum.Nombre_Tx.ColumnName + "," +
                                       CTA_Consulta_Proceso_DetalleEnum.Valor.ColumnName + "," +
                                       CTA_Consulta_Proceso_DetalleEnum.Url.ColumnName + "," +
                                       CTA_Consulta_Proceso_DetalleEnum.Anexo.ColumnName + "," +
                                       CTA_Consulta_Proceso_DetalleEnum.Cantidad_Folios.ColumnName;
        ...
        public string GetGrillaColModel()
        {
            ...
            foreach (DataColumn col in new CTA_Consulta_Proceso_DetalleDataTable().Columns)
            {
                if (!Program.ConsultaCamposOcultos.Contains(col.ColumnName))
                {
                    ...
                    if (ColumnsToShow.IndexOf(col.ColumnName) >= 0)
                        hideStr = "";
