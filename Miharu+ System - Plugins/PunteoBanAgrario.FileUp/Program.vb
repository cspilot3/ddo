...
#Region " Declaraciones "
    ...
    Public Shared Config As New PunteoAgrarioFileUpConfig
    Public Shared ConnectionStrings As PunteoAgrarioFileUpConfig.TypeConnectionString
...
#Region " Propiedades "
    ...
    Friend Shared ReadOnly Property AppDataPath() As String
        Get
            Return Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData).TrimEnd("\"c) + "\Banagrario\PunteoBanAgrario.FileUp\"
        End Get
    End Property
