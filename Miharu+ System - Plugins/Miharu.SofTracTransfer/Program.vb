...
#Region " Declaraciones "
    ...
    Public Shared Config As New SofTracConfig
    Public Shared ConnectionStrings As SofTracConfig.TypeConnectionString
...
#Region " Propiedades "
    ...
    Friend Shared ReadOnly Property AppDataPath() As String
        Get
            Return Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData).TrimEnd("\"c) + "\PYC\Miharu.SofTracTransfer\"
        End Get
    End Property
