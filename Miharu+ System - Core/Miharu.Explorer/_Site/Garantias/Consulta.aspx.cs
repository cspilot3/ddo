...
namespace Miharu.Explorer._Site.Garantias
{
    public partial class Consulta : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string Buscar(string par1, string val1, string idEntidad, string idProyecto, string idProyectoLlave, string nLlave)
        {
        ...
        [WebMethod]
        public static string GetFiles(string codigo, string llaves, string tipo)
        {
            Utils.IsValidSession();
            ...
            try
            {
                ...
                var info = dbmCore.SchemaProcess.PA_Folder_File_Busqueda_F11.DBExecute(codigo, Utils.MySession.Usuario.id, llaves, tipo);
        ...
        [WebMethod]
        public static string GetFileData(string codigo, int tipo, string fk_log_Cargue, string fk_Documento, string llaves)
        {
            Utils.IsValidSession();
            DBCore.DBCoreDataBaseManager dbmCore = null;
            ...
            try
            {
                ...
                var files = dbmCore.Schemadbo.PA_File_Data_Busqueda.DBExecute(codigo, Utils.MySession.Usuario.id, tipo, fk_log_Cargue_, llaves, fk_Documento_);
