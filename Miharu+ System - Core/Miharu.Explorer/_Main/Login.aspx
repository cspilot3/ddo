<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Miharu.Explorer._Main.Login" %>
<%@ Import Namespace="Miharu.Explorer._Clases" %>
...
<body>
    ...
    <div style="padding: 100px 0 0 300px;">
        <div id="login-box">
            <h2>
                e-Explorer</h2>
            Consultas y solicitudes de Garantias.
