<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FaltanteLogico.aspx.cs"
    Inherits="Miharu.Explorer.Imaging._Site.Garantias.Bancoomeva.FaltanteLogico" %>
...
<head runat="server">
    ...
    <script src="FaltanteLogico.js" type="text/javascript"></script>
            ...
            <tr>
                <td style="padding: 10px; vertical-align: top; border-color: #C5DBEC;
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td>
                                <input id="Button1" type="button" value="Buscar" class="button" onclick="buscarFaltantesLogicos()" />
