<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reporte_Multiactiva.aspx.cs"
    Inherits="Miharu.Explorer.Imaging._Site.Garantias.Bancoomeva.Reporte_Multiactiva" %>
...
<head runat="server">
    ...
    <script src="ReporteMultiactiva.js" type="text/javascript"></script>
            ...
            <tr>
                <td style="padding: 10px; vertical-align: top; border-color: #C5DBEC;
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td>
                                <input id="Button1" type="button" value="Buscar" class="button" onclick="buscarRepMultiActiva()" />
