...
{
    public partial class Reporte_NovedadesMesa : System.Web.UI.Page
            {
        ...
        [WebMethod]
        public static string BuscarReporte(string fecharecoleccionini, string fecharecoleccionfin)
        {
            ...
            try
            {
                DateTime Fecha_Recoleccion_Ini;
                DateTime Fecha_Recoleccion_Fin;
                Fecha_Recoleccion_Ini = DateTime.Parse(fecharecoleccionini);
                Fecha_Recoleccion_Fin = DateTime.Parse(fecharecoleccionfin);

                dbmArchiving = new DBArchiving.DBArchivingDataBaseManager(Utils.ConnectionString.Archiving);
                dbmArchiving.Connection_Open(Utils.MySession.Usuario.id);
                var info = dbmArchiving.SchemaReport.PA_Reporte_Novedades_Mesa.DBExecute(Fecha_Recoleccion_Ini, Fecha_Recoleccion_Fin);
