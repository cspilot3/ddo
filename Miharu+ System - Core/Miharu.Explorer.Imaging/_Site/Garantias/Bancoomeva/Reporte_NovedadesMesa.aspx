<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reporte_NovedadesMesa.aspx.cs"
    Inherits="Miharu.Explorer.Imaging._Site.Garantias.Bancoomeva.Reporte_NovedadesMesa" %>

<%@ Register assembly="Miharu.Explorer.Imaging" namespace="Explorer.Imaging.Controls" tagprefix="cc1" %>
...
<head runat="server">
    ...
    <script src="Reporte_NovedadesMesa.js" type="text/javascript"></script>
            ...
            <tr>
                <td style="padding: 10px; vertical-align: top; border-color: #C5DBEC;
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td class="contentText">
                                Fecha Recoleccion Fin
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <cc1:DFecha ID="DFecha2" runat="server" DateFormat="yyyy/MM/dd"
                                MaskFormat="YearMonthDay" CssClass="control" Width="100%" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input id="Button1" type="button" value="Buscar" class="button" onclick="buscarRepNovedadesMesa()" />
