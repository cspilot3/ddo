<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Consulta.aspx.cs" Inherits="Miharu.Explorer.Imaging._Site.Garantias.Consulta" %>
...
<body>
    ...
    <div>
                ...
                <td style="padding: 10px; width: 25%; vertical-align: top; border-color: #C5DBEC; border-right-style: solid;">
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <br />
                    <table id="llaves" style="width: 100%">
                        <tr>
                            <td class="Titulo_Cuaternario">
                                Búsqueda por llaves
                            </td>
                        </tr>
                        <tr>
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td>
                                <select id="ddlParametro1" class="control">
                                </select>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <input id="txtvalue1" type="text" class="control" />
                            </td>
                        </tr>
                        <tr>
                            <td>                                
                                <asp:CheckBox ID="chktipoBusqueda" runat="server" Text="Detalle" 
                                    Font-Size="Medium" />                                
                            </td>
                        </tr>
                        <tr>
        ...
        <div id="DataTablaAsociada" style="display: none;">
            <table id="tblDocumentosDataAsociada">
            </table>
        </div>
