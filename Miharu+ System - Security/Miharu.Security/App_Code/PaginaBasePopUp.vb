...
Imports Miharu.Security

Public Class PaginaBasePopUp
    Inherits Page
...
#Region " Propiedades "
    ...
    Public ReadOnly Property MySesion() As Sesion
        ...
        End Get
    End Property
    Public Shadows ReadOnly Property Master() As Miharu.Security.MiharuMasterPopUp
        Get
            Return CType(MyBase.Master, Miharu.Security.MiharuMasterPopUp)
        End Get
    End Property
...
#Region " Funciones "
    ...
    Protected Function ValidarNavegacion(ByVal nPageName As String, ByVal nPathPermiso As String) As Boolean
        If _MySesion Is Nothing Then
            Response.Redirect("~/sitio/login.aspx")
