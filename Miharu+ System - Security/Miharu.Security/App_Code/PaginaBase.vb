...
#Region " Propiedades "
        ...
        Public Shadows ReadOnly Property Master() As MiharuMasterPage
            ...
            End Get
        End Property
        Public ReadOnly Property ConnectionString() As Global.Program.TypeConnectionString
            Get
                If MySesion.Parameter("ConnectionStrings") Is Nothing Then
                    Return Nothing
                Else
                    Return CType(MySesion.Parameter("ConnectionStrings"), Global.Program.TypeConnectionString)
                End If
            End Get
        End Property
