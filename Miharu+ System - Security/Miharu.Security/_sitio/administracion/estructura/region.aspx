<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MiharuMasterForm.master" CodeBehind="region.aspx.vb" Inherits="Miharu.Security._sitio.administracion.estructura.region" 
    title="" %>
            ...
            <td>
                <table cellpadding="0" cellspacing="0" border="0" style="width: 760px">
                    <tr>
                        ...
                        <td align="right">
                            <asp:Label ID="lblTitulo" runat="server" Text="Regiones" CssClass="Titulo_Principal"></asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
                                    ...
                                    <td colspan="2">
                                        <div style="border: 1px solid #CCCCCC; overflow: auto; height: 395px; width: 735px">
                                            <Miharu:SlygGridView ID="gvBase" runat="server" AutoGenerateColumns="False" GridNum="0"
                                                ...
                                                <Columns>
                                                    <asp:BoundField DataField="id_Region" HeaderText="Codigo" ItemStyle-Width="1" />
                                                    <asp:BoundField DataField="Nombre_Region" HeaderText="Nombre" />
                                                </Columns>
                                    ...
                                    <table id="tblDetalle" cellspacing="0" cellpadding="0" border="0" style="margin-left: 20px">
                                        ...
                                        <tr>
                                            <td style="height: 14px">
                                                <asp:Label ID="lblCodigo" runat="server" CssClass="Label">Código Región</asp:Label>
                                            </td>
                                            <td style="height: 14px">
                                            </td>
                                            <td style="height: 14px">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblNombre" runat="server" CssClass="Label">Nombre Región</asp:Label>
                                            </td>
                                            <td style="width: 10px">
                                            </td>
                                            <td>
                                                <asp:Label ID="lblCodRegion" runat="server" CssClass="Oculto"></asp:Label>
                                                <asp:TextBox ID="txtNombre" TabIndex="1" runat="server" CssClass="Textbox" Width="400px"
                                                    MaxLength="100" />
                                                <asp:RequiredFieldValidator ID="rfvNombre" runat="server" ErrorMessage="&lt;b&gt;Falta campo requerido&lt;/b&gt;&lt;br /&gt;Se requiere un Nombre de Región."
