<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MiharuMasterForm.master"
    CodeBehind="ciudades.aspx.vb" Inherits="Miharu.Security._sitio.administracion.estructura.ciudades" Title="" %>
            ...
            <td>
                <table cellpadding="0" cellspacing="0" border="0" style="width: 760px;">
                    <tr>
                        ...
                        <td align="right">
                            <asp:Label ID="lblTitulo" runat="server" Text="Ciudades" CssClass="Titulo_Principal"></asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
                            ...
                            <table style="padding: 5px" cellspacing="5" border="0">
                                <tr>
                                    <td style="height: 30px">
                                        <asp:Label ID="lblPais" runat="server" Text="Pais" CssClass="Label" Width="120px"></asp:Label>
                                    </td>
                                    <td>
                                 ...
                                 <tr>
                                    <td style="height: 30px">
                                        <asp:Label ID="lblRegion" runat="server" Text="Región" CssClass="Label" Width="120px"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="ddlRegion" runat="server" Width="300px" AutoPostBack="True"
                                            CssClass="Textbox">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                    ...
                                    <td colspan="2">
                                        <div style="border: 1px solid #CCCCCC; overflow: auto; height: 430px; width: 735px">
                                            <Miharu:SlygGridView ID="gvBase" runat="server" AutoGenerateColumns="False" GridNum="0"
                                                ...
                                                <Columns>
                                                    <asp:BoundField DataField="id_Ciudad" HeaderText="Cod." ItemStyle-Width="1" />
                                                    <asp:BoundField DataField="Nombre_Ciudad" HeaderText="Nombre" />
                                                    <asp:BoundField DataField="Codigo_DANE_Ciudad" HeaderText="DANE" />
                                                    <asp:CheckBoxField DataField="Predeterminado" HeaderText="Predeterminado"/>
                                                </Columns>
                            ...
                            <div style="margin: 5px; height: 475px; width: 737px;">
                                <asp:Panel ID="pnlDetalle" runat="server" Visible="False">
                                    <table id="tblDetalle" cellspacing="0" cellpadding="0" border="0" style="margin-left: 20px">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblPaisEdit" runat="server" CssClass="Label">Pais</asp:Label>
                                            </td>
                                            <td style="width: 10px">
                                            </td>
                                            <td>
                                                <asp:Label ID="lblNombrePais" runat="server" CssClass="Textbox" Width="500px">Pais</asp:Label>
                                            </td>
                                        </tr>
                                         <tr>
                                            <td colspan="3" style="height: 10px">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblRegionEdit" runat="server" CssClass="Label">Región</asp:Label>
                                            </td>
                                            <td style="width: 10px">
                                            </td>
                                            <td>
                                                <asp:Label ID="lblNombreRegion" runat="server" CssClass="Textbox" Width="500px">Región</asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="3" style="height: 10px">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblNombre" runat="server" CssClass="Label">Nombre Ciudad</asp:Label>
                                            </td>
                                            <td style="width: 10px">
                                            </td>
                                            <td>
                                                <asp:Label ID="lblCodCiudad" runat="server" CssClass="Oculto"></asp:Label>
                                                <asp:TextBox ID="txtNombre" TabIndex="1" runat="server" CssClass="Textbox" Width="400px"
                                                    MaxLength="100" />
                                                <asp:RequiredFieldValidator ID="rfvNombre" runat="server" ErrorMessage="&lt;b&gt;Falta campo requerido&lt;/b&gt;&lt;br /&gt;Se requiere un Nombre de Ciudad."
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblCodigoDANE" runat="server" CssClass="Label">Código DANE</asp:Label>
                                            </td>
                                            <td style="width: 10px">
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtCodigoDANE" TabIndex="1" runat="server" CssClass="Textbox" Width="100px"
                                                    MaxLength="8" />
                                            </td>
                                        </tr>
                                         <tr>
                                         ...
                                         <tr>
                                            <td>
                                            <asp:CheckBox ID="chkPredeterminado" runat ="server" Text="Predeterminado" CssClass="Label" />
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
