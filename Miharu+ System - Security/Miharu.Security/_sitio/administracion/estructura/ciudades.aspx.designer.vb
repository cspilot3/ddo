...
Namespace _sitio.administracion.estructura
    ...
    Partial Public Class ciudades
        ...
        '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
        '''</remarks>
        Protected WithEvents lblPaisEdit As Global.System.Web.UI.WebControls.Label
        ...
        '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
        '''</remarks>
        Protected WithEvents lblNombrePais As Global.System.Web.UI.WebControls.Label

        '''<summary>
        '''Control lblRegionEdit.
        '''</summary>
        '''<remarks>
        '''Campo generado automáticamente.
        '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
        '''</remarks>
        Protected WithEvents lblRegionEdit As Global.System.Web.UI.WebControls.Label
        ...
        '''<summary>
        '''Control lblCodCiudad.
        '''</summary>
        '''<remarks>
        '''Campo generado automáticamente.
        '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
        '''</remarks>
        Protected WithEvents lblCodCiudad As Global.System.Web.UI.WebControls.Label
        ...
        '''<summary>
        '''Control lblCodigoDANE.
        '''</summary>
        '''<remarks>
        '''Campo generado automáticamente.
        '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
        '''</remarks>
        Protected WithEvents lblCodigoDANE As Global.System.Web.UI.WebControls.Label

        '''<summary>
        '''Control txtCodigoDANE.
        '''</summary>
        '''<remarks>
        '''Campo generado automáticamente.
        '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
        '''</remarks>
        Protected WithEvents txtCodigoDANE As Global.System.Web.UI.WebControls.TextBox

        '''<summary>
        '''Control chkPredeterminado.
        '''</summary>
        '''<remarks>
        '''Campo generado automáticamente.
        '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
