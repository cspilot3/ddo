<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MiharuMasterForm.master"
    CodeBehind="sedes.aspx.vb" Inherits="Miharu.Security._sitio.administracion.estructura.sedes" Title="" %>
            ...
            <td>
                <table cellpadding="0" cellspacing="0" border="0" style="width: 760px">
                    <tr>
                        ...
                        <td align="right">
                            <asp:Label ID="lblTitulo" runat="server" Text="Sede" CssClass="Titulo_Principal"></asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
                                    ...
                                    <td colspan="2">
                                        <div style="border: 1px solid #CCCCCC; overflow: auto; height: 395px; width: 735px">
                                            <Miharu:SlygGridView ID="gvBase" runat="server" AutoGenerateColumns="False" GridNum="0"
                                                ...
                                                <Columns>
                                                    <asp:BoundField DataField="id_Sede" HeaderText="Cod." ItemStyle-Width="1" />
                                                    <asp:BoundField DataField="Nombre_Sede" HeaderText="Nombre" />
                                                </Columns>
                    ...
                    <ajaxToolkit:TabPanel ID="tpDetalle" runat="server">
                        ...
                        <ContentTemplate>
                            ...
                            <ajaxToolkit:TabContainer ID="tcDetalle" runat="server" CssClass="ajax__tab_technorati-theme"
                                ActiveTabIndex="0" Width="740">
                                <ajaxToolkit:TabPanel runat="server" ID="tpDatos" HeaderText="Generales">
                                    <ContentTemplate>
                                        <asp:Panel ID="pnlDetalle" runat="server" Visible="False">
                                            <div style="margin: 5px; height: 390px; width: 725px;">
                                                <table id="tblDetalle" cellspacing="0" cellpadding="0" border="0" style="margin-left: 20px">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="lblCodSede" runat="server" CssClass="Oculto"></asp:Label>
                                                            <asp:TextBox ID="txtNombre" TabIndex="1" runat="server" CssClass="Textbox" Width="400px"
                                                                MaxLength="100" />
                                                            <asp:RequiredFieldValidator ID="rfvNombre" runat="server" ErrorMessage="&lt;b&gt;Falta campo requerido&lt;/b&gt;&lt;br /&gt;Se requiere un Nombre de Sede."
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="height: 14px">
                                                            <asp:TextBox ID="txtCodigo" TabIndex="2" runat="server" CssClass="Textbox" Width="100px"
                                                    ...
                                                    <tr>
                                                        <td style="height: 14px">
                                                            <asp:Label ID="lblPais" runat="server" CssClass="Label">Pais</asp:Label>
                                                        </td>
                                                        <td style="height: 14px">
                                                        </td>
                                                        <td style="height: 14px">
                                                            <asp:DropDownList ID="ddlPais" TabIndex="3" runat="server" CssClass="Textbox" Width="250px"
                                                                AutoPostBack="true">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td style="height: 14px">
                                                            <asp:Label ID="lblRegion" runat="server" CssClass="Label">Región</asp:Label>
                                                        </td>
                                                        <td style="height: 14px">
                                                        </td>
                                                        <td style="height: 14px">
                                                            <asp:DropDownList ID="ddlRegion" TabIndex="4" runat="server" CssClass="Textbox" Width="250px"
                                                                AutoPostBack="true">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td style="height: 14px">
                                                            <asp:Label ID="lblCiudad" runat="server" CssClass="Label">Ciudad</asp:Label>
                                                        </td>
                                                        <td style="height: 14px">
                                                        </td>
                                                        <td style="height: 14px">
                                                            <asp:DropDownList ID="ddlCiudad" TabIndex="5" runat="server" CssClass="Textbox" Width="250px">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td style="height: 14px">
                                                            <asp:Label ID="lblRegional" runat="server" CssClass="Label">Regional</asp:Label>
                                                        </td>
                                                        <td style="height: 14px">
                                                        </td>
                                                        <td style="height: 14px">
                                                            <asp:DropDownList ID="ddlRegional" TabIndex="6" runat="server" CssClass="Textbox"
                                                                Width="250px">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="Label2" runat="server" CssClass="Oculto"></asp:Label>
                                                            <asp:TextBox ID="txtDireccion" TabIndex="7" runat="server" CssClass="Textbox" Width="400px"
                                                                MaxLength="100" />
                                                            <asp:RequiredFieldValidator ID="rfvDireccion" runat="server" ErrorMessage="&lt;b&gt;Falta campo requerido&lt;/b&gt;&lt;br /&gt;Se requiere la dirección de la sede."
                                                                Display="None" ValidationGroup="Guardar" SetFocusOnError="True" ControlToValidate="txtDireccion"></asp:RequiredFieldValidator>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtTelefono" TabIndex="8" runat="server" CssClass="Textbox" Width="150px"
                                                                MaxLength="30" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtUbicacion" TabIndex="9" runat="server" CssClass="Textbox" Width="150px"
                                                                MaxLength="50" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtCentroCosto" TabIndex="10" runat="server" CssClass="Textbox"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="lblClasificacion" runat="server" CssClass="Label">Clasificación</asp:Label>
                                                        </td>
                                                        <td style="width: 10px">
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtClasificacion" TabIndex="11" runat="server" CssClass="Textbox"
                                                                Width="150px" MaxLength="50" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                ...
                                <ajaxToolkit:TabPanel runat="server" ID="tpDependencias" HeaderText="Dependencias">
                                    <ContentTemplate>
                                        <div style="margin: 5px; height: 390px; width: 725px;">
