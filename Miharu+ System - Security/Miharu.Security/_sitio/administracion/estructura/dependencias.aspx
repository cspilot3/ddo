<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MiharuMasterForm.master"
    CodeBehind="dependencias.aspx.vb" Inherits="Miharu.Security._sitio.administracion.estructura.dependencias" Title="" %>
                                    ...
                                    <td colspan="2">
                                        <div style="border: 1px solid #CCCCCC; overflow: auto; height: 395px; width: 735px">
                                            <Miharu:SlygGridView ID="gvBase" runat="server" AutoGenerateColumns="False" GridNum="0"
                                                ...
                                                <Columns>
                                                    <asp:BoundField DataField="id_Dependencia" HeaderText="Cod." ItemStyle-Width="1" />
                                                    <asp:BoundField DataField="Nombre_Dependencia" HeaderText="Nombre" />
                    ...
                    <ajaxToolkit:TabPanel ID="tpDetalle" runat="server">
                        ...
                        <ContentTemplate>
                            ...
                            <ajaxToolkit:TabContainer ID="tcDetalle" runat="server" CssClass="ajax__tab_technorati-theme"
                                        ...
                                        <div style="margin: 5px; height: 390px; width: 725px;">
                                            <asp:Panel ID="pnlDetalle" runat="server" Visible="False">
                                                <table id="tblDetalle" cellspacing="0" cellpadding="0" border="0" style="margin-left: 20px">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="lblDependenciaPadre" runat="server" CssClass="Label">Padre</asp:Label>
                                                        </td>
                                                        <td style="width: 10px">
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtDependenciaPadre" runat="server" CssClass="TextboxDisable" Width="480px"
                                                                MaxLength="100" Enabled="false" />
                                                            <asp:Label ID="lblDepenPadreID" runat="server" Text="-1" CssClass="Oculto"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <Miharu:ImageChangingButton ID="btnDependenciaPadre" runat="server" ImageUrl="~/_images/opciones/search.png" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtNombre" TabIndex="1" runat="server" CssClass="Textbox" Width="400px"
                                                                    MaxLength="100" />
                                                                <asp:RequiredFieldValidator ID="rfvNombre" runat="server" ErrorMessage="&lt;b&gt;Falta campo requerido&lt;/b&gt;&lt;br /&gt;Se requiere un Nombre de Dependencia."
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="height: 14px">
                                                                ...
                                                                <asp:Label ID="lblCodDependencia" runat="server" CssClass="Oculto"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3" style="height: 10px">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtDireccion" TabIndex="1" runat="server" CssClass="Textbox" Width="400px"
                                                                    MaxLength="100" />
                                                                <asp:RequiredFieldValidator ID="rfvDireccion" runat="server" ErrorMessage="&lt;b&gt;Falta campo requerido&lt;/b&gt;&lt;br /&gt;Se requiere la dirección de la Dependencia."
                                                                ...
                                                                <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender1" runat="server"
                                                                    TargetControlID="rfvDireccion" Enabled="True">
                                                                </ajaxToolkit:ValidatorCalloutExtender>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtTelefono" TabIndex="1" runat="server" CssClass="Textbox" Width="150px"
                                                                    MaxLength="30" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtUbicacion" TabIndex="1" runat="server" CssClass="Textbox" Width="150px"
                                                                    MaxLength="50" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtCentroCosto" TabIndex="1" runat="server" CssClass="Textbox" Width="150px"
                                                                    MaxLength="50" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lblTipo" runat="server" CssClass="Label">Tipo</asp:Label>
                                                            </td>
                                                            <td style="width: 10px">
                                                            </td>
                                                            <td>
                                                                <asp:DropDownList ID="ddlNivel" runat="server" Width="150px" CssClass="Textbox">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                </table>
                                ...
                                <ajaxToolkit:TabPanel runat="server" ID="tpSedes" HeaderText="Sedes">
                                    <ContentTemplate>
                                        <div style="margin: 5px; height: 390px; width: 725px;">
