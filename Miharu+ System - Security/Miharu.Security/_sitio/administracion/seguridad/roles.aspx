<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MiharuMasterForm.master"
    CodeBehind="roles.aspx.vb" Inherits="Miharu.Security._sitio.administracion.seguridad.roles" Title="" %>
            ...
            <td>
                <table cellpadding="0" cellspacing="0" border="0" style="width: 760px;">
                    <tr>
                        ...
                        <td align="right">
                            <asp:Label ID="lblTitulo" runat="server" Text="Roles" CssClass="Titulo_Principal"></asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
                                    ...
                                    <td colspan="2">
                                        <div style="border: 1px solid #CCCCCC; overflow: auto; height: 430px; width: 735px">
                                            <Miharu:SlygGridView ID="gvBase" runat="server" AutoGenerateColumns="False" GridNum="0"
                                                ...
                                                <Columns>
                                                    <asp:BoundField DataField="id_Rol" HeaderText="Cod.">
                                                        <ItemStyle Width="1px"></ItemStyle>
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="Nombre_Rol" HeaderText="Nombre"></asp:BoundField>
                                                    <asp:BoundField DataField="Descripcion_Rol" HeaderText="Descripción"></asp:BoundField>
                                                </Columns>
                                ...
                                <asp:Panel ID="pnlDetalle" runat="server" Visible="False">
                                    <table id="tblDetalle" cellspacing="0" cellpadding="0" border="0" style="margin-left: 20px">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblCodRol" runat="server" CssClass="Oculto"></asp:Label>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtDescripcion" TabIndex="3" runat="server" CssClass="Textbox" Width="400px"
                                                    MaxLength="100" />
                                                <asp:RequiredFieldValidator ID="rfvDescripcion" runat="server" ErrorMessage="&lt;b&gt;Falta campo requerido&lt;/b&gt;&lt;br /&gt;Se requiere una descripción."
                                                    Display="None" ValidationGroup="Guardar" SetFocusOnError="True" ControlToValidate="txtDescripcion"></asp:RequiredFieldValidator>
