<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MiharuMasterForm.master"
    CodeBehind="modulos.aspx.vb" Inherits="Miharu.Security._sitio.administracion.seguridad.modulos" Title="" %>
            ...
            <td>
                <table cellpadding="0" cellspacing="0" border="0" style="width: 760px;">
                    <tr>
                        ...
                        <td align="right">
                            <asp:Label ID="lblTitulo" runat="server" Text="Módulos" CssClass="Titulo_Principal"></asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
                        ...
                        <ContentTemplate>
                            <table style="padding: 5px" cellspacing="5" border="0">
                                <tr>
                                    ...
                                    <td>
                                        <uc1:wucFilter ID="ucFiltro" runat="server"></uc1:wucFilter>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <div style="border: 1px solid #CCCCCC; overflow: auto; height: 430px; width: 735px">
                                            <Miharu:SlygGridView ID="gvBase" runat="server" AutoGenerateColumns="False" GridNum="0"
                                                ...
                                                <Columns>
                                                    <asp:BoundField DataField="id_Modulo" HeaderText="Cod.">
                                                        <ItemStyle Width="1px"></ItemStyle>
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="Nombre_Modulo" HeaderText="Nombre"></asp:BoundField>
                                                    <asp:CheckBoxField DataField="Usa_Permisos_Heredados" HeaderText="Permisos H."></asp:CheckBoxField>
                                                    <asp:BoundField DataField="Ensamblado_Modulo" HeaderText="Ensamblado"></asp:BoundField>
                                                </Columns>
                                ...
                                <asp:Panel ID="pnlDetalle" runat="server" Visible="False">
                                    <table id="tblDetalle" cellspacing="0" cellpadding="0" border="0" style="margin-left: 20px">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblCodModulo" runat="server" CssClass="Oculto"></asp:Label>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:CheckBox ID="chkPermisosHeredados" CssClass="Label" TabIndex="2" runat="server"
                                                    Text="Usa permisos heredados"></asp:CheckBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="3" style="height: 10px">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblEnsamblado" runat="server" CssClass="Label">Ensamblado</asp:Label>
                                            </td>
                                            <td style="width: 10px">
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtEnsamblado" TabIndex="3" runat="server" CssClass="Textbox" Width="400px"
                                                    MaxLength="100" />
                                                <asp:RequiredFieldValidator ID="rfvEnsamblado" runat="server" ErrorMessage="&lt;b&gt;Falta campo requerido&lt;/b&gt;&lt;br /&gt;Se requiere un nombre de Ensamblado."
                                                    Display="None" ValidationGroup="Guardar" SetFocusOnError="True" ControlToValidate="txtEnsamblado"></asp:RequiredFieldValidator>
                                                <ajaxToolkit:ValidatorCalloutExtender ID="rfvEnsamblado_ValidatorCalloutExtender"
                                                    runat="server" TargetControlID="rfvEnsamblado" Enabled="True">
                                                </ajaxToolkit:ValidatorCalloutExtender>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="CadenaLabel" runat="server" CssClass="Label">Cadena Conexión</asp:Label>
                                            </td>
                                            <td style="width: 10px">
                                            </td>
                                            <td>
                                                <asp:TextBox ID="CadenaTextBox" TabIndex="3" runat="server" CssClass="Textbox" Width="500px"
                                                    TextMode="MultiLine" Height="100px" />
                                                <asp:RequiredFieldValidator ID="CadenaTextBoxRequiredFieldValidator" runat="server"
                                                    ErrorMessage="&lt;b&gt;Falta campo requerido&lt;/b&gt;&lt;br /&gt;Se requiere una cadena de conexión."
                                                    Display="None" ValidationGroup="Guardar" SetFocusOnError="True" ControlToValidate="CadenaTextBox"></asp:RequiredFieldValidator>
                                                <ajaxToolkit:ValidatorCalloutExtender ID="CadenaTextBoxRequiredFieldValidator_ValidatorCalloutExtender1"
                                                    runat="server" TargetControlID="CadenaTextBoxRequiredFieldValidator" Enabled="True">
                                                </ajaxToolkit:ValidatorCalloutExtender>
                                            </td>
                                        </tr>
                                    </table>
