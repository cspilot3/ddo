...
Namespace _sitio.administracion.seguridad
    ...
    Partial Public Class perfiles
        ...
        '''<summary>
        '''Control lblCodPerfil.
        '''</summary>
        '''<remarks>
        '''Campo generado automáticamente.
        '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
        '''</remarks>
        Protected WithEvents lblCodPerfil As Global.System.Web.UI.WebControls.Label
        ...
        '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
        '''</remarks>
        Protected WithEvents tpPermisos As Global.AjaxControlToolkit.TabPanel
        ...
        '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
        '''</remarks>
        Protected WithEvents tvPermisos As Global.System.Web.UI.WebControls.TreeView

        '''<summary>
        '''Control AsignarAccionesButton.
        '''</summary>
        '''<remarks>
        '''Campo generado automáticamente.
        '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
        '''</remarks>
        Protected WithEvents AsignarAccionesButton As Global.System.Web.UI.WebControls.Button
        ...
        '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
        '''</remarks>
        Protected WithEvents tpAcciones As Global.AjaxControlToolkit.TabPanel
        ...
        '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
        '''</remarks>
        Protected WithEvents gvCadenas As Global.Miharu.Web.Controls.SlygGridView
    End Class
End Namespace