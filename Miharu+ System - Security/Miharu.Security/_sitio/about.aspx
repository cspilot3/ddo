<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MiharuMasterPopUp.master"
    CodeBehind="about.aspx.vb" Inherits="Miharu.Security._sitio.about" Title="" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" bgcolor="#ECE9D8">
        <tr>
            <td style="width: 256px">
                <img alt="" src="../_images/basic/MiharuSecurityImage.png" height="256px" width="256px" />
            </td>
            <td style="width: 30px">
            </td>
            <td valign="top">
                    ...
                    <tr>
                        <td>
                            <asp:TextBox ID="txtBoxDescription" runat="server" CssClass="Parrafo" Height="50px"
                                Width="250px" Text="BoxDescription" ReadOnly="True">BoxDescription</asp:TextBox>
                        </td>
                    </tr>
                </table>
            </td>
