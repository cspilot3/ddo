...
#Region " Eventos "
    ...
    Private Sub lnkbHijaClose_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkbHijaClose.Click
        RaiseEvent HijaClose()
    End Sub

    Protected Sub mnuOpciones_MenuItemClick(ByVal sender As Object, ByVal e As MenuEventArgs) Handles mnuOpciones.MenuItemClick
...
#Region " Metodos "
    ...
    Private Sub AsignarPassword(ByVal nOldPassword As String, ByVal nNewPassword As String, ByVal nConfirmPassword As String)
        ...
        If (nNewPassword = nConfirmPassword) Then
            ...
            Dim MySesion As Sesion = CType(Session("Sesion"), Sesion)
            ...
            End Try
        Else
            ShowAlert("Las contraseñas ingresadas no coinciden", MsgBoxIcon.IconWarning)
        End If
    End Sub
