<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="default.aspx.vb" Inherits="Miharu.Security._default" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>:: MIHARU Security ::</title>
    ...
    <script type="text/javascript">
        ...
        function Iniciar_MIharu() {
            ...
            if(OpenChield == 0)
            {
                ...
                if (width > 0 && height > 0) 
                {
                    PaginaHija = window.open("_sitio/login.aspx","SecurityWindow", "width=" + width + "px,height=" + height + "px,top=0px,left=0px,toolbar=no,directories=no,menubar=no,status=yes,resizable=yes");
                }
                else
                {
                    PaginaHija = window.open("_sitio/login.aspx","SecurityWindow", "width:1000px,height=740px,top=0px,left=0px,toolbar=no,directories=no,menubar=no,status=yes,resizable=yes");
                }
...
<body onload="Iniciar_MIharu();" onunload="Cerrar_Hija();">
    ...
    <div>
        <center>
            <br />
            <br />
            <asp:Label ID="lblTitulo" runat="server" Text="MIHARU Security" Style="font-size: xx-large;
